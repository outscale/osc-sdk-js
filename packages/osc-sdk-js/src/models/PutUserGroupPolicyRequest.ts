 ...
 * 
 * @export
 * @interface PutUserGroupPolicyRequest
 */
export interface PutUserGroupPolicyRequest {
    /**
     * If true, checks whether you have the required permissions to perform the action.
     * @type {boolean}
     * @memberof PutUserGroupPolicyRequest
     */
    dryRun?: boolean;
    /**
...
export function PutUserGroupPolicyRequestFromJSON(json: any): PutUserGroupPolicyRequest {
    return PutUserGroupPolicyRequestFromJSONTyped(json, false);
}

export function PutUserGroupPolicyRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): PutUserGroupPolicyRequest {
...
export function PutUserGroupPolicyRequestToJSON(value?: PutUserGroupPolicyRequest | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
