...
export function FiltersVmTypeFromJSON(json: any): FiltersVmType {
    return FiltersVmTypeFromJSONTyped(json, false);
}

export function FiltersVmTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): FiltersVmType {
    ...
    return {
        ...
        'ephemeralsTypes': !exists(json, 'EphemeralsTypes') ? undefined : json['EphemeralsTypes'],
        'eths': !exists(json, 'Eths') ? undefined : json['Eths'],
...
export function FiltersVmTypeToJSON(value?: FiltersVmType | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
