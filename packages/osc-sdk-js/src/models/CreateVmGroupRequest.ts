 ...
 * @export
 */
export const CreateVmGroupRequestPositioningStrategyEnum = {
    Attract: 'attract',
...
export function CreateVmGroupRequestFromJSON(json: any): CreateVmGroupRequest {
    return CreateVmGroupRequestFromJSONTyped(json, false);
}

export function CreateVmGroupRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): CreateVmGroupRequest {
...
export function CreateVmGroupRequestToJSON(value?: CreateVmGroupRequest | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
