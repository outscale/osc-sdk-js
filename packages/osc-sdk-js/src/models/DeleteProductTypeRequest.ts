...
export function DeleteProductTypeRequestFromJSON(json: any): DeleteProductTypeRequest {
    return DeleteProductTypeRequestFromJSONTyped(json, false);
}

export function DeleteProductTypeRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): DeleteProductTypeRequest {
...
export function DeleteProductTypeRequestToJSON(value?: DeleteProductTypeRequest | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
