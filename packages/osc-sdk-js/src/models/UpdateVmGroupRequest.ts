 ...
 * 
 * @export
 * @interface UpdateVmGroupRequest
 */
export interface UpdateVmGroupRequest {
    /**
     * A new description for the VM group.
     * @type {string}
     * @memberof UpdateVmGroupRequest
     */
    description?: string;
    /**
...
export function UpdateVmGroupRequestFromJSON(json: any): UpdateVmGroupRequest {
    return UpdateVmGroupRequestFromJSONTyped(json, false);
}

export function UpdateVmGroupRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): UpdateVmGroupRequest {
...
export function UpdateVmGroupRequestToJSON(value?: UpdateVmGroupRequest | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
