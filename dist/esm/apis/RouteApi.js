...
export class RouteApi extends runtime.BaseAPI {
    ...
    createRouteRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const body = CreateRouteRequestToJSON(requestParameters.createRouteRequest);
            const request = {
                path: `/CreateRoute`,
                method: 'POST',
    ...
    deleteRouteRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const body = DeleteRouteRequestToJSON(requestParameters.deleteRouteRequest);
            const request = {
                path: `/DeleteRoute`,
                method: 'POST',
                headers: headerParameters,
    ...
    updateRouteRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const body = UpdateRouteRequestToJSON(requestParameters.updateRouteRequest);
            const request = {
                path: `/UpdateRoute`,
                method: 'POST',
                headers: headerParameters,
