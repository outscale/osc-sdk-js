...
export class NatServiceApi extends runtime.BaseAPI {
    ...
    createNatServiceRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const body = CreateNatServiceRequestToJSON(requestParameters.createNatServiceRequest);
            const request = {
    ...
    deleteNatServiceRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const body = DeleteNatServiceRequestToJSON(requestParameters.deleteNatServiceRequest);
            const request = {
    ...
    readNatServicesRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const body = ReadNatServicesRequestToJSON(requestParameters.readNatServicesRequest);
            const request = {
