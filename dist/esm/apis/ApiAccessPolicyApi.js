...
export class ApiAccessPolicyApi extends runtime.BaseAPI {
    ...
    readApiAccessPolicyRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const body = ReadApiAccessPolicyRequestToJSON(requestParameters.readApiAccessPolicyRequest);
            const request = {
    ...
    updateApiAccessPolicyRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const body = UpdateApiAccessPolicyRequestToJSON(requestParameters.updateApiAccessPolicyRequest);
            const request = {
