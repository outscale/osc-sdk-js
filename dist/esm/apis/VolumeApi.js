...
import { CreateVolumeRequestToJSON, CreateVolumeResponseFromJSON, DeleteVolumeRequestToJSON, DeleteVolumeResponseFromJSON, LinkVolumeRequestToJSON, LinkVolumeResponseFromJSON, ReadVolumeUpdateTasksRequestToJSON, ReadVolumeUpdateTasksResponseFromJSON, ReadVolumesRequestToJSON, ReadVolumesResponseFromJSON, UnlinkVolumeRequestToJSON, UnlinkVolumeResponseFromJSON, UpdateVolumeRequestToJSON, UpdateVolumeResponseFromJSON, } from '../models';
/**
 *
 */
export class VolumeApi extends runtime.BaseAPI {
    ...
    readVolumeUpdateTasksRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const body = ReadVolumeUpdateTasksRequestToJSON(requestParameters.readVolumeUpdateTasksRequest);
            const request = {
