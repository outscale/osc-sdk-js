...
export class DirectLinkApi extends runtime.BaseAPI {
    ...
    createDirectLinkRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const body = CreateDirectLinkRequestToJSON(requestParameters.createDirectLinkRequest);
            const request = {
    ...
    deleteDirectLinkRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const body = DeleteDirectLinkRequestToJSON(requestParameters.deleteDirectLinkRequest);
            const request = {
    ...
    readDirectLinksRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const body = ReadDirectLinksRequestToJSON(requestParameters.readDirectLinksRequest);
            const request = {
