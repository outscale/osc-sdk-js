...
import { CreateUserRequestToJSON, CreateUserResponseFromJSON, DeleteUserRequestToJSON, DeleteUserResponseFromJSON, ReadUsersRequestToJSON, ReadUsersResponseFromJSON, UpdateUserRequestToJSON, UpdateUserResponseFromJSON, } from '../models';
/**
 *
 */
export class UserApi extends runtime.BaseAPI {
    ...
    createUserRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const body = CreateUserRequestToJSON(requestParameters.createUserRequest);
            const request = {
                path: `/CreateUser`,
                method: 'POST',
    ...
    deleteUserRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const body = DeleteUserRequestToJSON(requestParameters.deleteUserRequest);
            const request = {
                path: `/DeleteUser`,
                method: 'POST',
                headers: headerParameters,
    ...
    readUsersRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const body = ReadUsersRequestToJSON(requestParameters.readUsersRequest);
            const request = {
                path: `/ReadUsers`,
                method: 'POST',
                headers: headerParameters,
    ...
    updateUserRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const body = UpdateUserRequestToJSON(requestParameters.updateUserRequest);
            const request = {
                path: `/UpdateUser`,
                method: 'POST',
                headers: headerParameters,
