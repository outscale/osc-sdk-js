...
import { CreateRouteTableRequestToJSON, CreateRouteTableResponseFromJSON, DeleteRouteTableRequestToJSON, DeleteRouteTableResponseFromJSON, LinkRouteTableRequestToJSON, LinkRouteTableResponseFromJSON, ReadRouteTablesRequestToJSON, ReadRouteTablesResponseFromJSON, UnlinkRouteTableRequestToJSON, UnlinkRouteTableResponseFromJSON, UpdateRouteTableLinkRequestToJSON, UpdateRouteTableLinkResponseFromJSON, } from '../models';
/**
 *
 */
export class RouteTableApi extends runtime.BaseAPI {
    ...
    updateRouteTableLinkRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const body = UpdateRouteTableLinkRequestToJSON(requestParameters.updateRouteTableLinkRequest);
            const request = {
