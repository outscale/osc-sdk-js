...
import { ReadCatalogRequestToJSON, ReadCatalogResponseFromJSON, ReadCatalogsRequestToJSON, ReadCatalogsResponseFromJSON, ReadUnitPriceRequestToJSON, ReadUnitPriceResponseFromJSON, } from '../models';
/**
 *
 */
export class CatalogApi extends runtime.BaseAPI {
     ...
     */
    readCatalogRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const body = ReadCatalogRequestToJSON(requestParameters.readCatalogRequest);
            const request = {
                path: `/ReadCatalog`,
                method: 'POST',
     ...
     */
    readCatalogsRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const queryParameters = {};
            const headerParameters = {};
            headerParameters['Content-Type'] = 'application/json';
            ...
            const body = ReadCatalogsRequestToJSON(requestParameters.readCatalogsRequest);
            const request = {
                path: `/ReadCatalogs`,
                method: 'POST',
                headers: headerParameters,
     ...
     */
    readUnitPriceRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const queryParameters = {};
            const headerParameters = {};
            headerParameters['Content-Type'] = 'application/json';
            ...
            const body = ReadUnitPriceRequestToJSON(requestParameters.readUnitPriceRequest);
            const request = {
                path: `/ReadUnitPrice`,
                method: 'POST',
                headers: headerParameters,
