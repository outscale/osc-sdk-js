...
import { CreateVmsRequestToJSON, CreateVmsResponseFromJSON, DeleteVmsRequestToJSON, DeleteVmsResponseFromJSON, ReadAdminPasswordRequestToJSON, ReadAdminPasswordResponseFromJSON, ReadConsoleOutputRequestToJSON, ReadConsoleOutputResponseFromJSON, ReadVmTypesRequestToJSON, ReadVmTypesResponseFromJSON, ReadVmsRequestToJSON, ReadVmsResponseFromJSON, ReadVmsStateRequestToJSON, ReadVmsStateResponseFromJSON, ReadVmsStopHistoryRequestToJSON, ReadVmsStopHistoryResponseFromJSON, RebootVmsRequestToJSON, RebootVmsResponseFromJSON, StartVmsRequestToJSON, StartVmsResponseFromJSON, StopVmsRequestToJSON, StopVmsResponseFromJSON, UpdateVmRequestToJSON, UpdateVmResponseFromJSON, } from '../models';
/**
 *
 */
export class VmApi extends runtime.BaseAPI {
     ...
     */
    readVmsStopHistoryRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const queryParameters = {};
            const headerParameters = {};
            headerParameters['Content-Type'] = 'application/json';
            ...
            const body = ReadVmsStopHistoryRequestToJSON(requestParameters.readVmsStopHistoryRequest);
            const request = {
            ...
            const response = yield this.request(request, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => ReadVmsStopHistoryResponseFromJSON(jsonValue));
        });
    }
    /**
     * Lists the stop history of one or more VMs.
    ...
    readVmsStopHistory() {
        return __awaiter(this, arguments, void 0, function* (requestParameters = {}, initOverrides) {
            const response = yield this.readVmsStopHistoryRaw(requestParameters, initOverrides);
            return yield response.value();
        });
    }
    /**
