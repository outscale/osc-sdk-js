...
export class ClientGatewayApi extends runtime.BaseAPI {
    ...
    createClientGatewayRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const body = CreateClientGatewayRequestToJSON(requestParameters.createClientGatewayRequest);
            const request = {
    ...
    deleteClientGatewayRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const body = DeleteClientGatewayRequestToJSON(requestParameters.deleteClientGatewayRequest);
            const request = {
    ...
    readClientGatewaysRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const body = ReadClientGatewaysRequestToJSON(requestParameters.readClientGatewaysRequest);
            const request = {
