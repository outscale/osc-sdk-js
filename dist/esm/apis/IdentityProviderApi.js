...
import { DisableOutscaleLoginPerUsersRequestToJSON, DisableOutscaleLoginPerUsersResponseFromJSON, DisableOutscaleLoginRequestToJSON, DisableOutscaleLoginResponseFromJSON, EnableOutscaleLoginForUsersRequestToJSON, EnableOutscaleLoginForUsersResponseFromJSON, EnableOutscaleLoginPerUsersRequestToJSON, EnableOutscaleLoginPerUsersResponseFromJSON, EnableOutscaleLoginRequestToJSON, EnableOutscaleLoginResponseFromJSON, } from '../models';
/**
 *
 */
export class IdentityProviderApi extends runtime.BaseAPI {
    ...
    disableOutscaleLoginRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const body = DisableOutscaleLoginRequestToJSON(requestParameters.disableOutscaleLoginRequest);
            const request = {
    ...
    disableOutscaleLoginPerUsersRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const body = DisableOutscaleLoginPerUsersRequestToJSON(requestParameters.disableOutscaleLoginPerUsersRequest);
            const request = {
    ...
    enableOutscaleLoginRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const body = EnableOutscaleLoginRequestToJSON(requestParameters.enableOutscaleLoginRequest);
            const request = {
    ...
    enableOutscaleLoginForUsersZzRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const body = EnableOutscaleLoginForUsersRequestToJSON(requestParameters.enableOutscaleLoginForUsersRequest);
            const request = {
    ...
    enableOutscaleLoginPerUsersRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const body = EnableOutscaleLoginPerUsersRequestToJSON(requestParameters.enableOutscaleLoginPerUsersRequest);
            const request = {
