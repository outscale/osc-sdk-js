...
import { CreateProductTypeRequestToJSON, CreateProductTypeResponseFromJSON, DeleteProductTypeRequestToJSON, DeleteProductTypeResponseFromJSON, ReadProductTypesRequestToJSON, ReadProductTypesResponseFromJSON, } from '../models';
/**
 *
 */
export class ProductTypeApi extends runtime.BaseAPI {
    ...
    createProductTypeRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const body = CreateProductTypeRequestToJSON(requestParameters.createProductTypeRequest);
            const request = {
     ...
     */
    deleteProductTypeRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const queryParameters = {};
            const headerParameters = {};
            headerParameters['Content-Type'] = 'application/json';
            ...
            const body = DeleteProductTypeRequestToJSON(requestParameters.deleteProductTypeRequest);
            const request = {
    ...
    readProductTypesRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const headerParameters = {};
            headerParameters['Content-Type'] = 'application/json';
            const body = ReadProductTypesRequestToJSON(requestParameters.readProductTypesRequest);
            const request = {
