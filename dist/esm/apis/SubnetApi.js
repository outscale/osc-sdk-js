...
export class SubnetApi extends runtime.BaseAPI {
    ...
    createSubnetRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const body = CreateSubnetRequestToJSON(requestParameters.createSubnetRequest);
            const request = {
                path: `/CreateSubnet`,
                method: 'POST',
    ...
    deleteSubnetRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const body = DeleteSubnetRequestToJSON(requestParameters.deleteSubnetRequest);
            const request = {
                path: `/DeleteSubnet`,
                method: 'POST',
                headers: headerParameters,
    ...
    readSubnetsRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const body = ReadSubnetsRequestToJSON(requestParameters.readSubnetsRequest);
            const request = {
                path: `/ReadSubnets`,
                method: 'POST',
                headers: headerParameters,
    ...
    updateSubnetRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const body = UpdateSubnetRequestToJSON(requestParameters.updateSubnetRequest);
            const request = {
                path: `/UpdateSubnet`,
                method: 'POST',
                headers: headerParameters,
