...
export function ShutdownBehaviorConfigurationFromJSON(json) {
    return ShutdownBehaviorConfigurationFromJSONTyped(json, false);
}
export function ShutdownBehaviorConfigurationFromJSONTyped(json, ignoreDiscriminator) {
...
export function ShutdownBehaviorConfigurationToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
