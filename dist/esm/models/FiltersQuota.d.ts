...
export declare function FiltersQuotaFromJSON(json: any): FiltersQuota;
export declare function FiltersQuotaFromJSONTyped(json: any, ignoreDiscriminator: boolean): FiltersQuota;
export declare function FiltersQuotaToJSON(value?: FiltersQuota | null): any;
