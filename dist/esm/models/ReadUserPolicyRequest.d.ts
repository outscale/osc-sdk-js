 ...
 *
 * @export
 * @interface ReadUserPolicyRequest
 */
export interface ReadUserPolicyRequest {
    /**
     * If true, checks whether you have the required permissions to perform the action.
     * @type {boolean}
     * @memberof ReadUserPolicyRequest
     */
    dryRun?: boolean;
    /**
...
export declare function ReadUserPolicyRequestFromJSON(json: any): ReadUserPolicyRequest;
export declare function ReadUserPolicyRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): ReadUserPolicyRequest;
export declare function ReadUserPolicyRequestToJSON(value?: ReadUserPolicyRequest | null): any;
