...
export declare function VmsStopHistoryFromJSON(json: any): VmsStopHistory;
export declare function VmsStopHistoryFromJSONTyped(json: any, ignoreDiscriminator: boolean): VmsStopHistory;
export declare function VmsStopHistoryToJSON(value?: VmsStopHistory | null): any;
