...
import { FiltersReadVolumeUpdateTaskFromJSON, FiltersReadVolumeUpdateTaskToJSON, } from './FiltersReadVolumeUpdateTask';
export function ReadVolumeUpdateTasksRequestFromJSON(json) {
    return ReadVolumeUpdateTasksRequestFromJSONTyped(json, false);
}
export function ReadVolumeUpdateTasksRequestFromJSONTyped(json, ignoreDiscriminator) {
...
export function ReadVolumeUpdateTasksRequestToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
