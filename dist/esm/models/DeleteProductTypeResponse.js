...
export function DeleteProductTypeResponseFromJSON(json) {
    return DeleteProductTypeResponseFromJSONTyped(json, false);
}
export function DeleteProductTypeResponseFromJSONTyped(json, ignoreDiscriminator) {
...
export function DeleteProductTypeResponseToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
