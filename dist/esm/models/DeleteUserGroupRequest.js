...
export function DeleteUserGroupRequestFromJSON(json) {
    return DeleteUserGroupRequestFromJSONTyped(json, false);
}
export function DeleteUserGroupRequestFromJSONTyped(json, ignoreDiscriminator) {
...
export function DeleteUserGroupRequestToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
