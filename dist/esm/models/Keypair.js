...
export function KeypairFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'keypairType': !exists(json, 'KeypairType') ? undefined : json['KeypairType'],
        'tags': !exists(json, 'Tags') ? undefined : (json['Tags'].map(ResourceTagFromJSON)),
    };
}
export function KeypairToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
