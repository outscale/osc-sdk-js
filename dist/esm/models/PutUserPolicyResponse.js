...
export function PutUserPolicyResponseFromJSON(json) {
    return PutUserPolicyResponseFromJSONTyped(json, false);
}
export function PutUserPolicyResponseFromJSONTyped(json, ignoreDiscriminator) {
...
export function PutUserPolicyResponseToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
