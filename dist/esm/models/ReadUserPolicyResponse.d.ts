...
export declare function ReadUserPolicyResponseFromJSON(json: any): ReadUserPolicyResponse;
export declare function ReadUserPolicyResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ReadUserPolicyResponse;
export declare function ReadUserPolicyResponseToJSON(value?: ReadUserPolicyResponse | null): any;
