...
export function DedicatedGroupFromJSON(json) {
    return DedicatedGroupFromJSONTyped(json, false);
}
export function DedicatedGroupFromJSONTyped(json, ignoreDiscriminator) {
...
export function DedicatedGroupToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
