...
export function FiltersVmsStopHistoryFromJSON(json) {
    return FiltersVmsStopHistoryFromJSONTyped(json, false);
}
export function FiltersVmsStopHistoryFromJSONTyped(json, ignoreDiscriminator) {
...
export function FiltersVmsStopHistoryToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
