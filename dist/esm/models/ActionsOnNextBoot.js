...
import { SecureBootActionFromJSON, SecureBootActionToJSON, } from './SecureBootAction';
export function ActionsOnNextBootFromJSON(json) {
    return ActionsOnNextBootFromJSONTyped(json, false);
}
export function ActionsOnNextBootFromJSONTyped(json, ignoreDiscriminator) {
...
export function ActionsOnNextBootToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
