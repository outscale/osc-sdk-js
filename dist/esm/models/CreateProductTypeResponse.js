...
export function CreateProductTypeResponseFromJSON(json) {
    return CreateProductTypeResponseFromJSONTyped(json, false);
}
export function CreateProductTypeResponseFromJSONTyped(json, ignoreDiscriminator) {
...
export function CreateProductTypeResponseToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
