...
export function FiltersCatalogsFromJSON(json) {
    return FiltersCatalogsFromJSONTyped(json, false);
}
export function FiltersCatalogsFromJSONTyped(json, ignoreDiscriminator) {
...
export function FiltersCatalogsToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
