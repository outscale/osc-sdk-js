...
export function DisableOutscaleLoginRequestFromJSON(json) {
    return DisableOutscaleLoginRequestFromJSONTyped(json, false);
}
export function DisableOutscaleLoginRequestFromJSONTyped(json, ignoreDiscriminator) {
...
export function DisableOutscaleLoginRequestToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
