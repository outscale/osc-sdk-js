...
import { FiltersCatalogsFromJSON, FiltersCatalogsToJSON, } from './FiltersCatalogs';
export function ReadCatalogsRequestFromJSON(json) {
    return ReadCatalogsRequestFromJSONTyped(json, false);
}
export function ReadCatalogsRequestFromJSONTyped(json, ignoreDiscriminator) {
...
export function ReadCatalogsRequestToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
