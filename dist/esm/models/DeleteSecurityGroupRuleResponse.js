...
export function DeleteSecurityGroupRuleResponseFromJSON(json) {
    return DeleteSecurityGroupRuleResponseFromJSONTyped(json, false);
}
export function DeleteSecurityGroupRuleResponseFromJSONTyped(json, ignoreDiscriminator) {
...
export function DeleteSecurityGroupRuleResponseToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
