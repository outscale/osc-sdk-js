...
export function FiltersReadImageExportTaskFromJSON(json) {
    return FiltersReadImageExportTaskFromJSONTyped(json, false);
}
export function FiltersReadImageExportTaskFromJSONTyped(json, ignoreDiscriminator) {
...
export function FiltersReadImageExportTaskToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
