...
export function RemoveUserFromUserGroupRequestFromJSON(json) {
    return RemoveUserFromUserGroupRequestFromJSONTyped(json, false);
}
export function RemoveUserFromUserGroupRequestFromJSONTyped(json, ignoreDiscriminator) {
...
export function RemoveUserFromUserGroupRequestToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
