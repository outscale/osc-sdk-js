 ...
 *
 * @export
 * @interface ReadUnitPriceRequest
 */
export interface ReadUnitPriceRequest {
    /**
     * The operation associated with the catalog entry (for example, `RunInstances-OD` or `CreateVolume`).
     * @type {string}
     * @memberof ReadUnitPriceRequest
     */
    operation: string;
    /**
...
export declare function ReadUnitPriceRequestFromJSON(json: any): ReadUnitPriceRequest;
export declare function ReadUnitPriceRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): ReadUnitPriceRequest;
export declare function ReadUnitPriceRequestToJSON(value?: ReadUnitPriceRequest | null): any;
