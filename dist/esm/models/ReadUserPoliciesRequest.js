...
export function ReadUserPoliciesRequestFromJSON(json) {
    return ReadUserPoliciesRequestFromJSONTyped(json, false);
}
export function ReadUserPoliciesRequestFromJSONTyped(json, ignoreDiscriminator) {
...
export function ReadUserPoliciesRequestToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
