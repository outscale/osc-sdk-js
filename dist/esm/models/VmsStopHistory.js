...
export function VmsStopHistoryFromJSON(json) {
    return VmsStopHistoryFromJSONTyped(json, false);
}
export function VmsStopHistoryFromJSONTyped(json, ignoreDiscriminator) {
...
export function VmsStopHistoryToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
