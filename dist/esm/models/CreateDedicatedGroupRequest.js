...
export function CreateDedicatedGroupRequestFromJSON(json) {
    return CreateDedicatedGroupRequestFromJSONTyped(json, false);
}
export function CreateDedicatedGroupRequestFromJSONTyped(json, ignoreDiscriminator) {
...
export function CreateDedicatedGroupRequestToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
