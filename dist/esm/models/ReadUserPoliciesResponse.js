...
export function ReadUserPoliciesResponseFromJSON(json) {
    return ReadUserPoliciesResponseFromJSONTyped(json, false);
}
export function ReadUserPoliciesResponseFromJSONTyped(json, ignoreDiscriminator) {
...
export function ReadUserPoliciesResponseToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
