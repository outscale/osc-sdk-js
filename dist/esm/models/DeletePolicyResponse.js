...
export function DeletePolicyResponseFromJSON(json) {
    return DeletePolicyResponseFromJSONTyped(json, false);
}
export function DeletePolicyResponseFromJSONTyped(json, ignoreDiscriminator) {
...
export function DeletePolicyResponseToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
