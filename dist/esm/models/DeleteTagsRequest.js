...
export function DeleteTagsRequestFromJSON(json) {
    return DeleteTagsRequestFromJSONTyped(json, false);
}
export function DeleteTagsRequestFromJSONTyped(json, ignoreDiscriminator) {
...
export function DeleteTagsRequestToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
