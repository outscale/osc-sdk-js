...
export function AddUserToUserGroupRequestFromJSON(json) {
    return AddUserToUserGroupRequestFromJSONTyped(json, false);
}
export function AddUserToUserGroupRequestFromJSONTyped(json, ignoreDiscriminator) {
...
export function AddUserToUserGroupRequestToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
