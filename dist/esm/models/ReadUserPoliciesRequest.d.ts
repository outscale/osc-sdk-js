...
export declare function ReadUserPoliciesRequestFromJSON(json: any): ReadUserPoliciesRequest;
export declare function ReadUserPoliciesRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): ReadUserPoliciesRequest;
export declare function ReadUserPoliciesRequestToJSON(value?: ReadUserPoliciesRequest | null): any;
