...
export function CreateDedicatedGroupResponseFromJSON(json) {
    return CreateDedicatedGroupResponseFromJSONTyped(json, false);
}
export function CreateDedicatedGroupResponseFromJSONTyped(json, ignoreDiscriminator) {
...
export function CreateDedicatedGroupResponseToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
