...
export function FiltersDedicatedGroupFromJSON(json) {
    return FiltersDedicatedGroupFromJSONTyped(json, false);
}
export function FiltersDedicatedGroupFromJSONTyped(json, ignoreDiscriminator) {
...
export function FiltersDedicatedGroupToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
