...
export function CreateVmGroupRequestFromJSON(json) {
    return CreateVmGroupRequestFromJSONTyped(json, false);
}
export function CreateVmGroupRequestFromJSONTyped(json, ignoreDiscriminator) {
...
export function CreateVmGroupRequestToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
