...
export function DeleteDedicatedGroupRequestFromJSON(json) {
    return DeleteDedicatedGroupRequestFromJSONTyped(json, false);
}
export function DeleteDedicatedGroupRequestFromJSONTyped(json, ignoreDiscriminator) {
...
export function DeleteDedicatedGroupRequestToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
