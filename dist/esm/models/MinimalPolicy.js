...
export function MinimalPolicyFromJSON(json) {
    return MinimalPolicyFromJSONTyped(json, false);
}
export function MinimalPolicyFromJSONTyped(json, ignoreDiscriminator) {
...
export function MinimalPolicyToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
