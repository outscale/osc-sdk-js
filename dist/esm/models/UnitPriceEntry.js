...
export function UnitPriceEntryFromJSON(json) {
    return UnitPriceEntryFromJSONTyped(json, false);
}
export function UnitPriceEntryFromJSONTyped(json, ignoreDiscriminator) {
...
export function UnitPriceEntryToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
