 ...
 */
export function VolumeUpdateParametersFromJSON(json) {
    return VolumeUpdateParametersFromJSONTyped(json, false);
}
export function VolumeUpdateParametersFromJSONTyped(json, ignoreDiscriminator) {
...
export function VolumeUpdateParametersToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
