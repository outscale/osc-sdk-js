...
export function ReadCO2EmissionAccountRequestFromJSON(json) {
    return ReadCO2EmissionAccountRequestFromJSONTyped(json, false);
}
export function ReadCO2EmissionAccountRequestFromJSONTyped(json, ignoreDiscriminator) {
...
export function ReadCO2EmissionAccountRequestToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
