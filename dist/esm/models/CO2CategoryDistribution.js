...
export function CO2CategoryDistributionFromJSON(json) {
    return CO2CategoryDistributionFromJSONTyped(json, false);
}
export function CO2CategoryDistributionFromJSONTyped(json, ignoreDiscriminator) {
...
export function CO2CategoryDistributionToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
