...
export function Phase2OptionsToUpdateFromJSON(json) {
    return Phase2OptionsToUpdateFromJSONTyped(json, false);
}
export function Phase2OptionsToUpdateFromJSONTyped(json, ignoreDiscriminator) {
...
export function Phase2OptionsToUpdateToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
