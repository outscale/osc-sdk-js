...
export function DisableOutscaleLoginPerUsersResponseFromJSON(json) {
    return DisableOutscaleLoginPerUsersResponseFromJSONTyped(json, false);
}
export function DisableOutscaleLoginPerUsersResponseFromJSONTyped(json, ignoreDiscriminator) {
...
export function DisableOutscaleLoginPerUsersResponseToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
