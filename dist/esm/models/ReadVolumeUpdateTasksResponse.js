...
import { VolumeUpdateTaskFromJSON, VolumeUpdateTaskToJSON, } from './VolumeUpdateTask';
export function ReadVolumeUpdateTasksResponseFromJSON(json) {
    return ReadVolumeUpdateTasksResponseFromJSONTyped(json, false);
}
export function ReadVolumeUpdateTasksResponseFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'volumeUpdateTasks': !exists(json, 'VolumeUpdateTasks') ? undefined : (json['VolumeUpdateTasks'].map(VolumeUpdateTaskFromJSON)),
    };
}
export function ReadVolumeUpdateTasksResponseToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'VolumeUpdateTasks': value.volumeUpdateTasks === undefined ? undefined : (value.volumeUpdateTasks.map(VolumeUpdateTaskToJSON)),
    };
}
