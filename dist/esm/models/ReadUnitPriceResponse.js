...
import { UnitPriceEntryFromJSON, UnitPriceEntryToJSON, } from './UnitPriceEntry';
export function ReadUnitPriceResponseFromJSON(json) {
    return ReadUnitPriceResponseFromJSONTyped(json, false);
}
export function ReadUnitPriceResponseFromJSONTyped(json, ignoreDiscriminator) {
...
export function ReadUnitPriceResponseToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
