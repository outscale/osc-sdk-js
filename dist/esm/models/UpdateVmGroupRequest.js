...
export function UpdateVmGroupRequestFromJSON(json) {
    return UpdateVmGroupRequestFromJSONTyped(json, false);
}
export function UpdateVmGroupRequestFromJSONTyped(json, ignoreDiscriminator) {
...
export function UpdateVmGroupRequestToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
