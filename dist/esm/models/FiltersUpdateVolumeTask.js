...
export function FiltersUpdateVolumeTaskFromJSON(json) {
    return FiltersUpdateVolumeTaskFromJSONTyped(json, false);
}
export function FiltersUpdateVolumeTaskFromJSONTyped(json, ignoreDiscriminator) {
...
export function FiltersUpdateVolumeTaskToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
