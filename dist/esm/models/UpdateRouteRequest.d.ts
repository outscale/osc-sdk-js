...
export declare function UpdateRouteRequestFromJSON(json: any): UpdateRouteRequest;
export declare function UpdateRouteRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): UpdateRouteRequest;
export declare function UpdateRouteRequestToJSON(value?: UpdateRouteRequest | null): any;
