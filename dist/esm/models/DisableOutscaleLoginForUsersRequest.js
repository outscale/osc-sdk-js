...
export function DisableOutscaleLoginForUsersRequestFromJSON(json) {
    return DisableOutscaleLoginForUsersRequestFromJSONTyped(json, false);
}
export function DisableOutscaleLoginForUsersRequestFromJSONTyped(json, ignoreDiscriminator) {
...
export function DisableOutscaleLoginForUsersRequestToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
