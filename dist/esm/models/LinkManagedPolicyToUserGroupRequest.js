...
export function LinkManagedPolicyToUserGroupRequestFromJSON(json) {
    return LinkManagedPolicyToUserGroupRequestFromJSONTyped(json, false);
}
export function LinkManagedPolicyToUserGroupRequestFromJSONTyped(json, ignoreDiscriminator) {
...
export function LinkManagedPolicyToUserGroupRequestToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
