...
export function FiltersReadVolumeUpdateTaskFromJSON(json) {
    return FiltersReadVolumeUpdateTaskFromJSONTyped(json, false);
}
export function FiltersReadVolumeUpdateTaskFromJSONTyped(json, ignoreDiscriminator) {
...
export function FiltersReadVolumeUpdateTaskToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
