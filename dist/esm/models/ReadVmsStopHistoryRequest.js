...
import { FiltersVmsStopHistoryFromJSON, FiltersVmsStopHistoryToJSON, } from './FiltersVmsStopHistory';
export function ReadVmsStopHistoryRequestFromJSON(json) {
    return ReadVmsStopHistoryRequestFromJSONTyped(json, false);
}
export function ReadVmsStopHistoryRequestFromJSONTyped(json, ignoreDiscriminator) {
...
export function ReadVmsStopHistoryRequestToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
