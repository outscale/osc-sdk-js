...
export function EnableOutscaleLoginResponseFromJSON(json) {
    return EnableOutscaleLoginResponseFromJSONTyped(json, false);
}
export function EnableOutscaleLoginResponseFromJSONTyped(json, ignoreDiscriminator) {
...
export function EnableOutscaleLoginResponseToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
