...
export function ReadUserGroupsRequestFromJSON(json) {
    return ReadUserGroupsRequestFromJSONTyped(json, false);
}
export function ReadUserGroupsRequestFromJSONTyped(json, ignoreDiscriminator) {
...
export function ReadUserGroupsRequestToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
