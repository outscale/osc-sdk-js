...
import { FiltersReadImageExportTaskFromJSON, FiltersReadImageExportTaskToJSON, } from './FiltersReadImageExportTask';
export function ReadImageExportTasksRequestFromJSON(json) {
    return ReadImageExportTasksRequestFromJSONTyped(json, false);
}
export function ReadImageExportTasksRequestFromJSONTyped(json, ignoreDiscriminator) {
...
export function ReadImageExportTasksRequestToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
