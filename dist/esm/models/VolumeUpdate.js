...
import { VolumeUpdateParametersFromJSON, VolumeUpdateParametersToJSON, } from './VolumeUpdateParameters';
export function VolumeUpdateFromJSON(json) {
    return VolumeUpdateFromJSONTyped(json, false);
}
export function VolumeUpdateFromJSONTyped(json, ignoreDiscriminator) {
...
export function VolumeUpdateToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
