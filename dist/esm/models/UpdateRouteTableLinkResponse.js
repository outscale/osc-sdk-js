...
export function UpdateRouteTableLinkResponseFromJSON(json) {
    return UpdateRouteTableLinkResponseFromJSONTyped(json, false);
}
export function UpdateRouteTableLinkResponseFromJSONTyped(json, ignoreDiscriminator) {
...
export function UpdateRouteTableLinkResponseToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
