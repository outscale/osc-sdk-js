 ...
 *
 * @export
 * @interface RemoveUserFromUserGroupResponse
 */
export interface RemoveUserFromUserGroupResponse {
    /**
     *
     * @type {ModelResponseContext}
     * @memberof RemoveUserFromUserGroupResponse
     */
    responseContext?: ModelResponseContext;
}
export declare function RemoveUserFromUserGroupResponseFromJSON(json: any): RemoveUserFromUserGroupResponse;
export declare function RemoveUserFromUserGroupResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): RemoveUserFromUserGroupResponse;
export declare function RemoveUserFromUserGroupResponseToJSON(value?: RemoveUserFromUserGroupResponse | null): any;
