...
import { VolumeUpdateFromJSON, VolumeUpdateToJSON, } from './VolumeUpdate';
export function VolumeUpdateTaskFromJSON(json) {
    return VolumeUpdateTaskFromJSONTyped(json, false);
}
export function VolumeUpdateTaskFromJSONTyped(json, ignoreDiscriminator) {
...
export function VolumeUpdateTaskToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
