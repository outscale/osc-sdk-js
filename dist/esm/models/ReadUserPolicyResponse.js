...
export function ReadUserPolicyResponseFromJSON(json) {
    return ReadUserPolicyResponseFromJSONTyped(json, false);
}
export function ReadUserPolicyResponseFromJSONTyped(json, ignoreDiscriminator) {
...
export function ReadUserPolicyResponseToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
