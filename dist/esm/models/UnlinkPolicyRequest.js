...
export function UnlinkPolicyRequestFromJSON(json) {
    return UnlinkPolicyRequestFromJSONTyped(json, false);
}
export function UnlinkPolicyRequestFromJSONTyped(json, ignoreDiscriminator) {
...
export function UnlinkPolicyRequestToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
