...
export declare function DisableOutscaleLoginPerUsersResponseFromJSON(json: any): DisableOutscaleLoginPerUsersResponse;
export declare function DisableOutscaleLoginPerUsersResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): DisableOutscaleLoginPerUsersResponse;
export declare function DisableOutscaleLoginPerUsersResponseToJSON(value?: DisableOutscaleLoginPerUsersResponse | null): any;
