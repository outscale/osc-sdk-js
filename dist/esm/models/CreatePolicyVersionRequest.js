...
export function CreatePolicyVersionRequestFromJSON(json) {
    return CreatePolicyVersionRequestFromJSONTyped(json, false);
}
export function CreatePolicyVersionRequestFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'setAsDefault': !exists(json, 'SetAsDefault') ? undefined : json['SetAsDefault'],
    };
}
export function CreatePolicyVersionRequestToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
