...
export function ReadUserPolicyRequestFromJSON(json) {
    return ReadUserPolicyRequestFromJSONTyped(json, false);
}
export function ReadUserPolicyRequestFromJSONTyped(json, ignoreDiscriminator) {
...
export function ReadUserPolicyRequestToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
