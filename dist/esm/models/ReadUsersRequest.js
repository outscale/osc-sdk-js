...
import { FiltersUsersFromJSON, FiltersUsersToJSON, } from './FiltersUsers';
export function ReadUsersRequestFromJSON(json) {
    return ReadUsersRequestFromJSONTyped(json, false);
}
export function ReadUsersRequestFromJSONTyped(json, ignoreDiscriminator) {
...
export function ReadUsersRequestToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
