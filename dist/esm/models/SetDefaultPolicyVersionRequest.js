 ...
 */
export function SetDefaultPolicyVersionRequestFromJSON(json) {
    return SetDefaultPolicyVersionRequestFromJSONTyped(json, false);
}
export function SetDefaultPolicyVersionRequestFromJSONTyped(json, ignoreDiscriminator) {
...
export function SetDefaultPolicyVersionRequestToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
