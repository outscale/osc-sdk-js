...
export function UpdateDirectLinkInterfaceResponseFromJSON(json) {
    return UpdateDirectLinkInterfaceResponseFromJSONTyped(json, false);
}
export function UpdateDirectLinkInterfaceResponseFromJSONTyped(json, ignoreDiscriminator) {
...
export function UpdateDirectLinkInterfaceResponseToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
