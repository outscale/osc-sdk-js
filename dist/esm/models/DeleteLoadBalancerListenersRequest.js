...
export function DeleteLoadBalancerListenersRequestFromJSON(json) {
    return DeleteLoadBalancerListenersRequestFromJSONTyped(json, false);
}
export function DeleteLoadBalancerListenersRequestFromJSONTyped(json, ignoreDiscriminator) {
...
export function DeleteLoadBalancerListenersRequestToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
