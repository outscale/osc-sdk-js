...
export function EnableOutscaleLoginForUsersResponseFromJSON(json) {
    return EnableOutscaleLoginForUsersResponseFromJSONTyped(json, false);
}
export function EnableOutscaleLoginForUsersResponseFromJSONTyped(json, ignoreDiscriminator) {
...
export function EnableOutscaleLoginForUsersResponseToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
