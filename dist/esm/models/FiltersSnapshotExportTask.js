...
export function FiltersSnapshotExportTaskFromJSON(json) {
    return FiltersSnapshotExportTaskFromJSONTyped(json, false);
}
export function FiltersSnapshotExportTaskFromJSONTyped(json, ignoreDiscriminator) {
...
export function FiltersSnapshotExportTaskToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
