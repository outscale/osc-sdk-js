...
export function ReadConsumptionAccountRequestFromJSON(json) {
    return ReadConsumptionAccountRequestFromJSONTyped(json, false);
}
export function ReadConsumptionAccountRequestFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'showResourceDetails': !exists(json, 'ShowResourceDetails') ? undefined : json['ShowResourceDetails'],
        'toDate': json['ToDate'],
    };
}
export function ReadConsumptionAccountRequestToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'ShowResourceDetails': value.showResourceDetails,
        'ToDate': value.toDate,
    };
}
