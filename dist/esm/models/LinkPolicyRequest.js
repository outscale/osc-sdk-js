...
export function LinkPolicyRequestFromJSON(json) {
    return LinkPolicyRequestFromJSONTyped(json, false);
}
export function LinkPolicyRequestFromJSONTyped(json, ignoreDiscriminator) {
...
export function LinkPolicyRequestToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
