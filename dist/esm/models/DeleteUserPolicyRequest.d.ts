...
export declare function DeleteUserPolicyRequestFromJSON(json: any): DeleteUserPolicyRequest;
export declare function DeleteUserPolicyRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): DeleteUserPolicyRequest;
export declare function DeleteUserPolicyRequestToJSON(value?: DeleteUserPolicyRequest | null): any;
