...
export declare function ReadConsumptionAccountResponseFromJSON(json: any): ReadConsumptionAccountResponse;
export declare function ReadConsumptionAccountResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ReadConsumptionAccountResponse;
export declare function ReadConsumptionAccountResponseToJSON(value?: ReadConsumptionAccountResponse | null): any;
