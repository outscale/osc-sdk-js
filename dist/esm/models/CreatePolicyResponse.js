...
export function CreatePolicyResponseFromJSON(json) {
    return CreatePolicyResponseFromJSONTyped(json, false);
}
export function CreatePolicyResponseFromJSONTyped(json, ignoreDiscriminator) {
...
export function CreatePolicyResponseToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
