...
export declare function EnableOutscaleLoginPerUsersResponseFromJSON(json: any): EnableOutscaleLoginPerUsersResponse;
export declare function EnableOutscaleLoginPerUsersResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): EnableOutscaleLoginPerUsersResponse;
export declare function EnableOutscaleLoginPerUsersResponseToJSON(value?: EnableOutscaleLoginPerUsersResponse | null): any;
