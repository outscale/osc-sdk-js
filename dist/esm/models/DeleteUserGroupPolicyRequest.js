...
export function DeleteUserGroupPolicyRequestFromJSON(json) {
    return DeleteUserGroupPolicyRequestFromJSONTyped(json, false);
}
export function DeleteUserGroupPolicyRequestFromJSONTyped(json, ignoreDiscriminator) {
...
export function DeleteUserGroupPolicyRequestToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
