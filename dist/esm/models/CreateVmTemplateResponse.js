...
export function CreateVmTemplateResponseFromJSON(json) {
    return CreateVmTemplateResponseFromJSONTyped(json, false);
}
export function CreateVmTemplateResponseFromJSONTyped(json, ignoreDiscriminator) {
...
export function CreateVmTemplateResponseToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
