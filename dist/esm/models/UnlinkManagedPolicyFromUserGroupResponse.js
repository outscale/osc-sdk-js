...
export function UnlinkManagedPolicyFromUserGroupResponseFromJSON(json) {
    return UnlinkManagedPolicyFromUserGroupResponseFromJSONTyped(json, false);
}
export function UnlinkManagedPolicyFromUserGroupResponseFromJSONTyped(json, ignoreDiscriminator) {
...
export function UnlinkManagedPolicyFromUserGroupResponseToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
