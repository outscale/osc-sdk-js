...
export function UpdateRouteTableLinkRequestFromJSON(json) {
    return UpdateRouteTableLinkRequestFromJSONTyped(json, false);
}
export function UpdateRouteTableLinkRequestFromJSONTyped(json, ignoreDiscriminator) {
...
export function UpdateRouteTableLinkRequestToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
