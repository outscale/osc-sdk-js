...
export function EnableOutscaleLoginPerUsersResponseFromJSON(json) {
    return EnableOutscaleLoginPerUsersResponseFromJSONTyped(json, false);
}
export function EnableOutscaleLoginPerUsersResponseFromJSONTyped(json, ignoreDiscriminator) {
...
export function EnableOutscaleLoginPerUsersResponseToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
