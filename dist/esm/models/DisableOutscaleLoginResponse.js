...
export function DisableOutscaleLoginResponseFromJSON(json) {
    return DisableOutscaleLoginResponseFromJSONTyped(json, false);
}
export function DisableOutscaleLoginResponseFromJSONTyped(json, ignoreDiscriminator) {
...
export function DisableOutscaleLoginResponseToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
