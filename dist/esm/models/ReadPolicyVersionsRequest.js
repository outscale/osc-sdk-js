...
export function ReadPolicyVersionsRequestFromJSON(json) {
    return ReadPolicyVersionsRequestFromJSONTyped(json, false);
}
export function ReadPolicyVersionsRequestFromJSONTyped(json, ignoreDiscriminator) {
...
export function ReadPolicyVersionsRequestToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
