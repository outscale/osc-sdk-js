...
import { VmsStopHistoryFromJSON, VmsStopHistoryToJSON, } from './VmsStopHistory';
export function ReadVmsStopHistoryResponseFromJSON(json) {
    return ReadVmsStopHistoryResponseFromJSONTyped(json, false);
}
export function ReadVmsStopHistoryResponseFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'vmsStopHistory': !exists(json, 'VmsStopHistory') ? undefined : (json['VmsStopHistory'].map(VmsStopHistoryFromJSON)),
    };
}
export function ReadVmsStopHistoryResponseToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'VmsStopHistory': value.vmsStopHistory === undefined ? undefined : (value.vmsStopHistory.map(VmsStopHistoryToJSON)),
    };
}
