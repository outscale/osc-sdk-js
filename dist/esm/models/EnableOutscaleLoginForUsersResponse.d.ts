 ...
 *
 * @export
 * @interface EnableOutscaleLoginForUsersResponse
 */
export interface EnableOutscaleLoginForUsersResponse {
    /**
     *
     * @type {ModelResponseContext}
     * @memberof EnableOutscaleLoginForUsersResponse
     */
    responseContext?: ModelResponseContext;
}
export declare function EnableOutscaleLoginForUsersResponseFromJSON(json: any): EnableOutscaleLoginForUsersResponse;
export declare function EnableOutscaleLoginForUsersResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): EnableOutscaleLoginForUsersResponse;
export declare function EnableOutscaleLoginForUsersResponseToJSON(value?: EnableOutscaleLoginForUsersResponse | null): any;
