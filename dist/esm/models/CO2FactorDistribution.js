...
export function CO2FactorDistributionFromJSON(json) {
    return CO2FactorDistributionFromJSONTyped(json, false);
}
export function CO2FactorDistributionFromJSONTyped(json, ignoreDiscriminator) {
...
export function CO2FactorDistributionToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
