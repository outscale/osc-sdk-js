...
export function CreateLoadBalancerResponseFromJSON(json) {
    return CreateLoadBalancerResponseFromJSONTyped(json, false);
}
export function CreateLoadBalancerResponseFromJSONTyped(json, ignoreDiscriminator) {
...
export function CreateLoadBalancerResponseToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
