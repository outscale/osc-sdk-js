...
export function UnlinkPolicyResponseFromJSON(json) {
    return UnlinkPolicyResponseFromJSONTyped(json, false);
}
export function UnlinkPolicyResponseFromJSONTyped(json, ignoreDiscriminator) {
...
export function UnlinkPolicyResponseToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
