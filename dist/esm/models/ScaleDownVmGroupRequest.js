...
export function ScaleDownVmGroupRequestFromJSON(json) {
    return ScaleDownVmGroupRequestFromJSONTyped(json, false);
}
export function ScaleDownVmGroupRequestFromJSONTyped(json, ignoreDiscriminator) {
...
export function ScaleDownVmGroupRequestToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
