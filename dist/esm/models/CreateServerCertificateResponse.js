...
export function CreateServerCertificateResponseFromJSON(json) {
    return CreateServerCertificateResponseFromJSONTyped(json, false);
}
export function CreateServerCertificateResponseFromJSONTyped(json, ignoreDiscriminator) {
...
export function CreateServerCertificateResponseToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
