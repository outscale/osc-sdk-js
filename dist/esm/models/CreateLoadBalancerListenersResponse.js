...
export function CreateLoadBalancerListenersResponseFromJSON(json) {
    return CreateLoadBalancerListenersResponseFromJSONTyped(json, false);
}
export function CreateLoadBalancerListenersResponseFromJSONTyped(json, ignoreDiscriminator) {
...
export function CreateLoadBalancerListenersResponseToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
