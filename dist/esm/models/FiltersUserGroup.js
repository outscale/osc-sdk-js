...
export function FiltersUserGroupFromJSON(json) {
    return FiltersUserGroupFromJSONTyped(json, false);
}
export function FiltersUserGroupFromJSONTyped(json, ignoreDiscriminator) {
...
export function FiltersUserGroupToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
