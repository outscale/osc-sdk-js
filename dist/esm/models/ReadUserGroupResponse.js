...
export function ReadUserGroupResponseFromJSON(json) {
    return ReadUserGroupResponseFromJSONTyped(json, false);
}
export function ReadUserGroupResponseFromJSONTyped(json, ignoreDiscriminator) {
...
export function ReadUserGroupResponseToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
