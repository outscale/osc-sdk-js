...
export function UpdateDedicatedGroupRequestFromJSON(json) {
    return UpdateDedicatedGroupRequestFromJSONTyped(json, false);
}
export function UpdateDedicatedGroupRequestFromJSONTyped(json, ignoreDiscriminator) {
...
export function UpdateDedicatedGroupRequestToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
