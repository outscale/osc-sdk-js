...
export function EnableOutscaleLoginRequestFromJSON(json) {
    return EnableOutscaleLoginRequestFromJSONTyped(json, false);
}
export function EnableOutscaleLoginRequestFromJSONTyped(json, ignoreDiscriminator) {
...
export function EnableOutscaleLoginRequestToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
