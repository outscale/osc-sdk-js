...
export declare function FiltersImageFromJSON(json: any): FiltersImage;
export declare function FiltersImageFromJSONTyped(json: any, ignoreDiscriminator: boolean): FiltersImage;
export declare function FiltersImageToJSON(value?: FiltersImage | null): any;
