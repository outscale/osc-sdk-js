...
export function UnlinkManagedPolicyFromUserGroupRequestFromJSON(json) {
    return UnlinkManagedPolicyFromUserGroupRequestFromJSONTyped(json, false);
}
export function UnlinkManagedPolicyFromUserGroupRequestFromJSONTyped(json, ignoreDiscriminator) {
...
export function UnlinkManagedPolicyFromUserGroupRequestToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
