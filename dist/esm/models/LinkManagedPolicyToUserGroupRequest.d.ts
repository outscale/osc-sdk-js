 ...
 *
 * @export
 * @interface LinkManagedPolicyToUserGroupRequest
 */
export interface LinkManagedPolicyToUserGroupRequest {
    /**
     * If true, checks whether you have the required permissions to perform the action.
     * @type {boolean}
     * @memberof LinkManagedPolicyToUserGroupRequest
     */
    dryRun?: boolean;
    /**
...
export declare function LinkManagedPolicyToUserGroupRequestFromJSON(json: any): LinkManagedPolicyToUserGroupRequest;
export declare function LinkManagedPolicyToUserGroupRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): LinkManagedPolicyToUserGroupRequest;
export declare function LinkManagedPolicyToUserGroupRequestToJSON(value?: LinkManagedPolicyToUserGroupRequest | null): any;
