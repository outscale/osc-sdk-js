...
export function SecureBootActionFromJSON(json) {
    return SecureBootActionFromJSONTyped(json, false);
}
export function SecureBootActionFromJSONTyped(json, ignoreDiscriminator) {
    return json;
}
export function SecureBootActionToJSON(value) {
    return value;
}
