...
export function UpdateVmTemplateRequestFromJSON(json) {
    return UpdateVmTemplateRequestFromJSONTyped(json, false);
}
export function UpdateVmTemplateRequestFromJSONTyped(json, ignoreDiscriminator) {
...
export function UpdateVmTemplateRequestToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
