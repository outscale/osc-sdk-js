...
export declare function UnitPriceEntryFromJSON(json: any): UnitPriceEntry;
export declare function UnitPriceEntryFromJSONTyped(json: any, ignoreDiscriminator: boolean): UnitPriceEntry;
export declare function UnitPriceEntryToJSON(value?: UnitPriceEntry | null): any;
