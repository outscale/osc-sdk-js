...
function ReadSecurityGroupsRequestFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'filters': !(0, runtime_1.exists)(json, 'Filters') ? undefined : (0, FiltersSecurityGroup_1.FiltersSecurityGroupFromJSON)(json['Filters']),
...
function ReadSecurityGroupsRequestToJSON(value) {
    ...
    return {
        'DryRun': value.dryRun,
        'Filters': (0, FiltersSecurityGroup_1.FiltersSecurityGroupToJSON)(value.filters),
