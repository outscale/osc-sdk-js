...
function ReadClientGatewaysRequestFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'filters': !(0, runtime_1.exists)(json, 'Filters') ? undefined : (0, FiltersClientGateway_1.FiltersClientGatewayFromJSON)(json['Filters']),
...
function ReadClientGatewaysRequestToJSON(value) {
    ...
    return {
        'DryRun': value.dryRun,
        'Filters': (0, FiltersClientGateway_1.FiltersClientGatewayToJSON)(value.filters),
