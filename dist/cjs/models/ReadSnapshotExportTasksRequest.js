...
const FiltersSnapshotExportTask_1 = require("./FiltersSnapshotExportTask");
...
function ReadSnapshotExportTasksRequestFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'filters': !(0, runtime_1.exists)(json, 'Filters') ? undefined : (0, FiltersSnapshotExportTask_1.FiltersSnapshotExportTaskFromJSON)(json['Filters']),
...
function ReadSnapshotExportTasksRequestToJSON(value) {
    ...
    return {
        'DryRun': value.dryRun,
        'Filters': (0, FiltersSnapshotExportTask_1.FiltersSnapshotExportTaskToJSON)(value.filters),
