...
function ReadSnapshotExportTasksRequestFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'filters': !(0, runtime_1.exists)(json, 'Filters') ? undefined : (0, FiltersExportTask_1.FiltersExportTaskFromJSON)(json['Filters']),
...
function ReadSnapshotExportTasksRequestToJSON(value) {
    ...
    return {
        'DryRun': value.dryRun,
        'Filters': (0, FiltersExportTask_1.FiltersExportTaskToJSON)(value.filters),
