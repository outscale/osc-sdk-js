...
function ReadRouteTablesRequestFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'filters': !(0, runtime_1.exists)(json, 'Filters') ? undefined : (0, FiltersRouteTable_1.FiltersRouteTableFromJSON)(json['Filters']),
    };
}
...
function ReadRouteTablesRequestToJSON(value) {
    ...
    return {
        'DryRun': value.dryRun,
        'Filters': (0, FiltersRouteTable_1.FiltersRouteTableToJSON)(value.filters),
    };
}
