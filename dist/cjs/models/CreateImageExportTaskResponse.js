...
function CreateImageExportTaskResponseFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        'imageExportTask': !(0, runtime_1.exists)(json, 'ImageExportTask') ? undefined : (0, ImageExportTask_1.ImageExportTaskFromJSON)(json['ImageExportTask']),
...
function CreateImageExportTaskResponseToJSON(value) {
    ...
    return {
        'ImageExportTask': (0, ImageExportTask_1.ImageExportTaskToJSON)(value.imageExportTask),
