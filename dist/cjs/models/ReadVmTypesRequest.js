...
function ReadVmTypesRequestFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'filters': !(0, runtime_1.exists)(json, 'Filters') ? undefined : (0, FiltersVmType_1.FiltersVmTypeFromJSON)(json['Filters']),
...
function ReadVmTypesRequestToJSON(value) {
    ...
    return {
        'DryRun': value.dryRun,
        'Filters': (0, FiltersVmType_1.FiltersVmTypeToJSON)(value.filters),
