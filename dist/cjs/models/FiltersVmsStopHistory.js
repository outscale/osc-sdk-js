...
exports.FiltersVmsStopHistoryFromJSON = FiltersVmsStopHistoryFromJSON;
exports.FiltersVmsStopHistoryFromJSONTyped = FiltersVmsStopHistoryFromJSONTyped;
exports.FiltersVmsStopHistoryToJSON = FiltersVmsStopHistoryToJSON;
const runtime_1 = require("../runtime");
function FiltersVmsStopHistoryFromJSON(json) {
    return FiltersVmsStopHistoryFromJSONTyped(json, false);
}
function FiltersVmsStopHistoryFromJSONTyped(json, ignoreDiscriminator) {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        'stateReasons': !(0, runtime_1.exists)(json, 'StateReasons') ? undefined : json['StateReasons'],
        'stopDateAfter': !(0, runtime_1.exists)(json, 'StopDateAfter') ? undefined : (new Date(json['StopDateAfter'])),
        'stopDateBefore': !(0, runtime_1.exists)(json, 'StopDateBefore') ? undefined : (new Date(json['StopDateBefore'])),
        'vmIds': !(0, runtime_1.exists)(json, 'VmIds') ? undefined : json['VmIds'],
    };
}
function FiltersVmsStopHistoryToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
