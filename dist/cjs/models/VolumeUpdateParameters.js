...
exports.VolumeUpdateParametersFromJSON = VolumeUpdateParametersFromJSON;
exports.VolumeUpdateParametersFromJSONTyped = VolumeUpdateParametersFromJSONTyped;
exports.VolumeUpdateParametersToJSON = VolumeUpdateParametersToJSON;
function VolumeUpdateParametersFromJSON(json) {
    return VolumeUpdateParametersFromJSONTyped(json, false);
}
function VolumeUpdateParametersFromJSONTyped(json, ignoreDiscriminator) {
...
function VolumeUpdateParametersToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
