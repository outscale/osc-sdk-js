...
function CreateKeypairResponseFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        'keypair': !(0, runtime_1.exists)(json, 'Keypair') ? undefined : (0, KeypairCreated_1.KeypairCreatedFromJSON)(json['Keypair']),
...
function CreateKeypairResponseToJSON(value) {
    ...
    return {
        'Keypair': (0, KeypairCreated_1.KeypairCreatedToJSON)(value.keypair),
