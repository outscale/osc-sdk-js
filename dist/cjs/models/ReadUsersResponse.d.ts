...
export declare function ReadUsersResponseFromJSON(json: any): ReadUsersResponse;
export declare function ReadUsersResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ReadUsersResponse;
export declare function ReadUsersResponseToJSON(value?: ReadUsersResponse | null): any;
