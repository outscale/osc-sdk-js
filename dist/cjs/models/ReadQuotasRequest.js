...
function ReadQuotasRequestFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'filters': !(0, runtime_1.exists)(json, 'Filters') ? undefined : (0, FiltersQuota_1.FiltersQuotaFromJSON)(json['Filters']),
    };
}
...
function ReadQuotasRequestToJSON(value) {
    ...
    return {
        'DryRun': value.dryRun,
        'Filters': (0, FiltersQuota_1.FiltersQuotaToJSON)(value.filters),
    };
}
