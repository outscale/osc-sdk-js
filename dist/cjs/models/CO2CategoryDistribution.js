...
exports.CO2CategoryDistributionFromJSON = CO2CategoryDistributionFromJSON;
exports.CO2CategoryDistributionFromJSONTyped = CO2CategoryDistributionFromJSONTyped;
exports.CO2CategoryDistributionToJSON = CO2CategoryDistributionToJSON;
const runtime_1 = require("../runtime");
function CO2CategoryDistributionFromJSON(json) {
    return CO2CategoryDistributionFromJSONTyped(json, false);
}
function CO2CategoryDistributionFromJSONTyped(json, ignoreDiscriminator) {
...
function CO2CategoryDistributionToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
