...
function SecurityGroupRuleFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'securityGroupRuleId': !(0, runtime_1.exists)(json, 'SecurityGroupRuleId') ? undefined : json['SecurityGroupRuleId'],
        'securityGroupsMembers': !(0, runtime_1.exists)(json, 'SecurityGroupsMembers') ? undefined : (json['SecurityGroupsMembers'].map(SecurityGroupsMember_1.SecurityGroupsMemberFromJSON)),
        'serviceIds': !(0, runtime_1.exists)(json, 'ServiceIds') ? undefined : json['ServiceIds'],
...
function SecurityGroupRuleToJSON(value) {
    ...
    return {
        ...
        'SecurityGroupRuleId': value.securityGroupRuleId,
