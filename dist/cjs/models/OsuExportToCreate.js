...
function OsuExportToCreateFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'osuApiKey': !(0, runtime_1.exists)(json, 'OsuApiKey') ? undefined : (0, OsuApiKey_1.OsuApiKeyFromJSON)(json['OsuApiKey']),
        'osuBucket': json['OsuBucket'],
        'osuManifestUrl': !(0, runtime_1.exists)(json, 'OsuManifestUrl') ? undefined : json['OsuManifestUrl'],
...
function OsuExportToCreateToJSON(value) {
    ...
    return {
        ...
        'OsuApiKey': (0, OsuApiKey_1.OsuApiKeyToJSON)(value.osuApiKey),
