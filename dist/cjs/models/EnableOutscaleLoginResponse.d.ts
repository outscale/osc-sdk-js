...
export declare function EnableOutscaleLoginResponseFromJSON(json: any): EnableOutscaleLoginResponse;
export declare function EnableOutscaleLoginResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): EnableOutscaleLoginResponse;
export declare function EnableOutscaleLoginResponseToJSON(value?: EnableOutscaleLoginResponse | null): any;
