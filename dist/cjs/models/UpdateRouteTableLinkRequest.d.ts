 ...
 *
 * @export
 * @interface UpdateRouteTableLinkRequest
 */
export interface UpdateRouteTableLinkRequest {
    /**
     * If true, checks whether you have the required permissions to perform the action.
     * @type {boolean}
     * @memberof UpdateRouteTableLinkRequest
     */
    dryRun?: boolean;
    /**
...
export declare function UpdateRouteTableLinkRequestFromJSON(json: any): UpdateRouteTableLinkRequest;
export declare function UpdateRouteTableLinkRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): UpdateRouteTableLinkRequest;
export declare function UpdateRouteTableLinkRequestToJSON(value?: UpdateRouteTableLinkRequest | null): any;
