...
function ReadSnapshotsRequestFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'filters': !(0, runtime_1.exists)(json, 'Filters') ? undefined : (0, FiltersSnapshot_1.FiltersSnapshotFromJSON)(json['Filters']),
    };
}
...
function ReadSnapshotsRequestToJSON(value) {
    ...
    return {
        'DryRun': value.dryRun,
        'Filters': (0, FiltersSnapshot_1.FiltersSnapshotToJSON)(value.filters),
    };
}
