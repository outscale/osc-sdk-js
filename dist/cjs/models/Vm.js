...
const ShutdownBehaviorConfiguration_1 = require("./ShutdownBehaviorConfiguration");
...
function VmFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'shutdownBehaviorConfiguration': !(0, runtime_1.exists)(json, 'ShutdownBehaviorConfiguration') ? undefined : (0, ShutdownBehaviorConfiguration_1.ShutdownBehaviorConfigurationFromJSON)(json['ShutdownBehaviorConfiguration']),
...
function VmToJSON(value) {
    ...
    return {
        ...
        'ShutdownBehaviorConfiguration': (0, ShutdownBehaviorConfiguration_1.ShutdownBehaviorConfigurationToJSON)(value.shutdownBehaviorConfiguration),
        'State': value.state,
