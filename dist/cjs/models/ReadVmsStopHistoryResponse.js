...
exports.ReadVmsStopHistoryResponseFromJSON = ReadVmsStopHistoryResponseFromJSON;
exports.ReadVmsStopHistoryResponseFromJSONTyped = ReadVmsStopHistoryResponseFromJSONTyped;
exports.ReadVmsStopHistoryResponseToJSON = ReadVmsStopHistoryResponseToJSON;
const runtime_1 = require("../runtime");
const ModelResponseContext_1 = require("./ModelResponseContext");
const VmsStopHistory_1 = require("./VmsStopHistory");
function ReadVmsStopHistoryResponseFromJSON(json) {
    return ReadVmsStopHistoryResponseFromJSONTyped(json, false);
}
function ReadVmsStopHistoryResponseFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'vmsStopHistory': !(0, runtime_1.exists)(json, 'VmsStopHistory') ? undefined : (json['VmsStopHistory'].map(VmsStopHistory_1.VmsStopHistoryFromJSON)),
    };
}
function ReadVmsStopHistoryResponseToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'VmsStopHistory': value.vmsStopHistory === undefined ? undefined : (value.vmsStopHistory.map(VmsStopHistory_1.VmsStopHistoryToJSON)),
    };
}
