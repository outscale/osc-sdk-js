...
function ReadUsersRequestFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'filters': !(0, runtime_1.exists)(json, 'Filters') ? undefined : (0, FiltersUsers_1.FiltersUsersFromJSON)(json['Filters']),
...
function ReadUsersRequestToJSON(value) {
    ...
    return {
        'DryRun': value.dryRun,
        'Filters': (0, FiltersUsers_1.FiltersUsersToJSON)(value.filters),
