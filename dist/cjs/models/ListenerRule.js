...
function ListenerRuleFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'listenerId': !(0, runtime_1.exists)(json, 'ListenerId') ? undefined : json['ListenerId'],
        'listenerRuleId': !(0, runtime_1.exists)(json, 'ListenerRuleId') ? undefined : json['ListenerRuleId'],
        'listenerRuleName': !(0, runtime_1.exists)(json, 'ListenerRuleName') ? undefined : json['ListenerRuleName'],
