...
function CreateDhcpOptionsResponseFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        'dhcpOptionsSet': !(0, runtime_1.exists)(json, 'DhcpOptionsSet') ? undefined : (0, DhcpOptionsSet_1.DhcpOptionsSetFromJSON)(json['DhcpOptionsSet']),
...
function CreateDhcpOptionsResponseToJSON(value) {
    ...
    return {
        'DhcpOptionsSet': (0, DhcpOptionsSet_1.DhcpOptionsSetToJSON)(value.dhcpOptionsSet),
