...
function ReadSubregionsRequestFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'filters': !(0, runtime_1.exists)(json, 'Filters') ? undefined : (0, FiltersSubregion_1.FiltersSubregionFromJSON)(json['Filters']),
    };
}
...
function ReadSubregionsRequestToJSON(value) {
    ...
    return {
        'DryRun': value.dryRun,
        'Filters': (0, FiltersSubregion_1.FiltersSubregionToJSON)(value.filters),
    };
}
