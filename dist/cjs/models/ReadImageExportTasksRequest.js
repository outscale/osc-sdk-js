...
const FiltersReadImageExportTask_1 = require("./FiltersReadImageExportTask");
...
function ReadImageExportTasksRequestFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'filters': !(0, runtime_1.exists)(json, 'Filters') ? undefined : (0, FiltersReadImageExportTask_1.FiltersReadImageExportTaskFromJSON)(json['Filters']),
...
function ReadImageExportTasksRequestToJSON(value) {
    ...
    return {
        'DryRun': value.dryRun,
        'Filters': (0, FiltersReadImageExportTask_1.FiltersReadImageExportTaskToJSON)(value.filters),
