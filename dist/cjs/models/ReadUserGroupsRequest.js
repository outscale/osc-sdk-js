...
function ReadUserGroupsRequestFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'filters': !(0, runtime_1.exists)(json, 'Filters') ? undefined : (0, FiltersUserGroup_1.FiltersUserGroupFromJSON)(json['Filters']),
...
function ReadUserGroupsRequestToJSON(value) {
    ...
    return {
        'DryRun': value.dryRun,
        'Filters': (0, FiltersUserGroup_1.FiltersUserGroupToJSON)(value.filters),
