...
exports.ReadVmsStopHistoryRequestFromJSON = ReadVmsStopHistoryRequestFromJSON;
exports.ReadVmsStopHistoryRequestFromJSONTyped = ReadVmsStopHistoryRequestFromJSONTyped;
exports.ReadVmsStopHistoryRequestToJSON = ReadVmsStopHistoryRequestToJSON;
const runtime_1 = require("../runtime");
const FiltersVmsStopHistory_1 = require("./FiltersVmsStopHistory");
function ReadVmsStopHistoryRequestFromJSON(json) {
    return ReadVmsStopHistoryRequestFromJSONTyped(json, false);
}
function ReadVmsStopHistoryRequestFromJSONTyped(json, ignoreDiscriminator) {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        'filters': !(0, runtime_1.exists)(json, 'Filters') ? undefined : (0, FiltersVmsStopHistory_1.FiltersVmsStopHistoryFromJSON)(json['Filters']),
...
function ReadVmsStopHistoryRequestToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        'Filters': (0, FiltersVmsStopHistory_1.FiltersVmsStopHistoryToJSON)(value.filters),
