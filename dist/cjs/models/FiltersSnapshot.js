...
function FiltersSnapshotFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'fromCreationDate': !(0, runtime_1.exists)(json, 'FromCreationDate') ? undefined : (new Date(json['FromCreationDate'])),
        ...
        'toCreationDate': !(0, runtime_1.exists)(json, 'ToCreationDate') ? undefined : (new Date(json['ToCreationDate'])),
