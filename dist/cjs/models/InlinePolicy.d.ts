...
export declare function InlinePolicyFromJSON(json: any): InlinePolicy;
export declare function InlinePolicyFromJSONTyped(json: any, ignoreDiscriminator: boolean): InlinePolicy;
export declare function InlinePolicyToJSON(value?: InlinePolicy | null): any;
