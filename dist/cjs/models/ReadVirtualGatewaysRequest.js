...
function ReadVirtualGatewaysRequestFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'filters': !(0, runtime_1.exists)(json, 'Filters') ? undefined : (0, FiltersVirtualGateway_1.FiltersVirtualGatewayFromJSON)(json['Filters']),
...
function ReadVirtualGatewaysRequestToJSON(value) {
    ...
    return {
        'DryRun': value.dryRun,
        'Filters': (0, FiltersVirtualGateway_1.FiltersVirtualGatewayToJSON)(value.filters),
