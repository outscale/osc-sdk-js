...
export interface FiltersUsers {
     ...
     * @type {Array<string>}
     * @memberof FiltersUsers
     */
    userIds?: Array<string>;
}
export declare function FiltersUsersFromJSON(json: any): FiltersUsers;
export declare function FiltersUsersFromJSONTyped(json: any, ignoreDiscriminator: boolean): FiltersUsers;
export declare function FiltersUsersToJSON(value?: FiltersUsers | null): any;
