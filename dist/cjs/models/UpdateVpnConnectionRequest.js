...
const VpnOptionsToUpdate_1 = require("./VpnOptionsToUpdate");
...
function UpdateVpnConnectionRequestFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'vpnOptions': !(0, runtime_1.exists)(json, 'VpnOptions') ? undefined : (0, VpnOptionsToUpdate_1.VpnOptionsToUpdateFromJSON)(json['VpnOptions']),
    };
}
...
function UpdateVpnConnectionRequestToJSON(value) {
    ...
    return {
        ...
        'VpnOptions': (0, VpnOptionsToUpdate_1.VpnOptionsToUpdateToJSON)(value.vpnOptions),
    };
}
