...
exports.ShutdownBehaviorConfigurationHostActionEnum = exports.ShutdownBehaviorConfigurationGuestActionEnum = void 0;
exports.ShutdownBehaviorConfigurationFromJSON = ShutdownBehaviorConfigurationFromJSON;
exports.ShutdownBehaviorConfigurationFromJSONTyped = ShutdownBehaviorConfigurationFromJSONTyped;
exports.ShutdownBehaviorConfigurationToJSON = ShutdownBehaviorConfigurationToJSON;
const runtime_1 = require("../runtime");
/**
 * @export
 */
exports.ShutdownBehaviorConfigurationGuestActionEnum = {
    Stop: 'stop',
    Terminate: 'terminate'
};
/**
 * @export
 */
exports.ShutdownBehaviorConfigurationHostActionEnum = {
    Restart: 'restart',
    Stop: 'stop'
};
function ShutdownBehaviorConfigurationFromJSON(json) {
    return ShutdownBehaviorConfigurationFromJSONTyped(json, false);
}
function ShutdownBehaviorConfigurationFromJSONTyped(json, ignoreDiscriminator) {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        'guestAction': !(0, runtime_1.exists)(json, 'GuestAction') ? undefined : json['GuestAction'],
        'hostAction': !(0, runtime_1.exists)(json, 'HostAction') ? undefined : json['HostAction'],
    };
}
function ShutdownBehaviorConfigurationToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
