...
function LinkVirtualGatewayResponseFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        'netToVirtualGatewayLink': !(0, runtime_1.exists)(json, 'NetToVirtualGatewayLink') ? undefined : (0, NetToVirtualGatewayLink_1.NetToVirtualGatewayLinkFromJSON)(json['NetToVirtualGatewayLink']),
...
function LinkVirtualGatewayResponseToJSON(value) {
    ...
    return {
        'NetToVirtualGatewayLink': (0, NetToVirtualGatewayLink_1.NetToVirtualGatewayLinkToJSON)(value.netToVirtualGatewayLink),
