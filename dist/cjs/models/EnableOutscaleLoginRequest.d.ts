 ...
 *
 * @export
 * @interface EnableOutscaleLoginRequest
 */
export interface EnableOutscaleLoginRequest {
    /**
     * If true, checks whether you have the required permissions to perform the action.
     * @type {boolean}
     * @memberof EnableOutscaleLoginRequest
     */
    dryRun?: boolean;
}
export declare function EnableOutscaleLoginRequestFromJSON(json: any): EnableOutscaleLoginRequest;
export declare function EnableOutscaleLoginRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): EnableOutscaleLoginRequest;
export declare function EnableOutscaleLoginRequestToJSON(value?: EnableOutscaleLoginRequest | null): any;
