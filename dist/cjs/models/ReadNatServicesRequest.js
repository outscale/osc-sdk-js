...
function ReadNatServicesRequestFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'filters': !(0, runtime_1.exists)(json, 'Filters') ? undefined : (0, FiltersNatService_1.FiltersNatServiceFromJSON)(json['Filters']),
...
function ReadNatServicesRequestToJSON(value) {
    ...
    return {
        'DryRun': value.dryRun,
        'Filters': (0, FiltersNatService_1.FiltersNatServiceToJSON)(value.filters),
