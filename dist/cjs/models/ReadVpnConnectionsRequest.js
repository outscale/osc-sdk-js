...
function ReadVpnConnectionsRequestFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'filters': !(0, runtime_1.exists)(json, 'Filters') ? undefined : (0, FiltersVpnConnection_1.FiltersVpnConnectionFromJSON)(json['Filters']),
...
function ReadVpnConnectionsRequestToJSON(value) {
    ...
    return {
        'DryRun': value.dryRun,
        'Filters': (0, FiltersVpnConnection_1.FiltersVpnConnectionToJSON)(value.filters),
