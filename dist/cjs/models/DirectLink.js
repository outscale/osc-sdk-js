...
function DirectLinkFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'bandwidth': !(0, runtime_1.exists)(json, 'Bandwidth') ? undefined : json['Bandwidth'],
        'directLinkId': !(0, runtime_1.exists)(json, 'DirectLinkId') ? undefined : json['DirectLinkId'],
        'directLinkName': !(0, runtime_1.exists)(json, 'DirectLinkName') ? undefined : json['DirectLinkName'],
