...
function UpdateNetAccessPointRequestFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        'addRouteTableIds': !(0, runtime_1.exists)(json, 'AddRouteTableIds') ? undefined : json['AddRouteTableIds'],
        'dryRun': !(0, runtime_1.exists)(json, 'DryRun') ? undefined : json['DryRun'],
        'netAccessPointId': json['NetAccessPointId'],
        'removeRouteTableIds': !(0, runtime_1.exists)(json, 'RemoveRouteTableIds') ? undefined : json['RemoveRouteTableIds'],
    };
}
