...
function CreateClientGatewayResponseFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        'clientGateway': !(0, runtime_1.exists)(json, 'ClientGateway') ? undefined : (0, ClientGateway_1.ClientGatewayFromJSON)(json['ClientGateway']),
...
function CreateClientGatewayResponseToJSON(value) {
    ...
    return {
        'ClientGateway': (0, ClientGateway_1.ClientGatewayToJSON)(value.clientGateway),
