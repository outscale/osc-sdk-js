...
exports.ReadVolumeUpdateTasksRequestFromJSON = ReadVolumeUpdateTasksRequestFromJSON;
exports.ReadVolumeUpdateTasksRequestFromJSONTyped = ReadVolumeUpdateTasksRequestFromJSONTyped;
exports.ReadVolumeUpdateTasksRequestToJSON = ReadVolumeUpdateTasksRequestToJSON;
const runtime_1 = require("../runtime");
const FiltersReadVolumeUpdateTask_1 = require("./FiltersReadVolumeUpdateTask");
function ReadVolumeUpdateTasksRequestFromJSON(json) {
    return ReadVolumeUpdateTasksRequestFromJSONTyped(json, false);
}
function ReadVolumeUpdateTasksRequestFromJSONTyped(json, ignoreDiscriminator) {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        'dryRun': !(0, runtime_1.exists)(json, 'DryRun') ? undefined : json['DryRun'],
        'filters': !(0, runtime_1.exists)(json, 'Filters') ? undefined : (0, FiltersReadVolumeUpdateTask_1.FiltersReadVolumeUpdateTaskFromJSON)(json['Filters']),
...
function ReadVolumeUpdateTasksRequestToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        'DryRun': value.dryRun,
        'Filters': (0, FiltersReadVolumeUpdateTask_1.FiltersReadVolumeUpdateTaskToJSON)(value.filters),
