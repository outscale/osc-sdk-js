...
const FiltersUpdateVolumeTask_1 = require("./FiltersUpdateVolumeTask");
...
function ReadVolumeUpdateTasksRequestFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'filters': !(0, runtime_1.exists)(json, 'Filters') ? undefined : (0, FiltersUpdateVolumeTask_1.FiltersUpdateVolumeTaskFromJSON)(json['Filters']),
...
function ReadVolumeUpdateTasksRequestToJSON(value) {
    ...
    return {
        'DryRun': value.dryRun,
        'Filters': (0, FiltersUpdateVolumeTask_1.FiltersUpdateVolumeTaskToJSON)(value.filters),
