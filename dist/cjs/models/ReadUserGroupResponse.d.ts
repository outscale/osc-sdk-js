...
export declare function ReadUserGroupResponseFromJSON(json: any): ReadUserGroupResponse;
export declare function ReadUserGroupResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ReadUserGroupResponse;
export declare function ReadUserGroupResponseToJSON(value?: ReadUserGroupResponse | null): any;
