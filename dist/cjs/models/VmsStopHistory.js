...
exports.VmsStopHistoryFromJSON = VmsStopHistoryFromJSON;
exports.VmsStopHistoryFromJSONTyped = VmsStopHistoryFromJSONTyped;
exports.VmsStopHistoryToJSON = VmsStopHistoryToJSON;
const runtime_1 = require("../runtime");
function VmsStopHistoryFromJSON(json) {
    return VmsStopHistoryFromJSONTyped(json, false);
}
function VmsStopHistoryFromJSONTyped(json, ignoreDiscriminator) {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        'stateReason': !(0, runtime_1.exists)(json, 'StateReason') ? undefined : json['StateReason'],
        'stopDate': !(0, runtime_1.exists)(json, 'StopDate') ? undefined : (new Date(json['StopDate'])),
        'vmId': !(0, runtime_1.exists)(json, 'VmId') ? undefined : json['VmId'],
    };
}
function VmsStopHistoryToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'StopDate': value.stopDate === undefined ? undefined : (value.stopDate.toISOString()),
        'VmId': value.vmId,
    };
}
