...
function ReadEntitiesLinkedToPolicyResponseFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        'policyEntities': !(0, runtime_1.exists)(json, 'PolicyEntities') ? undefined : (0, PolicyEntities_1.PolicyEntitiesFromJSON)(json['PolicyEntities']),
...
function ReadEntitiesLinkedToPolicyResponseToJSON(value) {
    ...
    return {
        'PolicyEntities': (0, PolicyEntities_1.PolicyEntitiesToJSON)(value.policyEntities),
