...
function ReadNetAccessPointsRequestFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'filters': !(0, runtime_1.exists)(json, 'Filters') ? undefined : (0, FiltersNetAccessPoint_1.FiltersNetAccessPointFromJSON)(json['Filters']),
...
function ReadNetAccessPointsRequestToJSON(value) {
    ...
    return {
        'DryRun': value.dryRun,
        'Filters': (0, FiltersNetAccessPoint_1.FiltersNetAccessPointToJSON)(value.filters),
