 ...
 *
 * @export
 * @interface ReadPolicyVersionRequest
 */
export interface ReadPolicyVersionRequest {
    /**
     ...
     * @type {string}
     * @memberof ReadPolicyVersionRequest
     */
    policyOrn: string;
    /**
...
export declare function ReadPolicyVersionRequestFromJSON(json: any): ReadPolicyVersionRequest;
export declare function ReadPolicyVersionRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): ReadPolicyVersionRequest;
export declare function ReadPolicyVersionRequestToJSON(value?: ReadPolicyVersionRequest | null): any;
