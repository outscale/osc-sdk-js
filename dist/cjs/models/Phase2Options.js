...
function Phase2OptionsFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        'phase2DhGroupNumbers': !(0, runtime_1.exists)(json, 'Phase2DhGroupNumbers') ? undefined : json['Phase2DhGroupNumbers'],
        'phase2EncryptionAlgorithms': !(0, runtime_1.exists)(json, 'Phase2EncryptionAlgorithms') ? undefined : json['Phase2EncryptionAlgorithms'],
        'phase2IntegrityAlgorithms': !(0, runtime_1.exists)(json, 'Phase2IntegrityAlgorithms') ? undefined : json['Phase2IntegrityAlgorithms'],
        'phase2LifetimeSeconds': !(0, runtime_1.exists)(json, 'Phase2LifetimeSeconds') ? undefined : json['Phase2LifetimeSeconds'],
