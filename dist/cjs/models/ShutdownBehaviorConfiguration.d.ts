 ...
 * @export
 */
export declare const ShutdownBehaviorConfigurationGuestActionEnum: {
    readonly Stop: "stop";
 ...
 * @export
 */
export declare const ShutdownBehaviorConfigurationHostActionEnum: {
...
export declare function ShutdownBehaviorConfigurationFromJSON(json: any): ShutdownBehaviorConfiguration;
export declare function ShutdownBehaviorConfigurationFromJSONTyped(json: any, ignoreDiscriminator: boolean): ShutdownBehaviorConfiguration;
export declare function ShutdownBehaviorConfigurationToJSON(value?: ShutdownBehaviorConfiguration | null): any;
