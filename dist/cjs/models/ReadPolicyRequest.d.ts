...
export declare function ReadPolicyRequestFromJSON(json: any): ReadPolicyRequest;
export declare function ReadPolicyRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): ReadPolicyRequest;
export declare function ReadPolicyRequestToJSON(value?: ReadPolicyRequest | null): any;
