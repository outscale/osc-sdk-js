...
exports.FiltersReadVolumeUpdateTaskFromJSON = FiltersReadVolumeUpdateTaskFromJSON;
exports.FiltersReadVolumeUpdateTaskFromJSONTyped = FiltersReadVolumeUpdateTaskFromJSONTyped;
exports.FiltersReadVolumeUpdateTaskToJSON = FiltersReadVolumeUpdateTaskToJSON;
const runtime_1 = require("../runtime");
function FiltersReadVolumeUpdateTaskFromJSON(json) {
    return FiltersReadVolumeUpdateTaskFromJSONTyped(json, false);
}
function FiltersReadVolumeUpdateTaskFromJSONTyped(json, ignoreDiscriminator) {
...
function FiltersReadVolumeUpdateTaskToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
