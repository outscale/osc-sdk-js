...
function ReadUserGroupPoliciesResponseFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'policies': !(0, runtime_1.exists)(json, 'Policies') ? undefined : (json['Policies'].map(InlinePolicy_1.InlinePolicyFromJSON)),
...
function ReadUserGroupPoliciesResponseToJSON(value) {
    ...
    return {
        ...
        'Policies': value.policies === undefined ? undefined : (value.policies.map(InlinePolicy_1.InlinePolicyToJSON)),
