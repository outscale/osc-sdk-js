...
exports.FiltersUpdateVolumeTaskFromJSON = FiltersUpdateVolumeTaskFromJSON;
exports.FiltersUpdateVolumeTaskFromJSONTyped = FiltersUpdateVolumeTaskFromJSONTyped;
exports.FiltersUpdateVolumeTaskToJSON = FiltersUpdateVolumeTaskToJSON;
const runtime_1 = require("../runtime");
function FiltersUpdateVolumeTaskFromJSON(json) {
    return FiltersUpdateVolumeTaskFromJSONTyped(json, false);
}
function FiltersUpdateVolumeTaskFromJSONTyped(json, ignoreDiscriminator) {
...
function FiltersUpdateVolumeTaskToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
