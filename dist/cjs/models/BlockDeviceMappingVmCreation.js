...
function BlockDeviceMappingVmCreationFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        'bsu': !(0, runtime_1.exists)(json, 'Bsu') ? undefined : (0, BsuToCreate_1.BsuToCreateFromJSON)(json['Bsu']),
        'deviceName': !(0, runtime_1.exists)(json, 'DeviceName') ? undefined : json['DeviceName'],
        'noDevice': !(0, runtime_1.exists)(json, 'NoDevice') ? undefined : json['NoDevice'],
...
function BlockDeviceMappingVmCreationToJSON(value) {
    ...
    return {
        'Bsu': (0, BsuToCreate_1.BsuToCreateToJSON)(value.bsu),
