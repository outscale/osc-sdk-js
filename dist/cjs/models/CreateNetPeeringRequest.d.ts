...
export declare function CreateNetPeeringRequestFromJSON(json: any): CreateNetPeeringRequest;
export declare function CreateNetPeeringRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): CreateNetPeeringRequest;
export declare function CreateNetPeeringRequestToJSON(value?: CreateNetPeeringRequest | null): any;
