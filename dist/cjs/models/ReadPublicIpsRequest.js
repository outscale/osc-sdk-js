...
function ReadPublicIpsRequestFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'filters': !(0, runtime_1.exists)(json, 'Filters') ? undefined : (0, FiltersPublicIp_1.FiltersPublicIpFromJSON)(json['Filters']),
    };
}
...
function ReadPublicIpsRequestToJSON(value) {
    ...
    return {
        'DryRun': value.dryRun,
        'Filters': (0, FiltersPublicIp_1.FiltersPublicIpToJSON)(value.filters),
    };
}
