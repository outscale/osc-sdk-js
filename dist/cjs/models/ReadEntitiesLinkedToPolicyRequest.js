 ...
 * @export
 */
exports.ReadEntitiesLinkedToPolicyRequestEntitiesTypeEnum = {
    Account: 'ACCOUNT',
    User: 'USER',
    Group: 'GROUP'
};
...
function ReadEntitiesLinkedToPolicyRequestFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        'entitiesType': !(0, runtime_1.exists)(json, 'EntitiesType') ? undefined : json['EntitiesType'],
        'firstItem': !(0, runtime_1.exists)(json, 'FirstItem') ? undefined : json['FirstItem'],
        'policyOrn': !(0, runtime_1.exists)(json, 'PolicyOrn') ? undefined : json['PolicyOrn'],
