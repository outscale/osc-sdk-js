...
exports.CO2FactorDistributionFromJSON = CO2FactorDistributionFromJSON;
exports.CO2FactorDistributionFromJSONTyped = CO2FactorDistributionFromJSONTyped;
exports.CO2FactorDistributionToJSON = CO2FactorDistributionToJSON;
const runtime_1 = require("../runtime");
function CO2FactorDistributionFromJSON(json) {
    return CO2FactorDistributionFromJSONTyped(json, false);
}
function CO2FactorDistributionFromJSONTyped(json, ignoreDiscriminator) {
...
function CO2FactorDistributionToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
