...
export declare function CO2CategoryDistributionFromJSON(json: any): CO2CategoryDistribution;
export declare function CO2CategoryDistributionFromJSONTyped(json: any, ignoreDiscriminator: boolean): CO2CategoryDistribution;
export declare function CO2CategoryDistributionToJSON(value?: CO2CategoryDistribution | null): any;
