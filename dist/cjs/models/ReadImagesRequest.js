...
function ReadImagesRequestFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'filters': !(0, runtime_1.exists)(json, 'Filters') ? undefined : (0, FiltersImage_1.FiltersImageFromJSON)(json['Filters']),
...
function ReadImagesRequestToJSON(value) {
    ...
    return {
        'DryRun': value.dryRun,
        'Filters': (0, FiltersImage_1.FiltersImageToJSON)(value.filters),
