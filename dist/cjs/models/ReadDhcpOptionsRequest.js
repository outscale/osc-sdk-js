...
function ReadDhcpOptionsRequestFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'filters': !(0, runtime_1.exists)(json, 'Filters') ? undefined : (0, FiltersDhcpOptions_1.FiltersDhcpOptionsFromJSON)(json['Filters']),
...
function ReadDhcpOptionsRequestToJSON(value) {
    ...
    return {
        'DryRun': value.dryRun,
        'Filters': (0, FiltersDhcpOptions_1.FiltersDhcpOptionsToJSON)(value.filters),
