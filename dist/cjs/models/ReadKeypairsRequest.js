...
function ReadKeypairsRequestFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'filters': !(0, runtime_1.exists)(json, 'Filters') ? undefined : (0, FiltersKeypair_1.FiltersKeypairFromJSON)(json['Filters']),
...
function ReadKeypairsRequestToJSON(value) {
    ...
    return {
        'DryRun': value.dryRun,
        'Filters': (0, FiltersKeypair_1.FiltersKeypairToJSON)(value.filters),
