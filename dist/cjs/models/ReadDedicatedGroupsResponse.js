...
function ReadDedicatedGroupsResponseFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        'dedicatedGroups': !(0, runtime_1.exists)(json, 'DedicatedGroups') ? undefined : (json['DedicatedGroups'].map(DedicatedGroup_1.DedicatedGroupFromJSON)),
...
function ReadDedicatedGroupsResponseToJSON(value) {
    ...
    return {
        'DedicatedGroups': value.dedicatedGroups === undefined ? undefined : (value.dedicatedGroups.map(DedicatedGroup_1.DedicatedGroupToJSON)),
