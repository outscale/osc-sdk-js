...
function UpdateNetAccessPointResponseFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        'netAccessPoint': !(0, runtime_1.exists)(json, 'NetAccessPoint') ? undefined : (0, NetAccessPoint_1.NetAccessPointFromJSON)(json['NetAccessPoint']),
...
function UpdateNetAccessPointResponseToJSON(value) {
    ...
    return {
        'NetAccessPoint': (0, NetAccessPoint_1.NetAccessPointToJSON)(value.netAccessPoint),
