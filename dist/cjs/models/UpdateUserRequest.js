...
function UpdateUserRequestFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'newUserEmail': !(0, runtime_1.exists)(json, 'NewUserEmail') ? undefined : json['NewUserEmail'],
        'newUserName': !(0, runtime_1.exists)(json, 'NewUserName') ? undefined : json['NewUserName'],
