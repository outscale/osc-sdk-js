...
function ReadSubnetsRequestFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'filters': !(0, runtime_1.exists)(json, 'Filters') ? undefined : (0, FiltersSubnet_1.FiltersSubnetFromJSON)(json['Filters']),
...
function ReadSubnetsRequestToJSON(value) {
    ...
    return {
        'DryRun': value.dryRun,
        'Filters': (0, FiltersSubnet_1.FiltersSubnetToJSON)(value.filters),
