...
function ReadVmsStateRequestFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        'allVms': !(0, runtime_1.exists)(json, 'AllVms') ? undefined : json['AllVms'],
        'dryRun': !(0, runtime_1.exists)(json, 'DryRun') ? undefined : json['DryRun'],
        'filters': !(0, runtime_1.exists)(json, 'Filters') ? undefined : (0, FiltersVmsState_1.FiltersVmsStateFromJSON)(json['Filters']),
    };
}
...
function ReadVmsStateRequestToJSON(value) {
    ...
    return {
        'AllVms': value.allVms,
        'DryRun': value.dryRun,
        'Filters': (0, FiltersVmsState_1.FiltersVmsStateToJSON)(value.filters),
    };
}
