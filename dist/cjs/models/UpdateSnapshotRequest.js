...
function UpdateSnapshotRequestFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'permissionsToCreateVolume': (0, PermissionsOnResourceCreation_1.PermissionsOnResourceCreationFromJSON)(json['PermissionsToCreateVolume']),
...
function UpdateSnapshotRequestToJSON(value) {
    ...
    return {
        'DryRun': value.dryRun,
        'PermissionsToCreateVolume': (0, PermissionsOnResourceCreation_1.PermissionsOnResourceCreationToJSON)(value.permissionsToCreateVolume),
