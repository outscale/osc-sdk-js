...
function UpdateAccessKeyRequestFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'clearExpirationDate': !(0, runtime_1.exists)(json, 'ClearExpirationDate') ? undefined : json['ClearExpirationDate'],
        'clearTag': !(0, runtime_1.exists)(json, 'ClearTag') ? undefined : json['ClearTag'],
...
function UpdateAccessKeyRequestToJSON(value) {
    ...
    return {
        ...
        'ClearExpirationDate': value.clearExpirationDate,
        'ClearTag': value.clearTag,
        'DryRun': value.dryRun,
