...
exports.VolumeUpdateTaskFromJSON = VolumeUpdateTaskFromJSON;
exports.VolumeUpdateTaskFromJSONTyped = VolumeUpdateTaskFromJSONTyped;
exports.VolumeUpdateTaskToJSON = VolumeUpdateTaskToJSON;
const runtime_1 = require("../runtime");
const ResourceTag_1 = require("./ResourceTag");
const VolumeUpdate_1 = require("./VolumeUpdate");
function VolumeUpdateTaskFromJSON(json) {
    return VolumeUpdateTaskFromJSONTyped(json, false);
}
function VolumeUpdateTaskFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'volumeUpdate': !(0, runtime_1.exists)(json, 'VolumeUpdate') ? undefined : (0, VolumeUpdate_1.VolumeUpdateFromJSON)(json['VolumeUpdate']),
    };
}
function VolumeUpdateTaskToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'VolumeUpdate': (0, VolumeUpdate_1.VolumeUpdateToJSON)(value.volumeUpdate),
    };
}
