...
function RouteTableFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        'linkRouteTables': !(0, runtime_1.exists)(json, 'LinkRouteTables') ? undefined : (json['LinkRouteTables'].map(LinkRouteTable_1.LinkRouteTableFromJSON)),
        'netId': !(0, runtime_1.exists)(json, 'NetId') ? undefined : json['NetId'],
        'routePropagatingVirtualGateways': !(0, runtime_1.exists)(json, 'RoutePropagatingVirtualGateways') ? undefined : (json['RoutePropagatingVirtualGateways'].map(RoutePropagatingVirtualGateway_1.RoutePropagatingVirtualGatewayFromJSON)),
        'routeTableId': !(0, runtime_1.exists)(json, 'RouteTableId') ? undefined : json['RouteTableId'],
        'routes': !(0, runtime_1.exists)(json, 'Routes') ? undefined : (json['Routes'].map(Route_1.RouteFromJSON)),
