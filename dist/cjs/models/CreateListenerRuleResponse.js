...
function CreateListenerRuleResponseFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        'listenerRule': !(0, runtime_1.exists)(json, 'ListenerRule') ? undefined : (0, ListenerRule_1.ListenerRuleFromJSON)(json['ListenerRule']),
...
function CreateListenerRuleResponseToJSON(value) {
    ...
    return {
        'ListenerRule': (0, ListenerRule_1.ListenerRuleToJSON)(value.listenerRule),
