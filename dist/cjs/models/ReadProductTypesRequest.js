...
function ReadProductTypesRequestFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'filters': !(0, runtime_1.exists)(json, 'Filters') ? undefined : (0, FiltersProductType_1.FiltersProductTypeFromJSON)(json['Filters']),
...
function ReadProductTypesRequestToJSON(value) {
    ...
    return {
        'DryRun': value.dryRun,
        'Filters': (0, FiltersProductType_1.FiltersProductTypeToJSON)(value.filters),
