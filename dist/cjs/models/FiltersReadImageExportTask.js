...
exports.FiltersReadImageExportTaskFromJSON = FiltersReadImageExportTaskFromJSON;
exports.FiltersReadImageExportTaskFromJSONTyped = FiltersReadImageExportTaskFromJSONTyped;
exports.FiltersReadImageExportTaskToJSON = FiltersReadImageExportTaskToJSON;
const runtime_1 = require("../runtime");
function FiltersReadImageExportTaskFromJSON(json) {
    return FiltersReadImageExportTaskFromJSONTyped(json, false);
}
function FiltersReadImageExportTaskFromJSONTyped(json, ignoreDiscriminator) {
...
function FiltersReadImageExportTaskToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
