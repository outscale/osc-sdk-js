...
function ReadVolumesRequestFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'filters': !(0, runtime_1.exists)(json, 'Filters') ? undefined : (0, FiltersVolume_1.FiltersVolumeFromJSON)(json['Filters']),
    };
}
...
function ReadVolumesRequestToJSON(value) {
    ...
    return {
        'DryRun': value.dryRun,
        'Filters': (0, FiltersVolume_1.FiltersVolumeToJSON)(value.filters),
    };
}
