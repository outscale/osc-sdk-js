 ...
 *
 */
class LocationApi extends runtime.BaseAPI {
    /**
     */
    readLocationsRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const body = (0, models_1.ReadLocationsRequestToJSON)(requestParameters.readLocationsRequest);
            const request = {
                path: `/ReadLocations`,
                method: 'POST',
            ...
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.ReadLocationsResponseFromJSON)(jsonValue));
        });
    }
    /**
     */
