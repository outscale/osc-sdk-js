...
class ProductTypeApi extends runtime.BaseAPI {
    ...
    deleteProductTypeRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const body = (0, models_1.DeleteProductTypeRequestToJSON)(requestParameters.deleteProductTypeRequest);
            const request = {
            ...
            const response = yield this.request(request, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.DeleteProductTypeResponseFromJSON)(jsonValue));
        });
    }
    /**
     * Deletes a specified product type that belongs to you.<br />  **[WARNING]**<br /> The product type must not be associated with one or more OMIs to be deleted. Otherwise, you need to force the deletion.<br /> If you force the deletion, the product type is deleted and remains associated with the OMIs.<br />
    ...
    readProductTypesRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const headerParameters = {};
            headerParameters['Content-Type'] = 'application/json';
            const body = (0, models_1.ReadProductTypesRequestToJSON)(requestParameters.readProductTypesRequest);
            const request = {
            ...
            const response = yield this.request(request, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.ReadProductTypesResponseFromJSON)(jsonValue));
        });
    }
    /**
     * Lists one or more product types.
...
exports.ProductTypeApi = ProductTypeApi;
