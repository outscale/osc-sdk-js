...
class ProductTypeApi extends runtime.BaseAPI {
    ...
    readProductTypesRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const body = models_1.ReadProductTypesRequestToJSON(requestParameters.readProductTypesRequest);
            const request = {
            ...
            return new runtime.JSONApiResponse(response, (jsonValue) => models_1.ReadProductTypesResponseFromJSON(jsonValue));
        });
    }
    /**
     */
