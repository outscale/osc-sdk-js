...
class RegionApi extends runtime.BaseAPI {
    ...
    readRegionsRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const body = (0, models_1.ReadRegionsRequestToJSON)(requestParameters.readRegionsRequest);
            const request = {
                path: `/ReadRegions`,
                method: 'POST',
            ...
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.ReadRegionsResponseFromJSON)(jsonValue));
        });
    }
    /**
     * Lists one or more Regions of the OUTSCALE Cloud.<br /><br /> For more information, see [About Regions and Subregions](https://docs.outscale.com/en/userguide/About-Regions-and-Subregions.html).
