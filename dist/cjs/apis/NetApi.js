...
exports.NetApi = void 0;
const runtime = __importStar(require("../runtime"));
const models_1 = require("../models");
/**
 *
 */
class NetApi extends runtime.BaseAPI {
    /**
    ...
    createNetRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const body = (0, models_1.CreateNetRequestToJSON)(requestParameters.createNetRequest);
            const request = {
                path: `/CreateNet`,
                method: 'POST',
            ...
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.CreateNetResponseFromJSON)(jsonValue));
        });
    }
    /**
     * Creates a Net with a specified IP range.<br /> The IP range (network range) of your Net must be between a /28 netmask (16 IPs) and a /16 netmask (65536 IPs).<br /><br /> For more information, see [About Nets](https://docs.outscale.com/en/userguide/About-Nets.html).
    ...
    deleteNetRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const body = (0, models_1.DeleteNetRequestToJSON)(requestParameters.deleteNetRequest);
            const request = {
                path: `/DeleteNet`,
                method: 'POST',
                headers: headerParameters,
            ...
            const response = yield this.request(request, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.DeleteNetResponseFromJSON)(jsonValue));
        });
    }
    /**
     * Deletes a specified Net.<br /> Before deleting the Net, you need to delete or detach all the resources associated with the Net:<br /><br />  * Virtual machines (VMs)<br /> * Net peerings<br /> * Custom route tables<br /> * Public IPs allocated to resources in the Net<br /> * Network Interface Cards (NICs) created in the Subnets<br /> * Virtual gateways, internet services and NAT services<br /> * Load balancers<br /> * Security groups<br /> * Subnets
    ...
    readNetsRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const body = (0, models_1.ReadNetsRequestToJSON)(requestParameters.readNetsRequest);
            const request = {
                path: `/ReadNets`,
                method: 'POST',
                headers: headerParameters,
            ...
            const response = yield this.request(request, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.ReadNetsResponseFromJSON)(jsonValue));
        });
    }
    /**
     * Lists one or more Nets.
    ...
    updateNetRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const body = (0, models_1.UpdateNetRequestToJSON)(requestParameters.updateNetRequest);
            const request = {
                path: `/UpdateNet`,
                method: 'POST',
                headers: headerParameters,
            ...
            const response = yield this.request(request, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.UpdateNetResponseFromJSON)(jsonValue));
        });
    }
    /**
     * Associates a DHCP options set with a specified Net.
