...
class NetAccessPointApi extends runtime.BaseAPI {
    ...
    createNetAccessPointRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const body = (0, models_1.CreateNetAccessPointRequestToJSON)(requestParameters.createNetAccessPointRequest);
            const request = {
            ...
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.CreateNetAccessPointResponseFromJSON)(jsonValue));
        });
    }
    /**
     */
    ...
    deleteNetAccessPointRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const body = (0, models_1.DeleteNetAccessPointRequestToJSON)(requestParameters.deleteNetAccessPointRequest);
            const request = {
            ...
            const response = yield this.request(request, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.DeleteNetAccessPointResponseFromJSON)(jsonValue));
        });
    }
    /**
     */
    ...
    readNetAccessPointServicesRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const headerParameters = {};
            headerParameters['Content-Type'] = 'application/json';
            const body = (0, models_1.ReadNetAccessPointServicesRequestToJSON)(requestParameters.readNetAccessPointServicesRequest);
            const request = {
            ...
            const response = yield this.request(request, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.ReadNetAccessPointServicesResponseFromJSON)(jsonValue));
        });
    }
    /**
     */
    ...
    readNetAccessPointsRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const body = (0, models_1.ReadNetAccessPointsRequestToJSON)(requestParameters.readNetAccessPointsRequest);
            const request = {
            ...
            const response = yield this.request(request, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.ReadNetAccessPointsResponseFromJSON)(jsonValue));
        });
    }
    /**
     */
    ...
    updateNetAccessPointRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const body = (0, models_1.UpdateNetAccessPointRequestToJSON)(requestParameters.updateNetAccessPointRequest);
            const request = {
            ...
            const response = yield this.request(request, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.UpdateNetAccessPointResponseFromJSON)(jsonValue));
        });
    }
    /**
     */
