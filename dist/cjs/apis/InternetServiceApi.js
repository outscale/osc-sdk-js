...
class InternetServiceApi extends runtime.BaseAPI {
    ...
    createInternetServiceRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const body = (0, models_1.CreateInternetServiceRequestToJSON)(requestParameters.createInternetServiceRequest);
            const request = {
            ...
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.CreateInternetServiceResponseFromJSON)(jsonValue));
        });
    }
    /**
     */
    ...
    deleteInternetServiceRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const body = (0, models_1.DeleteInternetServiceRequestToJSON)(requestParameters.deleteInternetServiceRequest);
            const request = {
            ...
            const response = yield this.request(request, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.DeleteInternetServiceResponseFromJSON)(jsonValue));
        });
    }
    /**
     */
    ...
    linkInternetServiceRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const body = (0, models_1.LinkInternetServiceRequestToJSON)(requestParameters.linkInternetServiceRequest);
            const request = {
            ...
            const response = yield this.request(request, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.LinkInternetServiceResponseFromJSON)(jsonValue));
        });
    }
    /**
     */
    ...
    readInternetServicesRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const body = (0, models_1.ReadInternetServicesRequestToJSON)(requestParameters.readInternetServicesRequest);
            const request = {
            ...
            const response = yield this.request(request, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.ReadInternetServicesResponseFromJSON)(jsonValue));
        });
    }
    /**
     */
    ...
    unlinkInternetServiceRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const body = (0, models_1.UnlinkInternetServiceRequestToJSON)(requestParameters.unlinkInternetServiceRequest);
            const request = {
            ...
            const response = yield this.request(request, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.UnlinkInternetServiceResponseFromJSON)(jsonValue));
        });
    }
    /**
     */
