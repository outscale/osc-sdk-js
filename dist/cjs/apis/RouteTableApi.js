...
class RouteTableApi extends runtime.BaseAPI {
    ...
    createRouteTableRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const body = models_1.CreateRouteTableRequestToJSON(requestParameters.createRouteTableRequest);
            const request = {
            ...
            return new runtime.JSONApiResponse(response, (jsonValue) => models_1.CreateRouteTableResponseFromJSON(jsonValue));
        });
    }
    /**
     */
    ...
    deleteRouteTableRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const body = models_1.DeleteRouteTableRequestToJSON(requestParameters.deleteRouteTableRequest);
            const request = {
            ...
            const response = yield this.request(request, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => models_1.DeleteRouteTableResponseFromJSON(jsonValue));
        });
    }
    /**
     */
    ...
    linkRouteTableRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const body = models_1.LinkRouteTableRequestToJSON(requestParameters.linkRouteTableRequest);
            const request = {
                path: `/LinkRouteTable`,
                method: 'POST',
                headers: headerParameters,
            ...
            const response = yield this.request(request, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => models_1.LinkRouteTableResponseFromJSON(jsonValue));
        });
    }
    /**
     */
    ...
    readRouteTablesRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const body = models_1.ReadRouteTablesRequestToJSON(requestParameters.readRouteTablesRequest);
            const request = {
            ...
            const response = yield this.request(request, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => models_1.ReadRouteTablesResponseFromJSON(jsonValue));
        });
    }
    /**
     */
    ...
    unlinkRouteTableRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const body = models_1.UnlinkRouteTableRequestToJSON(requestParameters.unlinkRouteTableRequest);
            const request = {
            ...
            const response = yield this.request(request, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => models_1.UnlinkRouteTableResponseFromJSON(jsonValue));
        });
    }
    /**
     */
