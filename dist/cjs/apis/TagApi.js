...
class TagApi extends runtime.BaseAPI {
    ...
    createTagsRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const body = models_1.CreateTagsRequestToJSON(requestParameters.createTagsRequest);
            const request = {
                path: `/CreateTags`,
                method: 'POST',
            ...
            return new runtime.JSONApiResponse(response, (jsonValue) => models_1.CreateTagsResponseFromJSON(jsonValue));
        });
    }
    /**
     */
    ...
    deleteTagsRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const body = models_1.DeleteTagsRequestToJSON(requestParameters.deleteTagsRequest);
            const request = {
                path: `/DeleteTags`,
                method: 'POST',
                headers: headerParameters,
            ...
            const response = yield this.request(request, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => models_1.DeleteTagsResponseFromJSON(jsonValue));
        });
    }
    /**
     */
    ...
    readTagsRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const body = models_1.ReadTagsRequestToJSON(requestParameters.readTagsRequest);
            const request = {
                path: `/ReadTags`,
                method: 'POST',
                headers: headerParameters,
            ...
            const response = yield this.request(request, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => models_1.ReadTagsResponseFromJSON(jsonValue));
        });
    }
    /**
     */
