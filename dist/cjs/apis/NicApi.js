...
class NicApi extends runtime.BaseAPI {
    ...
    createNicRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const body = (0, models_1.CreateNicRequestToJSON)(requestParameters.createNicRequest);
            const request = {
                path: `/CreateNic`,
                method: 'POST',
            ...
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.CreateNicResponseFromJSON)(jsonValue));
        });
    }
    /**
     */
    ...
    deleteNicRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const body = (0, models_1.DeleteNicRequestToJSON)(requestParameters.deleteNicRequest);
            const request = {
                path: `/DeleteNic`,
                method: 'POST',
                headers: headerParameters,
            ...
            const response = yield this.request(request, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.DeleteNicResponseFromJSON)(jsonValue));
        });
    }
    /**
     */
    ...
    linkNicRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const body = (0, models_1.LinkNicRequestToJSON)(requestParameters.linkNicRequest);
            const request = {
                path: `/LinkNic`,
                method: 'POST',
                headers: headerParameters,
            ...
            const response = yield this.request(request, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.LinkNicResponseFromJSON)(jsonValue));
        });
    }
    /**
     */
    ...
    linkPrivateIpsRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const body = (0, models_1.LinkPrivateIpsRequestToJSON)(requestParameters.linkPrivateIpsRequest);
            const request = {
                path: `/LinkPrivateIps`,
                method: 'POST',
                headers: headerParameters,
            ...
            const response = yield this.request(request, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.LinkPrivateIpsResponseFromJSON)(jsonValue));
        });
    }
    /**
     */
    ...
    readNicsRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const body = (0, models_1.ReadNicsRequestToJSON)(requestParameters.readNicsRequest);
            const request = {
                path: `/ReadNics`,
                method: 'POST',
                headers: headerParameters,
            ...
            const response = yield this.request(request, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.ReadNicsResponseFromJSON)(jsonValue));
        });
    }
    /**
     */
    ...
    unlinkNicRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const body = (0, models_1.UnlinkNicRequestToJSON)(requestParameters.unlinkNicRequest);
            const request = {
                path: `/UnlinkNic`,
                method: 'POST',
                headers: headerParameters,
            ...
            const response = yield this.request(request, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.UnlinkNicResponseFromJSON)(jsonValue));
        });
    }
    /**
     */
    ...
    unlinkPrivateIpsRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const body = (0, models_1.UnlinkPrivateIpsRequestToJSON)(requestParameters.unlinkPrivateIpsRequest);
            const request = {
            ...
            const response = yield this.request(request, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.UnlinkPrivateIpsResponseFromJSON)(jsonValue));
        });
    }
    /**
     */
    ...
    updateNicRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const body = (0, models_1.UpdateNicRequestToJSON)(requestParameters.updateNicRequest);
            const request = {
                path: `/UpdateNic`,
                method: 'POST',
                headers: headerParameters,
            ...
            const response = yield this.request(request, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.UpdateNicResponseFromJSON)(jsonValue));
        });
    }
    /**
     */
