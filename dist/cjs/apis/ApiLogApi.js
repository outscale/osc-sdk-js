...
exports.ApiLogApi = void 0;
const runtime = __importStar(require("../runtime"));
const models_1 = require("../models");
/**
 *
 */
class ApiLogApi extends runtime.BaseAPI {
    /**
     */
    readApiLogsRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const body = (0, models_1.ReadApiLogsRequestToJSON)(requestParameters.readApiLogsRequest);
            const request = {
                path: `/ReadApiLogs`,
                method: 'POST',
            ...
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.ReadApiLogsResponseFromJSON)(jsonValue));
        });
    }
    /**
     */
