...
class ApiLogApi extends runtime.BaseAPI {
    ...
    readApiLogsRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const body = models_1.ReadApiLogsRequestToJSON(requestParameters.readApiLogsRequest);
            const request = {
                path: `/ReadApiLogs`,
                method: 'POST',
            ...
            return new runtime.JSONApiResponse(response, (jsonValue) => models_1.ReadApiLogsResponseFromJSON(jsonValue));
        });
    }
    /**
     */
