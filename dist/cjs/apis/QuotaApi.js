...
class QuotaApi extends runtime.BaseAPI {
    ...
    readQuotasRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const body = models_1.ReadQuotasRequestToJSON(requestParameters.readQuotasRequest);
            const request = {
                path: `/ReadQuotas`,
                method: 'POST',
            ...
            return new runtime.JSONApiResponse(response, (jsonValue) => models_1.ReadQuotasResponseFromJSON(jsonValue));
        });
    }
    /**
     */
