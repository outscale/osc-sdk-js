...
class DhcpOptionApi extends runtime.BaseAPI {
    ...
    createDhcpOptionsRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const body = (0, models_1.CreateDhcpOptionsRequestToJSON)(requestParameters.createDhcpOptionsRequest);
            const request = {
            ...
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.CreateDhcpOptionsResponseFromJSON)(jsonValue));
        });
    }
    /**
     */
    ...
    deleteDhcpOptionsRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const body = (0, models_1.DeleteDhcpOptionsRequestToJSON)(requestParameters.deleteDhcpOptionsRequest);
            const request = {
            ...
            const response = yield this.request(request, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.DeleteDhcpOptionsResponseFromJSON)(jsonValue));
        });
    }
    /**
     */
    ...
    readDhcpOptionsRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const body = (0, models_1.ReadDhcpOptionsRequestToJSON)(requestParameters.readDhcpOptionsRequest);
            const request = {
            ...
            const response = yield this.request(request, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.ReadDhcpOptionsResponseFromJSON)(jsonValue));
        });
    }
    /**
     */
