...
import { CreateVmsRequest, CreateVmsResponse, DeleteVmsRequest, DeleteVmsResponse, ReadAdminPasswordRequest, ReadAdminPasswordResponse, ReadConsoleOutputRequest, ReadConsoleOutputResponse, ReadVmTypesRequest, ReadVmTypesResponse, ReadVmsRequest, ReadVmsResponse, ReadVmsStateRequest, ReadVmsStateResponse, ReadVmsStopHistoryRequest, ReadVmsStopHistoryResponse, RebootVmsRequest, RebootVmsResponse, StartVmsRequest, StartVmsResponse, StopVmsRequest, StopVmsResponse, UpdateVmRequest, UpdateVmResponse } from '../models';
