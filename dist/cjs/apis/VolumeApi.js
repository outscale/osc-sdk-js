...
exports.VolumeApi = void 0;
const runtime = __importStar(require("../runtime"));
const models_1 = require("../models");
/**
 *
 */
class VolumeApi extends runtime.BaseAPI {
    /**
    ...
    createVolumeRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const body = (0, models_1.CreateVolumeRequestToJSON)(requestParameters.createVolumeRequest);
            const request = {
                path: `/CreateVolume`,
                method: 'POST',
            ...
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.CreateVolumeResponseFromJSON)(jsonValue));
        });
    }
    /**
     * Creates a Block Storage Unit (BSU) volume in a specified Region.<br /> BSU volumes can be attached to a virtual machine (VM) in the same Subregion. You can create an empty volume or restore a volume from an existing snapshot.<br /> You can create the following volume types: Enterprise (`io1`) for provisioned IOPS SSD volumes, Performance (`gp2`) for general purpose SSD volumes, or Magnetic (`standard`) volumes.<br /><br /> For more information, see [About Volumes](https://docs.outscale.com/en/userguide/About-Volumes.html).
    ...
    deleteVolumeRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const body = (0, models_1.DeleteVolumeRequestToJSON)(requestParameters.deleteVolumeRequest);
            const request = {
                path: `/DeleteVolume`,
                method: 'POST',
                headers: headerParameters,
            ...
            const response = yield this.request(request, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.DeleteVolumeResponseFromJSON)(jsonValue));
        });
    }
    /**
     * Deletes a specified Block Storage Unit (BSU) volume.<br /> You can delete available volumes only, that is, volumes that are not attached to a virtual machine (VM).
    ...
    linkVolumeRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const body = (0, models_1.LinkVolumeRequestToJSON)(requestParameters.linkVolumeRequest);
            const request = {
                path: `/LinkVolume`,
                method: 'POST',
                headers: headerParameters,
            ...
            const response = yield this.request(request, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.LinkVolumeResponseFromJSON)(jsonValue));
        });
    }
    /**
     * Attaches a Block Storage Unit (BSU) volume to a virtual machine (VM).<br /> The volume and the VM must be in the same Subregion. The VM can be running or stopped. The volume is attached to the specified VM device.
     ...
     */
    readVolumeUpdateTasksRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const queryParameters = {};
            const headerParameters = {};
            headerParameters['Content-Type'] = 'application/json';
            ...
            const body = (0, models_1.ReadVolumeUpdateTasksRequestToJSON)(requestParameters.readVolumeUpdateTasksRequest);
            const request = {
            ...
            const response = yield this.request(request, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.ReadVolumeUpdateTasksResponseFromJSON)(jsonValue));
        });
    }
    /**
     * Lists one or more specified tasks of volume update.
    ...
    readVolumeUpdateTasks() {
        return __awaiter(this, arguments, void 0, function* (requestParameters = {}, initOverrides) {
            const response = yield this.readVolumeUpdateTasksRaw(requestParameters, initOverrides);
            return yield response.value();
        });
    }
    /**
    ...
    readVolumesRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const body = (0, models_1.ReadVolumesRequestToJSON)(requestParameters.readVolumesRequest);
            const request = {
                path: `/ReadVolumes`,
                method: 'POST',
                headers: headerParameters,
            ...
            const response = yield this.request(request, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.ReadVolumesResponseFromJSON)(jsonValue));
        });
    }
    /**
     * Lists one or more specified Block Storage Unit (BSU) volumes.
    ...
    unlinkVolumeRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const body = (0, models_1.UnlinkVolumeRequestToJSON)(requestParameters.unlinkVolumeRequest);
            const request = {
                path: `/UnlinkVolume`,
                method: 'POST',
                headers: headerParameters,
            ...
            const response = yield this.request(request, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.UnlinkVolumeResponseFromJSON)(jsonValue));
        });
    }
    /**
     * Detaches a Block Storage Unit (BSU) volume from a virtual machine (VM).<br /> To detach the root device of a VM, this VM must be stopped.
    ...
    updateVolumeRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const body = (0, models_1.UpdateVolumeRequestToJSON)(requestParameters.updateVolumeRequest);
            const request = {
                path: `/UpdateVolume`,
                method: 'POST',
                headers: headerParameters,
            ...
            const response = yield this.request(request, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.UpdateVolumeResponseFromJSON)(jsonValue));
        });
    }
    /**
     * Modifies the specified attributes of a volume.<br />  **[NOTE]**<br /> When the modification is not instantaneous, the response displays the previous value. You can use the [ReadVolumeUpdateTasks](#readvolumeupdatetasks) method to see the progression of the update.
