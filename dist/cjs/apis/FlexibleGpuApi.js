...
exports.FlexibleGpuApi = void 0;
const runtime = __importStar(require("../runtime"));
const models_1 = require("../models");
/**
 *
 */
class FlexibleGpuApi extends runtime.BaseAPI {
    /**
     */
    createFlexibleGpuRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const body = (0, models_1.CreateFlexibleGpuRequestToJSON)(requestParameters.createFlexibleGpuRequest);
            const request = {
            ...
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.CreateFlexibleGpuResponseFromJSON)(jsonValue));
        });
    }
    /**
     */
    ...
    deleteFlexibleGpuRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const body = (0, models_1.DeleteFlexibleGpuRequestToJSON)(requestParameters.deleteFlexibleGpuRequest);
            const request = {
            ...
            const response = yield this.request(request, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.DeleteFlexibleGpuResponseFromJSON)(jsonValue));
        });
    }
    /**
     */
    ...
    linkFlexibleGpuRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const body = (0, models_1.LinkFlexibleGpuRequestToJSON)(requestParameters.linkFlexibleGpuRequest);
            const request = {
            ...
            const response = yield this.request(request, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.LinkFlexibleGpuResponseFromJSON)(jsonValue));
        });
    }
    /**
     */
    ...
    readFlexibleGpuCatalogRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const headerParameters = {};
            headerParameters['Content-Type'] = 'application/json';
            const body = (0, models_1.ReadFlexibleGpuCatalogRequestToJSON)(requestParameters.readFlexibleGpuCatalogRequest);
            const request = {
            ...
            const response = yield this.request(request, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.ReadFlexibleGpuCatalogResponseFromJSON)(jsonValue));
        });
    }
    /**
     */
    ...
    readFlexibleGpusRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const body = (0, models_1.ReadFlexibleGpusRequestToJSON)(requestParameters.readFlexibleGpusRequest);
            const request = {
            ...
            const response = yield this.request(request, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.ReadFlexibleGpusResponseFromJSON)(jsonValue));
        });
    }
    /**
     */
    ...
    unlinkFlexibleGpuRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const body = (0, models_1.UnlinkFlexibleGpuRequestToJSON)(requestParameters.unlinkFlexibleGpuRequest);
            const request = {
            ...
            const response = yield this.request(request, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.UnlinkFlexibleGpuResponseFromJSON)(jsonValue));
        });
    }
    /**
     */
    ...
    updateFlexibleGpuRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const body = (0, models_1.UpdateFlexibleGpuRequestToJSON)(requestParameters.updateFlexibleGpuRequest);
            const request = {
            ...
            const response = yield this.request(request, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.UpdateFlexibleGpuResponseFromJSON)(jsonValue));
        });
    }
    /**
     */
