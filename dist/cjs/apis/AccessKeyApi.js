...
exports.AccessKeyApi = void 0;
const runtime = __importStar(require("../runtime"));
const models_1 = require("../models");
/**
 *
 */
class AccessKeyApi extends runtime.BaseAPI {
    /**
     */
    createAccessKeyRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const body = (0, models_1.CreateAccessKeyRequestToJSON)(requestParameters.createAccessKeyRequest);
            const request = {
            ...
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.CreateAccessKeyResponseFromJSON)(jsonValue));
        });
    }
    /**
     */
    ...
    deleteAccessKeyRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const body = (0, models_1.DeleteAccessKeyRequestToJSON)(requestParameters.deleteAccessKeyRequest);
            const request = {
            ...
            const response = yield this.request(request, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.DeleteAccessKeyResponseFromJSON)(jsonValue));
        });
    }
    /**
     */
    ...
    readAccessKeysRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const body = (0, models_1.ReadAccessKeysRequestToJSON)(requestParameters.readAccessKeysRequest);
            const request = {
                path: `/ReadAccessKeys`,
                method: 'POST',
                headers: headerParameters,
            ...
            const response = yield this.request(request, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.ReadAccessKeysResponseFromJSON)(jsonValue));
        });
    }
    /**
     */
    ...
    readSecretAccessKeyRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const body = (0, models_1.ReadSecretAccessKeyRequestToJSON)(requestParameters.readSecretAccessKeyRequest);
            const request = {
            ...
            const response = yield this.request(request, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.ReadSecretAccessKeyResponseFromJSON)(jsonValue));
        });
    }
    /**
     */
    ...
    updateAccessKeyRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const body = (0, models_1.UpdateAccessKeyRequestToJSON)(requestParameters.updateAccessKeyRequest);
            const request = {
            ...
            const response = yield this.request(request, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.UpdateAccessKeyResponseFromJSON)(jsonValue));
        });
    }
    /**
     */
