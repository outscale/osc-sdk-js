 ...
 *
 */
class TaskApi extends runtime.BaseAPI {
    /**
     */
    deleteExportTaskRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const body = (0, models_1.DeleteExportTaskRequestToJSON)(requestParameters.deleteExportTaskRequest);
            const request = {
            ...
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.DeleteExportTaskResponseFromJSON)(jsonValue));
        });
    }
    /**
     */
