...
class DirectLinkInterfaceApi extends runtime.BaseAPI {
    ...
    createDirectLinkInterfaceRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const body = models_1.CreateDirectLinkInterfaceRequestToJSON(requestParameters.createDirectLinkInterfaceRequest);
            const request = {
            ...
            return new runtime.JSONApiResponse(response, (jsonValue) => models_1.CreateDirectLinkInterfaceResponseFromJSON(jsonValue));
        });
    }
    /**
     */
    ...
    deleteDirectLinkInterfaceRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const body = models_1.DeleteDirectLinkInterfaceRequestToJSON(requestParameters.deleteDirectLinkInterfaceRequest);
            const request = {
            ...
            const response = yield this.request(request, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => models_1.DeleteDirectLinkInterfaceResponseFromJSON(jsonValue));
        });
    }
    /**
     */
    ...
    readDirectLinkInterfacesRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const body = models_1.ReadDirectLinkInterfacesRequestToJSON(requestParameters.readDirectLinkInterfacesRequest);
            const request = {
            ...
            const response = yield this.request(request, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => models_1.ReadDirectLinkInterfacesResponseFromJSON(jsonValue));
        });
    }
    /**
     */
