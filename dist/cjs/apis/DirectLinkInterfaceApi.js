...
exports.DirectLinkInterfaceApi = void 0;
const runtime = __importStar(require("../runtime"));
const models_1 = require("../models");
/**
 *
 */
class DirectLinkInterfaceApi extends runtime.BaseAPI {
    /**
    ...
    createDirectLinkInterfaceRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const body = (0, models_1.CreateDirectLinkInterfaceRequestToJSON)(requestParameters.createDirectLinkInterfaceRequest);
            const request = {
            ...
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.CreateDirectLinkInterfaceResponseFromJSON)(jsonValue));
        });
    }
    /**
     * Creates a DirectLink interface.<br /> DirectLink interfaces enable you to reach one of your Nets through a virtual gateway.<br /><br /> For more information, see [About DirectLink](https://docs.outscale.com/en/userguide/About-DirectLink.html).
    ...
    deleteDirectLinkInterfaceRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const body = (0, models_1.DeleteDirectLinkInterfaceRequestToJSON)(requestParameters.deleteDirectLinkInterfaceRequest);
            const request = {
            ...
            const response = yield this.request(request, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.DeleteDirectLinkInterfaceResponseFromJSON)(jsonValue));
        });
    }
    /**
     * Deletes a specified DirectLink interface.
    ...
    readDirectLinkInterfacesRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const body = (0, models_1.ReadDirectLinkInterfacesRequestToJSON)(requestParameters.readDirectLinkInterfacesRequest);
            const request = {
            ...
            const response = yield this.request(request, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.ReadDirectLinkInterfacesResponseFromJSON)(jsonValue));
        });
    }
    /**
     * Lists one or more of your DirectLink interfaces.
    ...
    updateDirectLinkInterfaceRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const body = (0, models_1.UpdateDirectLinkInterfaceRequestToJSON)(requestParameters.updateDirectLinkInterfaceRequest);
            const request = {
            ...
            const response = yield this.request(request, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.UpdateDirectLinkInterfaceResponseFromJSON)(jsonValue));
        });
    }
    /**
     * Modifies the maximum transmission unit (MTU) of a DirectLink interface.
...
exports.DirectLinkInterfaceApi = DirectLinkInterfaceApi;
