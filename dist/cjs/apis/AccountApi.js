...
class AccountApi extends runtime.BaseAPI {
    ...
    checkAuthenticationRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const body = (0, models_1.CheckAuthenticationRequestToJSON)(requestParameters.checkAuthenticationRequest);
            const request = {
    ...
    createAccountRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const body = (0, models_1.CreateAccountRequestToJSON)(requestParameters.createAccountRequest);
            const request = {
                path: `/CreateAccount`,
                method: 'POST',
                headers: headerParameters,
    ...
    readAccountsRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const body = (0, models_1.ReadAccountsRequestToJSON)(requestParameters.readAccountsRequest);
            const request = {
                path: `/ReadAccounts`,
                method: 'POST',
                headers: headerParameters,
    ...
    readCO2EmissionAccountRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const body = (0, models_1.ReadCO2EmissionAccountRequestToJSON)(requestParameters.readCO2EmissionAccountRequest);
            const request = {
            ...
            const response = yield this.request(request, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.ReadCO2EmissionAccountResponseFromJSON)(jsonValue));
        });
    }
    /**
     * Gets information about the estimated carbon footprint of your account for the current Region within the specified time period.
    ...
    readConsumptionAccountRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const body = (0, models_1.ReadConsumptionAccountRequestToJSON)(requestParameters.readConsumptionAccountRequest);
            const request = {
    ...
    updateAccountRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const body = (0, models_1.UpdateAccountRequestToJSON)(requestParameters.updateAccountRequest);
            const request = {
                path: `/UpdateAccount`,
                method: 'POST',
                headers: headerParameters,
