...
exports.ServerCertificateApi = void 0;
const runtime = __importStar(require("../runtime"));
const models_1 = require("../models");
/**
 *
 */
class ServerCertificateApi extends runtime.BaseAPI {
    /**
     */
    createServerCertificateRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const body = (0, models_1.CreateServerCertificateRequestToJSON)(requestParameters.createServerCertificateRequest);
            const request = {
            ...
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.CreateServerCertificateResponseFromJSON)(jsonValue));
        });
    }
    /**
     */
    ...
    deleteServerCertificateRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const body = (0, models_1.DeleteServerCertificateRequestToJSON)(requestParameters.deleteServerCertificateRequest);
            const request = {
            ...
            const response = yield this.request(request, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.DeleteServerCertificateResponseFromJSON)(jsonValue));
        });
    }
    /**
     */
    ...
    readServerCertificatesRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const body = (0, models_1.ReadServerCertificatesRequestToJSON)(requestParameters.readServerCertificatesRequest);
            const request = {
            ...
            const response = yield this.request(request, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.ReadServerCertificatesResponseFromJSON)(jsonValue));
        });
    }
    /**
     */
    ...
    updateServerCertificateRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const body = (0, models_1.UpdateServerCertificateRequestToJSON)(requestParameters.updateServerCertificateRequest);
            const request = {
            ...
            const response = yield this.request(request, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.UpdateServerCertificateResponseFromJSON)(jsonValue));
        });
    }
    /**
     */
...
exports.ServerCertificateApi = ServerCertificateApi;
