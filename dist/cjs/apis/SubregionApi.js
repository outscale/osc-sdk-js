...
class SubregionApi extends runtime.BaseAPI {
    ...
    readSubregionsRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const body = models_1.ReadSubregionsRequestToJSON(requestParameters.readSubregionsRequest);
            const request = {
                path: `/ReadSubregions`,
                method: 'POST',
            ...
            return new runtime.JSONApiResponse(response, (jsonValue) => models_1.ReadSubregionsResponseFromJSON(jsonValue));
        });
    }
    /**
     */
