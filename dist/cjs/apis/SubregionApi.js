...
exports.SubregionApi = void 0;
const runtime = __importStar(require("../runtime"));
const models_1 = require("../models");
/**
 *
 */
class SubregionApi extends runtime.BaseAPI {
    /**
     */
    readSubregionsRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const body = (0, models_1.ReadSubregionsRequestToJSON)(requestParameters.readSubregionsRequest);
            const request = {
                path: `/ReadSubregions`,
                method: 'POST',
            ...
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.ReadSubregionsResponseFromJSON)(jsonValue));
        });
    }
    /**
     */
...
exports.SubregionApi = SubregionApi;
