...
class CatalogApi extends runtime.BaseAPI {
    ...
    readCatalogRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const body = (0, models_1.ReadCatalogRequestToJSON)(requestParameters.readCatalogRequest);
            const request = {
                path: `/ReadCatalog`,
                method: 'POST',
            ...
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.ReadCatalogResponseFromJSON)(jsonValue));
        });
    }
    /**
     * Returns the price list of OUTSCALE services for the current Region.
    ...
    readCatalogsRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const body = (0, models_1.ReadCatalogsRequestToJSON)(requestParameters.readCatalogsRequest);
            const request = {
                path: `/ReadCatalogs`,
                method: 'POST',
                headers: headerParameters,
            ...
            const response = yield this.request(request, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.ReadCatalogsResponseFromJSON)(jsonValue));
        });
    }
    /**
     * Returns the price list of OUTSCALE services for the current Region within a specific time period.
    ...
    readUnitPriceRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const body = (0, models_1.ReadUnitPriceRequestToJSON)(requestParameters.readUnitPriceRequest);
            const request = {
                path: `/ReadUnitPrice`,
                method: 'POST',
                headers: headerParameters,
            ...
            const response = yield this.request(request, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.ReadUnitPriceResponseFromJSON)(jsonValue));
        });
    }
    /**
     * Gets unit price information for the specified parameters.
