...
class CatalogApi extends runtime.BaseAPI {
    ...
    readCatalogRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const body = models_1.ReadCatalogRequestToJSON(requestParameters.readCatalogRequest);
            const request = {
                path: `/ReadCatalog`,
                method: 'POST',
            ...
            return new runtime.JSONApiResponse(response, (jsonValue) => models_1.ReadCatalogResponseFromJSON(jsonValue));
        });
    }
    /**
     */
