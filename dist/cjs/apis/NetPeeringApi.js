...
class NetPeeringApi extends runtime.BaseAPI {
    ...
    acceptNetPeeringRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const body = models_1.AcceptNetPeeringRequestToJSON(requestParameters.acceptNetPeeringRequest);
            const request = {
            ...
            return new runtime.JSONApiResponse(response, (jsonValue) => models_1.AcceptNetPeeringResponseFromJSON(jsonValue));
        });
    }
    /**
     */
    ...
    createNetPeeringRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const body = models_1.CreateNetPeeringRequestToJSON(requestParameters.createNetPeeringRequest);
            const request = {
            ...
            const response = yield this.request(request, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => models_1.CreateNetPeeringResponseFromJSON(jsonValue));
        });
    }
    /**
     */
    ...
    deleteNetPeeringRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const body = models_1.DeleteNetPeeringRequestToJSON(requestParameters.deleteNetPeeringRequest);
            const request = {
            ...
            const response = yield this.request(request, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => models_1.DeleteNetPeeringResponseFromJSON(jsonValue));
        });
    }
    /**
     */
    ...
    readNetPeeringsRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const body = models_1.ReadNetPeeringsRequestToJSON(requestParameters.readNetPeeringsRequest);
            const request = {
            ...
            const response = yield this.request(request, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => models_1.ReadNetPeeringsResponseFromJSON(jsonValue));
        });
    }
    /**
     */
    ...
    rejectNetPeeringRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const body = models_1.RejectNetPeeringRequestToJSON(requestParameters.rejectNetPeeringRequest);
            const request = {
            ...
            const response = yield this.request(request, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => models_1.RejectNetPeeringResponseFromJSON(jsonValue));
        });
    }
    /**
     */
