 ...
 *
 */
class IdentityProviderApi extends runtime.BaseAPI {
    /**
     ...
     */
    disableOutscaleLoginRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const body = (0, models_1.DisableOutscaleLoginRequestToJSON)(requestParameters.disableOutscaleLoginRequest);
            const request = {
            ...
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.DisableOutscaleLoginResponseFromJSON)(jsonValue));
        });
    }
    /**
     * > [WARNING]<br /> > This feature is currently in beta.<br />  Disables the possibility of logging in using the Outscale credentials of your root account when identity federation is activated.
     ...
     */
    disableOutscaleLoginForUsersZzRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const queryParameters = {};
            const headerParameters = {};
            headerParameters['Content-Type'] = 'application/json';
     ...
     */
    disableOutscaleLoginPerUsersRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const queryParameters = {};
            const headerParameters = {};
            headerParameters['Content-Type'] = 'application/json';
            ...
            const body = (0, models_1.DisableOutscaleLoginPerUsersRequestToJSON)(requestParameters.disableOutscaleLoginPerUsersRequest);
            const request = {
            ...
            const response = yield this.request(request, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.DisableOutscaleLoginPerUsersResponseFromJSON)(jsonValue));
        });
    }
    /**
     * > [WARNING]<br /> > This feature is currently in beta.<br />  Disables the possibility for one or more specific users to log in using their Outscale credentials when identity federation is activated.
     ...
     */
    enableOutscaleLoginRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const queryParameters = {};
            const headerParameters = {};
            headerParameters['Content-Type'] = 'application/json';
            ...
            const body = (0, models_1.EnableOutscaleLoginRequestToJSON)(requestParameters.enableOutscaleLoginRequest);
            const request = {
            ...
            const response = yield this.request(request, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.EnableOutscaleLoginResponseFromJSON)(jsonValue));
        });
    }
    /**
     * > [WARNING]<br /> > This feature is currently in beta.<br />  Enables the possibility of logging in using the Outscale credentials of your root account when identity federation is activated.
     ...
     */
    enableOutscaleLoginForUsersZzRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const queryParameters = {};
            const headerParameters = {};
            headerParameters['Content-Type'] = 'application/json';
            ...
            const body = (0, models_1.EnableOutscaleLoginForUsersRequestToJSON)(requestParameters.enableOutscaleLoginForUsersRequest);
            const request = {
            ...
            const response = yield this.request(request, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.EnableOutscaleLoginForUsersResponseFromJSON)(jsonValue));
        });
    }
    /**
     * > [WARNING]<br /> > This feature is currently in beta.<br />  Enables the possibility for all your EIM users to log in using their Outscale credentials when identity federation is activated.
     ...
     */
    enableOutscaleLoginPerUsersRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const queryParameters = {};
            const headerParameters = {};
            headerParameters['Content-Type'] = 'application/json';
            ...
            const body = (0, models_1.EnableOutscaleLoginPerUsersRequestToJSON)(requestParameters.enableOutscaleLoginPerUsersRequest);
            const request = {
            ...
            const response = yield this.request(request, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.EnableOutscaleLoginPerUsersResponseFromJSON)(jsonValue));
        });
    }
    /**
     * > [WARNING]<br /> > This feature is currently in beta.<br />  Enables the possibility for one or more specific users to log in using their Outscale credentials when identity federation is activated.
