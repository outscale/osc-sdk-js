...
exports.ClientGatewayApi = void 0;
const runtime = __importStar(require("../runtime"));
const models_1 = require("../models");
/**
 *
 */
class ClientGatewayApi extends runtime.BaseAPI {
    /**
     */
    createClientGatewayRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const body = (0, models_1.CreateClientGatewayRequestToJSON)(requestParameters.createClientGatewayRequest);
            const request = {
            ...
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.CreateClientGatewayResponseFromJSON)(jsonValue));
        });
    }
    /**
     */
    ...
    deleteClientGatewayRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const body = (0, models_1.DeleteClientGatewayRequestToJSON)(requestParameters.deleteClientGatewayRequest);
            const request = {
            ...
            const response = yield this.request(request, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.DeleteClientGatewayResponseFromJSON)(jsonValue));
        });
    }
    /**
     */
    ...
    readClientGatewaysRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const body = (0, models_1.ReadClientGatewaysRequestToJSON)(requestParameters.readClientGatewaysRequest);
            const request = {
            ...
            const response = yield this.request(request, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.ReadClientGatewaysResponseFromJSON)(jsonValue));
        });
    }
    /**
     */
...
exports.ClientGatewayApi = ClientGatewayApi;
