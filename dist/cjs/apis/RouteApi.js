 ...
 *
 */
class RouteApi extends runtime.BaseAPI {
    /**
    ...
    createRouteRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const body = (0, models_1.CreateRouteRequestToJSON)(requestParameters.createRouteRequest);
            const request = {
                path: `/CreateRoute`,
                method: 'POST',
            ...
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.CreateRouteResponseFromJSON)(jsonValue));
        });
    }
    /**
     * Creates a route in a specified route table within a specified Net.<br /> You must specify one of the following elements as the target:<br /><br />  * Net peering<br /> * NAT VM<br /> * Internet service<br /> * Virtual gateway<br /> * NAT service<br /> * Network interface card (NIC)<br /><br />  The routing algorithm is based on the most specific match.<br /><br /> For more information, see [About Route Tables](https://docs.outscale.com/en/userguide/About-Route-Tables.html).
    ...
    deleteRouteRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const body = (0, models_1.DeleteRouteRequestToJSON)(requestParameters.deleteRouteRequest);
            const request = {
                path: `/DeleteRoute`,
                method: 'POST',
                headers: headerParameters,
            ...
            const response = yield this.request(request, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.DeleteRouteResponseFromJSON)(jsonValue));
        });
    }
    /**
     * Deletes a route from a specified route table.
    ...
    updateRouteRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const body = (0, models_1.UpdateRouteRequestToJSON)(requestParameters.updateRouteRequest);
            const request = {
                path: `/UpdateRoute`,
                method: 'POST',
                headers: headerParameters,
            ...
            const response = yield this.request(request, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.UpdateRouteResponseFromJSON)(jsonValue));
        });
    }
    /**
     * Replaces an existing route within a route table in a Net.<br /> You must specify one of the following elements as the target:<br /><br />  * Net peering<br /> * NAT virtual machine (VM)<br /> * Internet service<br /> * Virtual gateway<br /> * NAT service<br /> * Network interface card (NIC)<br /><br />  The routing algorithm is based on the most specific match.
