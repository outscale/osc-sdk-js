...
class RouteApi extends runtime.BaseAPI {
    ...
    createRouteRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const body = models_1.CreateRouteRequestToJSON(requestParameters.createRouteRequest);
            const request = {
                path: `/CreateRoute`,
                method: 'POST',
            ...
            return new runtime.JSONApiResponse(response, (jsonValue) => models_1.CreateRouteResponseFromJSON(jsonValue));
        });
    }
    /**
     */
    ...
    deleteRouteRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const body = models_1.DeleteRouteRequestToJSON(requestParameters.deleteRouteRequest);
            const request = {
                path: `/DeleteRoute`,
                method: 'POST',
                headers: headerParameters,
            ...
            const response = yield this.request(request, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => models_1.DeleteRouteResponseFromJSON(jsonValue));
        });
    }
    /**
     */
    ...
    updateRouteRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const body = models_1.UpdateRouteRequestToJSON(requestParameters.updateRouteRequest);
            const request = {
                path: `/UpdateRoute`,
                method: 'POST',
                headers: headerParameters,
            ...
            const response = yield this.request(request, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => models_1.UpdateRouteResponseFromJSON(jsonValue));
        });
    }
    /**
     */
