...
class KeypairApi extends runtime.BaseAPI {
    ...
    createKeypairRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const body = models_1.CreateKeypairRequestToJSON(requestParameters.createKeypairRequest);
            const request = {
                path: `/CreateKeypair`,
                method: 'POST',
            ...
            return new runtime.JSONApiResponse(response, (jsonValue) => models_1.CreateKeypairResponseFromJSON(jsonValue));
        });
    }
    /**
     */
    ...
    deleteKeypairRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const body = models_1.DeleteKeypairRequestToJSON(requestParameters.deleteKeypairRequest);
            const request = {
                path: `/DeleteKeypair`,
                method: 'POST',
                headers: headerParameters,
            ...
            const response = yield this.request(request, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => models_1.DeleteKeypairResponseFromJSON(jsonValue));
        });
    }
    /**
     */
    ...
    readKeypairsRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const body = models_1.ReadKeypairsRequestToJSON(requestParameters.readKeypairsRequest);
            const request = {
                path: `/ReadKeypairs`,
                method: 'POST',
                headers: headerParameters,
            ...
            const response = yield this.request(request, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => models_1.ReadKeypairsResponseFromJSON(jsonValue));
        });
    }
    /**
     */
