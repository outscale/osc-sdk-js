...
class UserApi extends runtime.BaseAPI {
    ...
    createUserRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const body = (0, models_1.CreateUserRequestToJSON)(requestParameters.createUserRequest);
            const request = {
                path: `/CreateUser`,
                method: 'POST',
            ...
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.CreateUserResponseFromJSON)(jsonValue));
        });
    }
    /**
     */
    ...
    deleteUserRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const body = (0, models_1.DeleteUserRequestToJSON)(requestParameters.deleteUserRequest);
            const request = {
                path: `/DeleteUser`,
                method: 'POST',
                headers: headerParameters,
            ...
            const response = yield this.request(request, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.DeleteUserResponseFromJSON)(jsonValue));
        });
    }
    /**
     */
    ...
    /**
     */
    readUsersRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const queryParameters = {};
            const headerParameters = {};
            headerParameters['Content-Type'] = 'application/json';
            ...
            const body = (0, models_1.ReadUsersRequestToJSON)(requestParameters.readUsersRequest);
            const request = {
                path: `/ReadUsers`,
                method: 'POST',
                headers: headerParameters,
            ...
            const response = yield this.request(request, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.ReadUsersResponseFromJSON)(jsonValue));
        });
    }
    /**
     */
    ...
    updateUserRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const body = (0, models_1.UpdateUserRequestToJSON)(requestParameters.updateUserRequest);
            const request = {
                path: `/UpdateUser`,
                method: 'POST',
                headers: headerParameters,
            ...
            const response = yield this.request(request, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.UpdateUserResponseFromJSON)(jsonValue));
        });
    }
    /**
     */
