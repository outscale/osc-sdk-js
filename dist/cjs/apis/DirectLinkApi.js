...
class DirectLinkApi extends runtime.BaseAPI {
    ...
    createDirectLinkRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const body = models_1.CreateDirectLinkRequestToJSON(requestParameters.createDirectLinkRequest);
            const request = {
            ...
            return new runtime.JSONApiResponse(response, (jsonValue) => models_1.CreateDirectLinkResponseFromJSON(jsonValue));
        });
    }
    /**
     */
    ...
    deleteDirectLinkRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const body = models_1.DeleteDirectLinkRequestToJSON(requestParameters.deleteDirectLinkRequest);
            const request = {
            ...
            const response = yield this.request(request, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => models_1.DeleteDirectLinkResponseFromJSON(jsonValue));
        });
    }
    /**
     */
    ...
    readDirectLinksRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const body = models_1.ReadDirectLinksRequestToJSON(requestParameters.readDirectLinksRequest);
            const request = {
            ...
            const response = yield this.request(request, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => models_1.ReadDirectLinksResponseFromJSON(jsonValue));
        });
    }
    /**
     */
