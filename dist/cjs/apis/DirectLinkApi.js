...
exports.DirectLinkApi = void 0;
const runtime = __importStar(require("../runtime"));
const models_1 = require("../models");
/**
 *
 */
class DirectLinkApi extends runtime.BaseAPI {
    /**
    ...
    createDirectLinkRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const body = (0, models_1.CreateDirectLinkRequestToJSON)(requestParameters.createDirectLinkRequest);
            const request = {
            ...
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.CreateDirectLinkResponseFromJSON)(jsonValue));
        });
    }
    /**
     * Creates a DirectLink between a customer network and a specified DirectLink location.<br /><br /> For more information, see [About DirectLink](https://docs.outscale.com/en/userguide/About-DirectLink.html).
    ...
    deleteDirectLinkRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const body = (0, models_1.DeleteDirectLinkRequestToJSON)(requestParameters.deleteDirectLinkRequest);
            const request = {
            ...
            const response = yield this.request(request, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.DeleteDirectLinkResponseFromJSON)(jsonValue));
        });
    }
    /**
     * Deletes a specified DirectLink.<br /> Before deleting a DirectLink, ensure that all your DirectLink interfaces related to this DirectLink are deleted.
    ...
    readDirectLinksRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const body = (0, models_1.ReadDirectLinksRequestToJSON)(requestParameters.readDirectLinksRequest);
            const request = {
            ...
            const response = yield this.request(request, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.ReadDirectLinksResponseFromJSON)(jsonValue));
        });
    }
    /**
     * Lists all DirectLinks in the Region.
...
exports.DirectLinkApi = DirectLinkApi;
