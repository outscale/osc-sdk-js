...
class ListenerApi extends runtime.BaseAPI {
    ...
    createListenerRuleRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const body = models_1.CreateListenerRuleRequestToJSON(requestParameters.createListenerRuleRequest);
            const request = {
            ...
            return new runtime.JSONApiResponse(response, (jsonValue) => models_1.CreateListenerRuleResponseFromJSON(jsonValue));
        });
    }
    /**
     */
    ...
    createLoadBalancerListenersRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const body = models_1.CreateLoadBalancerListenersRequestToJSON(requestParameters.createLoadBalancerListenersRequest);
            const request = {
            ...
            const response = yield this.request(request, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => models_1.CreateLoadBalancerListenersResponseFromJSON(jsonValue));
        });
    }
    /**
     */
    ...
    deleteListenerRuleRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const body = models_1.DeleteListenerRuleRequestToJSON(requestParameters.deleteListenerRuleRequest);
            const request = {
            ...
            const response = yield this.request(request, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => models_1.DeleteListenerRuleResponseFromJSON(jsonValue));
        });
    }
    /**
     */
    ...
    deleteLoadBalancerListenersRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const body = models_1.DeleteLoadBalancerListenersRequestToJSON(requestParameters.deleteLoadBalancerListenersRequest);
            const request = {
            ...
            const response = yield this.request(request, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => models_1.DeleteLoadBalancerListenersResponseFromJSON(jsonValue));
        });
    }
    /**
     */
    ...
    readListenerRulesRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const body = models_1.ReadListenerRulesRequestToJSON(requestParameters.readListenerRulesRequest);
            const request = {
            ...
            const response = yield this.request(request, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => models_1.ReadListenerRulesResponseFromJSON(jsonValue));
        });
    }
    /**
     */
    ...
    updateListenerRuleRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const body = models_1.UpdateListenerRuleRequestToJSON(requestParameters.updateListenerRuleRequest);
            const request = {
            ...
            const response = yield this.request(request, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => models_1.UpdateListenerRuleResponseFromJSON(jsonValue));
        });
    }
    /**
     */
