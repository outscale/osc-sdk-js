...
exports.ApiAccessPolicyApi = void 0;
const runtime = __importStar(require("../runtime"));
const models_1 = require("../models");
/**
 *
 */
class ApiAccessPolicyApi extends runtime.BaseAPI {
    /**
     */
    readApiAccessPolicyRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const body = (0, models_1.ReadApiAccessPolicyRequestToJSON)(requestParameters.readApiAccessPolicyRequest);
            const request = {
            ...
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.ReadApiAccessPolicyResponseFromJSON)(jsonValue));
        });
    }
    /**
     */
    ...
    updateApiAccessPolicyRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const body = (0, models_1.UpdateApiAccessPolicyRequestToJSON)(requestParameters.updateApiAccessPolicyRequest);
            const request = {
            ...
            const response = yield this.request(request, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.UpdateApiAccessPolicyResponseFromJSON)(jsonValue));
        });
    }
    /**
     */
...
exports.ApiAccessPolicyApi = ApiAccessPolicyApi;
