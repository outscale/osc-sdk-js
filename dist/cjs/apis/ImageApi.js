...
class ImageApi extends runtime.BaseAPI {
    ...
    createImageRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const body = models_1.CreateImageRequestToJSON(requestParameters.createImageRequest);
            const request = {
                path: `/CreateImage`,
                method: 'POST',
            ...
            return new runtime.JSONApiResponse(response, (jsonValue) => models_1.CreateImageResponseFromJSON(jsonValue));
        });
    }
    /**
     */
    ...
    createImageExportTaskRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const body = models_1.CreateImageExportTaskRequestToJSON(requestParameters.createImageExportTaskRequest);
            const request = {
            ...
            const response = yield this.request(request, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => models_1.CreateImageExportTaskResponseFromJSON(jsonValue));
        });
    }
    /**
     */
    ...
    deleteImageRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const body = models_1.DeleteImageRequestToJSON(requestParameters.deleteImageRequest);
            const request = {
                path: `/DeleteImage`,
                method: 'POST',
                headers: headerParameters,
            ...
            const response = yield this.request(request, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => models_1.DeleteImageResponseFromJSON(jsonValue));
        });
    }
    /**
     */
    ...
    readImageExportTasksRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const body = models_1.ReadImageExportTasksRequestToJSON(requestParameters.readImageExportTasksRequest);
            const request = {
            ...
            const response = yield this.request(request, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => models_1.ReadImageExportTasksResponseFromJSON(jsonValue));
        });
    }
    /**
     */
    ...
    readImagesRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const body = models_1.ReadImagesRequestToJSON(requestParameters.readImagesRequest);
            const request = {
                path: `/ReadImages`,
                method: 'POST',
                headers: headerParameters,
            ...
            const response = yield this.request(request, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => models_1.ReadImagesResponseFromJSON(jsonValue));
        });
    }
    /**
     */
    ...
    updateImageRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const body = models_1.UpdateImageRequestToJSON(requestParameters.updateImageRequest);
            const request = {
                path: `/UpdateImage`,
                method: 'POST',
                headers: headerParameters,
            ...
            const response = yield this.request(request, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => models_1.UpdateImageResponseFromJSON(jsonValue));
        });
    }
    /**
     */
