...
class VmApi extends runtime.BaseAPI {
    ...
    createVmsRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const body = models_1.CreateVmsRequestToJSON(requestParameters.createVmsRequest);
            const request = {
                path: `/CreateVms`,
                method: 'POST',
            ...
            return new runtime.JSONApiResponse(response, (jsonValue) => models_1.CreateVmsResponseFromJSON(jsonValue));
        });
    }
    /**
     */
    ...
    deleteVmsRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const body = models_1.DeleteVmsRequestToJSON(requestParameters.deleteVmsRequest);
            const request = {
                path: `/DeleteVms`,
                method: 'POST',
                headers: headerParameters,
            ...
            const response = yield this.request(request, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => models_1.DeleteVmsResponseFromJSON(jsonValue));
        });
    }
    /**
     */
    ...
    readAdminPasswordRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const body = models_1.ReadAdminPasswordRequestToJSON(requestParameters.readAdminPasswordRequest);
            const request = {
            ...
            const response = yield this.request(request, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => models_1.ReadAdminPasswordResponseFromJSON(jsonValue));
        });
    }
    /**
     */
    ...
    readConsoleOutputRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const body = models_1.ReadConsoleOutputRequestToJSON(requestParameters.readConsoleOutputRequest);
            const request = {
            ...
            const response = yield this.request(request, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => models_1.ReadConsoleOutputResponseFromJSON(jsonValue));
        });
    }
    /**
     */
    ...
    readVmTypesRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const headerParameters = {};
            headerParameters['Content-Type'] = 'application/json';
            const body = models_1.ReadVmTypesRequestToJSON(requestParameters.readVmTypesRequest);
            const request = {
                path: `/ReadVmTypes`,
                method: 'POST',
                headers: headerParameters,
            ...
            const response = yield this.request(request, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => models_1.ReadVmTypesResponseFromJSON(jsonValue));
        });
    }
    /**
     */
    ...
    readVmsRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const body = models_1.ReadVmsRequestToJSON(requestParameters.readVmsRequest);
            const request = {
                path: `/ReadVms`,
                method: 'POST',
                headers: headerParameters,
            ...
            const response = yield this.request(request, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => models_1.ReadVmsResponseFromJSON(jsonValue));
        });
    }
    /**
     */
    ...
    readVmsStateRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const body = models_1.ReadVmsStateRequestToJSON(requestParameters.readVmsStateRequest);
            const request = {
                path: `/ReadVmsState`,
                method: 'POST',
                headers: headerParameters,
            ...
            const response = yield this.request(request, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => models_1.ReadVmsStateResponseFromJSON(jsonValue));
        });
    }
    /**
     */
    ...
    rebootVmsRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const body = models_1.RebootVmsRequestToJSON(requestParameters.rebootVmsRequest);
            const request = {
                path: `/RebootVms`,
                method: 'POST',
                headers: headerParameters,
            ...
            const response = yield this.request(request, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => models_1.RebootVmsResponseFromJSON(jsonValue));
        });
    }
    /**
     */
    ...
    startVmsRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const body = models_1.StartVmsRequestToJSON(requestParameters.startVmsRequest);
            const request = {
                path: `/StartVms`,
                method: 'POST',
                headers: headerParameters,
            ...
            const response = yield this.request(request, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => models_1.StartVmsResponseFromJSON(jsonValue));
        });
    }
    /**
     */
    ...
    stopVmsRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const body = models_1.StopVmsRequestToJSON(requestParameters.stopVmsRequest);
            const request = {
                path: `/StopVms`,
                method: 'POST',
                headers: headerParameters,
            ...
            const response = yield this.request(request, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => models_1.StopVmsResponseFromJSON(jsonValue));
        });
    }
    /**
     */
    ...
    updateVmRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const body = models_1.UpdateVmRequestToJSON(requestParameters.updateVmRequest);
            const request = {
                path: `/UpdateVm`,
                method: 'POST',
                headers: headerParameters,
            ...
            const response = yield this.request(request, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => models_1.UpdateVmResponseFromJSON(jsonValue));
        });
    }
    /**
     */
