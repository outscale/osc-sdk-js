...
class VmApi extends runtime.BaseAPI {
    ...
    readVmsStopHistoryRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const body = (0, models_1.ReadVmsStopHistoryRequestToJSON)(requestParameters.readVmsStopHistoryRequest);
            const request = {
            ...
            const response = yield this.request(request, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.ReadVmsStopHistoryResponseFromJSON)(jsonValue));
        });
    }
    /**
     * Lists the stop history of one or more VMs.
