...
class SecurityGroupApi extends runtime.BaseAPI {
    ...
    createSecurityGroupRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const body = models_1.CreateSecurityGroupRequestToJSON(requestParameters.createSecurityGroupRequest);
            const request = {
            ...
            return new runtime.JSONApiResponse(response, (jsonValue) => models_1.CreateSecurityGroupResponseFromJSON(jsonValue));
        });
    }
    /**
     */
    ...
    deleteSecurityGroupRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const body = models_1.DeleteSecurityGroupRequestToJSON(requestParameters.deleteSecurityGroupRequest);
            const request = {
            ...
            const response = yield this.request(request, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => models_1.DeleteSecurityGroupResponseFromJSON(jsonValue));
        });
    }
    /**
     */
    ...
    readSecurityGroupsRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const body = models_1.ReadSecurityGroupsRequestToJSON(requestParameters.readSecurityGroupsRequest);
            const request = {
            ...
            const response = yield this.request(request, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => models_1.ReadSecurityGroupsResponseFromJSON(jsonValue));
        });
    }
    /**
     */
