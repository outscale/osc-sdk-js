...
import {
    ...
    ReadVmsStopHistoryRequestFromJSON,
    ReadVmsStopHistoryRequestToJSON,
    ReadVmsStopHistoryResponse,
    ReadVmsStopHistoryResponseFromJSON,
    ReadVmsStopHistoryResponseToJSON,
    RebootVmsRequest,
...
export interface ReadVmsStopHistoryOperationRequest {
...
export interface VmApiInterface {
     ...
     * @param {ReadVmsStopHistoryRequest} [readVmsStopHistoryRequest] 
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     * @memberof VmApiInterface
     */
    readVmsStopHistoryRaw(requestParameters: ReadVmsStopHistoryOperationRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<runtime.ApiResponse<ReadVmsStopHistoryResponse>>;

    /**
     * Lists the stop history of one or more VMs.
     */
    readVmsStopHistory(requestParameters: ReadVmsStopHistoryOperationRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<ReadVmsStopHistoryResponse>;
...
export class VmApi extends runtime.BaseAPI implements VmApiInterface {
     ...
     * Lists the stop history of one or more VMs.
     */
    async readVmsStopHistoryRaw(requestParameters: ReadVmsStopHistoryOperationRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<runtime.ApiResponse<ReadVmsStopHistoryResponse>> {
        const queryParameters: any = {};
        ...
        const body: any = ReadVmsStopHistoryRequestToJSON(requestParameters.readVmsStopHistoryRequest);
     ...
     * Lists the stop history of one or more VMs.
     */
    async readVmsStopHistory(requestParameters: ReadVmsStopHistoryOperationRequest = {}, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<ReadVmsStopHistoryResponse> {
        const response = await this.readVmsStopHistoryRaw(requestParameters, initOverrides);
        return await response.value();
    }
