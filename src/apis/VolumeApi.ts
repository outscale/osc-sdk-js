...
import {
    ...
    ReadVolumeUpdateTasksRequestFromJSON,
    ReadVolumeUpdateTasksRequestToJSON,
    ReadVolumeUpdateTasksResponse,
    ReadVolumeUpdateTasksResponseFromJSON,
    ReadVolumeUpdateTasksResponseToJSON,
    ReadVolumesRequest,
...
export class VolumeApi extends runtime.BaseAPI implements VolumeApiInterface {
     ...
     * Lists one or more update tasks of volumes
     */
    async readVolumeUpdateTasksRaw(requestParameters: ReadVolumeUpdateTasksOperationRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<runtime.ApiResponse<ReadVolumeUpdateTasksResponse>> {
        const queryParameters: any = {};
        ...
        const body: any = ReadVolumeUpdateTasksRequestToJSON(requestParameters.readVolumeUpdateTasksRequest);
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => ReadVolumeUpdateTasksResponseFromJSON(jsonValue));
    }
     ...
     * Lists one or more update tasks of volumes
     */
    async readVolumeUpdateTasks(requestParameters: ReadVolumeUpdateTasksOperationRequest = {}, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<ReadVolumeUpdateTasksResponse> {
        const response = await this.readVolumeUpdateTasksRaw(requestParameters, initOverrides);
        return await response.value();
    }
