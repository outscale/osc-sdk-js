...
export class RetryMiddleware implements Middleware {
    ...
    private readonly shouldRetry?: (response: Response, attempt: number) => boolean;
    private readonly jitterMs: number;
    
    private attemptMap = new WeakMap<Request, number>();
    ...
    constructor(options: RetryOptions = {}) {
        ...
        this.retryableStatuses = new Set(options.retryableStatuses ?? [408, 429, 500, 502, 503, 504]);
    ...
    async post(context: ResponseContext): Promise<Response | void> {
        ...
        const currentAttempt = this.attemptMap.get(request) ?? 0;
        ...
        const delay = Math.min(
            this.initialDelayMs * Math.pow(this.backoffMultiplier, currentAttempt),
            this.maxDelayMs
        );
...
export class Configuration {
    constructor(private configuration: ConfigurationParameters = {}) {
        ...
        if (!("User-Agent" in headers)) {
            headers["User-Agent"] = "osc-sdk-js/0.24.0"
        }
