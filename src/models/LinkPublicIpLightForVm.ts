...
export function LinkPublicIpLightForVmFromJSON(json: any): LinkPublicIpLightForVm {
    return LinkPublicIpLightForVmFromJSONTyped(json, false);
}

export function LinkPublicIpLightForVmFromJSONTyped(json: any, ignoreDiscriminator: boolean): LinkPublicIpLightForVm {
...
export function LinkPublicIpLightForVmToJSON(value?: LinkPublicIpLightForVm | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
