...
import {
    VolumeUpdate,
    VolumeUpdateFromJSON,
    VolumeUpdateFromJSONTyped,
    VolumeUpdateToJSON,
} from './VolumeUpdate';
 ...
 * @export
 * @interface VolumeUpdateTask
 */
export interface VolumeUpdateTask {
    /**
     * If the update volume task fails, an error message appears.
     * @type {string}
     * @memberof VolumeUpdateTask
     */
    comment?: string;
    /**
...
export function VolumeUpdateTaskFromJSON(json: any): VolumeUpdateTask {
    return VolumeUpdateTaskFromJSONTyped(json, false);
}

export function VolumeUpdateTaskFromJSONTyped(json: any, ignoreDiscriminator: boolean): VolumeUpdateTask {
    ...
    return {
        ...
        'volumeUpdate': !exists(json, 'VolumeUpdate') ? undefined : VolumeUpdateFromJSON(json['VolumeUpdate']),
    };
}

export function VolumeUpdateTaskToJSON(value?: VolumeUpdateTask | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'VolumeUpdate': VolumeUpdateToJSON(value.volumeUpdate),
    };
}
