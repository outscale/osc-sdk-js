...
export interface DeleteUserPolicyRequest {
     ...
     * @type {boolean}
     * @memberof DeleteUserPolicyRequest
     */
    dryRun?: boolean;
    /**
...
export function DeleteUserPolicyRequestFromJSON(json: any): DeleteUserPolicyRequest {
    return DeleteUserPolicyRequestFromJSONTyped(json, false);
}

export function DeleteUserPolicyRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): DeleteUserPolicyRequest {
...
export function DeleteUserPolicyRequestToJSON(value?: DeleteUserPolicyRequest | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
