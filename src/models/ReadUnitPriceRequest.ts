...
export function ReadUnitPriceRequestFromJSON(json: any): ReadUnitPriceRequest {
    return ReadUnitPriceRequestFromJSONTyped(json, false);
}

export function ReadUnitPriceRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): ReadUnitPriceRequest {
...
export function ReadUnitPriceRequestToJSON(value?: ReadUnitPriceRequest | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
