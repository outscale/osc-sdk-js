...
export function DeleteSecurityGroupRequestFromJSON(json: any): DeleteSecurityGroupRequest {
    return DeleteSecurityGroupRequestFromJSONTyped(json, false);
}

export function DeleteSecurityGroupRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): DeleteSecurityGroupRequest {
...
export function DeleteSecurityGroupRequestToJSON(value?: DeleteSecurityGroupRequest | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
