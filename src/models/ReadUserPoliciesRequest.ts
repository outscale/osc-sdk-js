 ...
 * 
 * @export
 * @interface ReadUserPoliciesRequest
 */
export interface ReadUserPoliciesRequest {
    /**
     * If true, checks whether you have the required permissions to perform the action.
     * @type {boolean}
     * @memberof ReadUserPoliciesRequest
     */
    dryRun?: boolean;
    /**
...
export function ReadUserPoliciesRequestFromJSON(json: any): ReadUserPoliciesRequest {
    return ReadUserPoliciesRequestFromJSONTyped(json, false);
}

export function ReadUserPoliciesRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): ReadUserPoliciesRequest {
...
export function ReadUserPoliciesRequestToJSON(value?: ReadUserPoliciesRequest | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
