 ...
 * One or more filters.
 * @export
 * @interface FiltersVmsStopHistory
 */
export interface FiltersVmsStopHistory {
    /**
     ...
     * @type {Array<string>}
     * @memberof FiltersVmsStopHistory
     */
...
export function FiltersVmsStopHistoryFromJSON(json: any): FiltersVmsStopHistory {
    return FiltersVmsStopHistoryFromJSONTyped(json, false);
}

export function FiltersVmsStopHistoryFromJSONTyped(json: any, ignoreDiscriminator: boolean): FiltersVmsStopHistory {
    ...
    return {
        ...
        'stopDateAfter': !exists(json, 'StopDateAfter') ? undefined : (new Date(json['StopDateAfter'])),
        'stopDateBefore': !exists(json, 'StopDateBefore') ? undefined : (new Date(json['StopDateBefore'])),
        'vmIds': !exists(json, 'VmIds') ? undefined : json['VmIds'],
    };
}

export function FiltersVmsStopHistoryToJSON(value?: FiltersVmsStopHistory | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'StopDateAfter': value.stopDateAfter === undefined ? undefined : (value.stopDateAfter.toISOString().substr(0,10)),
        'StopDateBefore': value.stopDateBefore === undefined ? undefined : (value.stopDateBefore.toISOString().substr(0,10)),
        'VmIds': value.vmIds,
    };
}
