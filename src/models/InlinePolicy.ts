...
export function InlinePolicyFromJSON(json: any): InlinePolicy {
    return InlinePolicyFromJSONTyped(json, false);
}

export function InlinePolicyFromJSONTyped(json: any, ignoreDiscriminator: boolean): InlinePolicy {
...
export function InlinePolicyToJSON(value?: InlinePolicy | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
