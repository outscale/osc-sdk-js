...
export function FiltersDedicatedGroupFromJSON(json: any): FiltersDedicatedGroup {
    return FiltersDedicatedGroupFromJSONTyped(json, false);
}

export function FiltersDedicatedGroupFromJSONTyped(json: any, ignoreDiscriminator: boolean): FiltersDedicatedGroup {
    ...
    return {
        ...
        'dedicatedGroupIds': !exists(json, 'DedicatedGroupIds') ? undefined : json['DedicatedGroupIds'],
        'names': !exists(json, 'Names') ? undefined : json['Names'],
        'subregionNames': !exists(json, 'SubregionNames') ? undefined : json['SubregionNames'],
    };
}

export function FiltersDedicatedGroupToJSON(value?: FiltersDedicatedGroup | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
