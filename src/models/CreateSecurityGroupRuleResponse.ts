...
export function CreateSecurityGroupRuleResponseFromJSON(json: any): CreateSecurityGroupRuleResponse {
    return CreateSecurityGroupRuleResponseFromJSONTyped(json, false);
}

export function CreateSecurityGroupRuleResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): CreateSecurityGroupRuleResponse {
...
export function CreateSecurityGroupRuleResponseToJSON(value?: CreateSecurityGroupRuleResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
