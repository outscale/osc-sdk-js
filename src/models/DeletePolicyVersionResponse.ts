...
export function DeletePolicyVersionResponseFromJSON(json: any): DeletePolicyVersionResponse {
    return DeletePolicyVersionResponseFromJSONTyped(json, false);
}

export function DeletePolicyVersionResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): DeletePolicyVersionResponse {
...
export function DeletePolicyVersionResponseToJSON(value?: DeletePolicyVersionResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
