...
import {
    VpnOptionsToUpdate,
    VpnOptionsToUpdateFromJSON,
    VpnOptionsToUpdateFromJSONTyped,
    VpnOptionsToUpdateToJSON,
} from './VpnOptionsToUpdate';
...
export function UpdateVpnConnectionRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): UpdateVpnConnectionRequest {
    ...
    return {
        ...
        'vpnOptions': !exists(json, 'VpnOptions') ? undefined : VpnOptionsToUpdateFromJSON(json['VpnOptions']),
    };
}
...
export function UpdateVpnConnectionRequestToJSON(value?: UpdateVpnConnectionRequest | null): any {
    ...
    return {
        ...
        'VpnOptions': VpnOptionsToUpdateToJSON(value.vpnOptions),
    };
}
