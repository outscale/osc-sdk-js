...
import {
    VmsStopHistory,
    VmsStopHistoryFromJSON,
    VmsStopHistoryFromJSONTyped,
    VmsStopHistoryToJSON,
} from './VmsStopHistory';

/**
 * 
 * @export
 * @interface ReadVmsStopHistoryResponse
 */
export interface ReadVmsStopHistoryResponse {
    /**
     * The token to request the next page of results. Each token refers to a specific page.
     * @type {string}
     * @memberof ReadVmsStopHistoryResponse
     */
     ...
     * @type {Array<VmsStopHistory>}
     * @memberof ReadVmsStopHistoryResponse
     */
    vmsStopHistory?: Array<VmsStopHistory>;
}

export function ReadVmsStopHistoryResponseFromJSON(json: any): ReadVmsStopHistoryResponse {
    return ReadVmsStopHistoryResponseFromJSONTyped(json, false);
}

export function ReadVmsStopHistoryResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ReadVmsStopHistoryResponse {
    ...
    return {
        ...
        'vmsStopHistory': !exists(json, 'VmsStopHistory') ? undefined : ((json['VmsStopHistory'] as Array<any>).map(VmsStopHistoryFromJSON)),
    };
}

export function ReadVmsStopHistoryResponseToJSON(value?: ReadVmsStopHistoryResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'VmsStopHistory': value.vmsStopHistory === undefined ? undefined : ((value.vmsStopHistory as Array<any>).map(VmsStopHistoryToJSON)),
    };
}
