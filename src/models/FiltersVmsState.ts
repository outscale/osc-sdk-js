...
export function FiltersVmsStateFromJSON(json: any): FiltersVmsState {
    return FiltersVmsStateFromJSONTyped(json, false);
}

export function FiltersVmsStateFromJSONTyped(json: any, ignoreDiscriminator: boolean): FiltersVmsState {
...
export function FiltersVmsStateToJSON(value?: FiltersVmsState | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
