 ...
 * 
 * @export
 * @interface ReadPolicyVersionResponse
 */
export interface ReadPolicyVersionResponse {
    /**
     * 
     * @type {PolicyVersion}
     * @memberof ReadPolicyVersionResponse
     */
...
export function ReadPolicyVersionResponseFromJSON(json: any): ReadPolicyVersionResponse {
    return ReadPolicyVersionResponseFromJSONTyped(json, false);
}

export function ReadPolicyVersionResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ReadPolicyVersionResponse {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'policyVersion': !exists(json, 'PolicyVersion') ? undefined : PolicyVersionFromJSON(json['PolicyVersion']),
        'responseContext': !exists(json, 'ResponseContext') ? undefined : ModelResponseContextFromJSON(json['ResponseContext']),
    };
}

export function ReadPolicyVersionResponseToJSON(value?: ReadPolicyVersionResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'PolicyVersion': PolicyVersionToJSON(value.policyVersion),
