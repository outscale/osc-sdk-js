...
export function LinkVirtualGatewayResponseFromJSON(json: any): LinkVirtualGatewayResponse {
    return LinkVirtualGatewayResponseFromJSONTyped(json, false);
}

export function LinkVirtualGatewayResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): LinkVirtualGatewayResponse {
...
export function LinkVirtualGatewayResponseToJSON(value?: LinkVirtualGatewayResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
