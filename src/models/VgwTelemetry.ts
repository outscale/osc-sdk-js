...
export function VgwTelemetryFromJSONTyped(json: any, ignoreDiscriminator: boolean): VgwTelemetry {
    ...
    return {
        ...
        'lastStateChangeDate': !exists(json, 'LastStateChangeDate') ? undefined : (new Date(json['LastStateChangeDate'])),
...
export function VgwTelemetryToJSON(value?: VgwTelemetry | null): any {
    ...
    return {
        ...
        'LastStateChangeDate': value.lastStateChangeDate === undefined ? undefined : (value.lastStateChangeDate.toISOString()),
