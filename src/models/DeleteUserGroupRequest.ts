...
export function DeleteUserGroupRequestFromJSON(json: any): DeleteUserGroupRequest {
    return DeleteUserGroupRequestFromJSONTyped(json, false);
}

export function DeleteUserGroupRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): DeleteUserGroupRequest {
...
export function DeleteUserGroupRequestToJSON(value?: DeleteUserGroupRequest | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
