 ...
 * 
 * @export
 * @interface ReadUserGroupResponse
 */
export interface ReadUserGroupResponse {
    /**
     * 
     * @type {ModelResponseContext}
     * @memberof ReadUserGroupResponse
     */
...
export function ReadUserGroupResponseFromJSON(json: any): ReadUserGroupResponse {
    return ReadUserGroupResponseFromJSONTyped(json, false);
}

export function ReadUserGroupResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ReadUserGroupResponse {
    ...
    return {
        ...
        'userGroup': !exists(json, 'UserGroup') ? undefined : UserGroupFromJSON(json['UserGroup']),
        'users': !exists(json, 'Users') ? undefined : ((json['Users'] as Array<any>).map(UserFromJSON)),
    };
}

export function ReadUserGroupResponseToJSON(value?: ReadUserGroupResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
