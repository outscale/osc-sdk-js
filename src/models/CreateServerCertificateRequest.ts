...
export function CreateServerCertificateRequestFromJSON(json: any): CreateServerCertificateRequest {
    return CreateServerCertificateRequestFromJSONTyped(json, false);
}

export function CreateServerCertificateRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): CreateServerCertificateRequest {
...
export function CreateServerCertificateRequestToJSON(value?: CreateServerCertificateRequest | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
