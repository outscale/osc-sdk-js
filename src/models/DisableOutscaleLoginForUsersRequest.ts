...
export function DisableOutscaleLoginForUsersRequestFromJSON(json: any): DisableOutscaleLoginForUsersRequest {
    return DisableOutscaleLoginForUsersRequestFromJSONTyped(json, false);
}

export function DisableOutscaleLoginForUsersRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): DisableOutscaleLoginForUsersRequest {
...
export function DisableOutscaleLoginForUsersRequestToJSON(value?: DisableOutscaleLoginForUsersRequest | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
