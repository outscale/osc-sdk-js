...
import {
    FiltersUsers,
    FiltersUsersFromJSON,
    FiltersUsersFromJSONTyped,
    FiltersUsersToJSON,
} from './FiltersUsers';
 ...
 * 
 * @export
 * @interface ReadUsersRequest
 */
export interface ReadUsersRequest {
    /**
     * If true, checks whether you have the required permissions to perform the action.
     * @type {boolean}
     * @memberof ReadUsersRequest
     */
    dryRun?: boolean;
    /**
     * 
...
export function ReadUsersRequestFromJSON(json: any): ReadUsersRequest {
    return ReadUsersRequestFromJSONTyped(json, false);
}

export function ReadUsersRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): ReadUsersRequest {
    ...
    return {
        ...
        'filters': !exists(json, 'Filters') ? undefined : FiltersUsersFromJSON(json['Filters']),
...
export function ReadUsersRequestToJSON(value?: ReadUsersRequest | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'DryRun': value.dryRun,
        'Filters': FiltersUsersToJSON(value.filters),
