 ...
 * @export
 */
export const SecureBootAction = {
    Enable: 'enable',
    Disable: 'disable',
    SetupMode: 'setup-mode',
    None: 'none',
    RestoreFactoryKeys: 'restore-factory-keys'
} as const;
export type SecureBootAction = typeof SecureBootAction[keyof typeof SecureBootAction];


export function SecureBootActionFromJSON(json: any): SecureBootAction {
    return SecureBootActionFromJSONTyped(json, false);
}

export function SecureBootActionFromJSONTyped(json: any, ignoreDiscriminator: boolean): SecureBootAction {
    return json as SecureBootAction;
}

export function SecureBootActionToJSON(value?: SecureBootAction | null): any {
    return value as any;
}
