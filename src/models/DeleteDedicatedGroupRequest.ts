...
export function DeleteDedicatedGroupRequestFromJSON(json: any): DeleteDedicatedGroupRequest {
    return DeleteDedicatedGroupRequestFromJSONTyped(json, false);
}

export function DeleteDedicatedGroupRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): DeleteDedicatedGroupRequest {
...
export function DeleteDedicatedGroupRequestToJSON(value?: DeleteDedicatedGroupRequest | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
