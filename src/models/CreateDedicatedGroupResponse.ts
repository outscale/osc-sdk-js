...
export function CreateDedicatedGroupResponseFromJSON(json: any): CreateDedicatedGroupResponse {
    return CreateDedicatedGroupResponseFromJSONTyped(json, false);
}

export function CreateDedicatedGroupResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): CreateDedicatedGroupResponse {
...
export function CreateDedicatedGroupResponseToJSON(value?: CreateDedicatedGroupResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
