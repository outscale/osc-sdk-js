...
import {
    UnitPriceEntry,
    UnitPriceEntryFromJSON,
    UnitPriceEntryFromJSONTyped,
    UnitPriceEntryToJSON,
} from './UnitPriceEntry';

/**
 * 
 * @export
 * @interface ReadUnitPriceResponse
 */
export interface ReadUnitPriceResponse {
    /**
     * 
     * @type {ModelResponseContext}
     * @memberof ReadUnitPriceResponse
     */
     ...
     * @memberof ReadUnitPriceResponse
     */
    unitPriceEntry?: UnitPriceEntry;
}

export function ReadUnitPriceResponseFromJSON(json: any): ReadUnitPriceResponse {
    return ReadUnitPriceResponseFromJSONTyped(json, false);
}

export function ReadUnitPriceResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ReadUnitPriceResponse {
    ...
    return {
        ...
        'unitPriceEntry': !exists(json, 'UnitPriceEntry') ? undefined : UnitPriceEntryFromJSON(json['UnitPriceEntry']),
    };
}

export function ReadUnitPriceResponseToJSON(value?: ReadUnitPriceResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'UnitPriceEntry': UnitPriceEntryToJSON(value.unitPriceEntry),
    };
}
