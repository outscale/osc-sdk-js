...
export function FiltersApiLogToJSON(value?: FiltersApiLog | null): any {
    ...
    return {
        ...
        'QueryDateAfter': value.queryDateAfter === undefined ? undefined : (value.queryDateAfter.toISOString()),
        'QueryDateBefore': value.queryDateBefore === undefined ? undefined : (value.queryDateBefore.toISOString()),
