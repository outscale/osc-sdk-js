...
export function UpdateRouteTableLinkRequestFromJSON(json: any): UpdateRouteTableLinkRequest {
    return UpdateRouteTableLinkRequestFromJSONTyped(json, false);
}

export function UpdateRouteTableLinkRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): UpdateRouteTableLinkRequest {
...
export function UpdateRouteTableLinkRequestToJSON(value?: UpdateRouteTableLinkRequest | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
