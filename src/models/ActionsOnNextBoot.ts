...
import {
    SecureBootAction,
    SecureBootActionFromJSON,
    SecureBootActionFromJSONTyped,
    SecureBootActionToJSON,
} from './SecureBootAction';

/**
 * The action to perform on the next boot of the VM.
 * @export
 * @interface ActionsOnNextBoot
 */
export interface ActionsOnNextBoot {
    /**
     * 
     * @type {SecureBootAction}
     * @memberof ActionsOnNextBoot
     */
    secureBoot?: SecureBootAction;
}

export function ActionsOnNextBootFromJSON(json: any): ActionsOnNextBoot {
    return ActionsOnNextBootFromJSONTyped(json, false);
}

export function ActionsOnNextBootFromJSONTyped(json: any, ignoreDiscriminator: boolean): ActionsOnNextBoot {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'secureBoot': !exists(json, 'SecureBoot') ? undefined : SecureBootActionFromJSON(json['SecureBoot']),
    };
}

export function ActionsOnNextBootToJSON(value?: ActionsOnNextBoot | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'SecureBoot': SecureBootActionToJSON(value.secureBoot),
    };
}
