 ...
 * 
 * @export
 * @interface UnlinkPolicyResponse
 */
export interface UnlinkPolicyResponse {
    /**
     * 
     * @type {ModelResponseContext}
     * @memberof UnlinkPolicyResponse
     */
    responseContext?: ModelResponseContext;
}

export function UnlinkPolicyResponseFromJSON(json: any): UnlinkPolicyResponse {
    return UnlinkPolicyResponseFromJSONTyped(json, false);
}

export function UnlinkPolicyResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): UnlinkPolicyResponse {
...
export function UnlinkPolicyResponseToJSON(value?: UnlinkPolicyResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
