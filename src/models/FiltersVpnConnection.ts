...
export function FiltersVpnConnectionFromJSON(json: any): FiltersVpnConnection {
    return FiltersVpnConnectionFromJSONTyped(json, false);
}

export function FiltersVpnConnectionFromJSONTyped(json: any, ignoreDiscriminator: boolean): FiltersVpnConnection {
...
export function FiltersVpnConnectionToJSON(value?: FiltersVpnConnection | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
