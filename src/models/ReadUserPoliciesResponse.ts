...
export function ReadUserPoliciesResponseFromJSON(json: any): ReadUserPoliciesResponse {
    return ReadUserPoliciesResponseFromJSONTyped(json, false);
}

export function ReadUserPoliciesResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ReadUserPoliciesResponse {
...
export function ReadUserPoliciesResponseToJSON(value?: ReadUserPoliciesResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
