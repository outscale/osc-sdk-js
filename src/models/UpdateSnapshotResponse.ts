...
export function UpdateSnapshotResponseFromJSON(json: any): UpdateSnapshotResponse {
    return UpdateSnapshotResponseFromJSONTyped(json, false);
}

export function UpdateSnapshotResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): UpdateSnapshotResponse {
...
export function UpdateSnapshotResponseToJSON(value?: UpdateSnapshotResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
