...
export function UpdateLoadBalancerResponseFromJSON(json: any): UpdateLoadBalancerResponse {
    return UpdateLoadBalancerResponseFromJSONTyped(json, false);
}

export function UpdateLoadBalancerResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): UpdateLoadBalancerResponse {
...
export function UpdateLoadBalancerResponseToJSON(value?: UpdateLoadBalancerResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
