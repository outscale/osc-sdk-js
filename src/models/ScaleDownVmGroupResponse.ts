...
export function ScaleDownVmGroupResponseFromJSON(json: any): ScaleDownVmGroupResponse {
    return ScaleDownVmGroupResponseFromJSONTyped(json, false);
}

export function ScaleDownVmGroupResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ScaleDownVmGroupResponse {
...
export function ScaleDownVmGroupResponseToJSON(value?: ScaleDownVmGroupResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
