...
export function CreateVmGroupResponseFromJSON(json: any): CreateVmGroupResponse {
    return CreateVmGroupResponseFromJSONTyped(json, false);
}

export function CreateVmGroupResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): CreateVmGroupResponse {
...
export function CreateVmGroupResponseToJSON(value?: CreateVmGroupResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
