 ...
 * One or more filters.
 * @export
 * @interface FiltersSnapshotExportTask
 */
export interface FiltersSnapshotExportTask {
    /**
     * The IDs of the snapshots used with the snapshot export tasks
     * @type {Array<string>}
     * @memberof FiltersSnapshotExportTask
     */
...
export function FiltersSnapshotExportTaskFromJSON(json: any): FiltersSnapshotExportTask {
    return FiltersSnapshotExportTaskFromJSONTyped(json, false);
}

export function FiltersSnapshotExportTaskFromJSONTyped(json: any, ignoreDiscriminator: boolean): FiltersSnapshotExportTask {
...
export function FiltersSnapshotExportTaskToJSON(value?: FiltersSnapshotExportTask | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
