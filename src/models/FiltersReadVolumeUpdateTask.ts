 ...
 * One or more filters.
 * @export
 * @interface FiltersReadVolumeUpdateTask
 */
export interface FiltersReadVolumeUpdateTask {
    /**
     * The IDs of the snapshot export tasks.
     * @type {Array<string>}
     * @memberof FiltersReadVolumeUpdateTask
     */
...
export function FiltersReadVolumeUpdateTaskFromJSON(json: any): FiltersReadVolumeUpdateTask {
    return FiltersReadVolumeUpdateTaskFromJSONTyped(json, false);
}

export function FiltersReadVolumeUpdateTaskFromJSONTyped(json: any, ignoreDiscriminator: boolean): FiltersReadVolumeUpdateTask {
...
export function FiltersReadVolumeUpdateTaskToJSON(value?: FiltersReadVolumeUpdateTask | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
