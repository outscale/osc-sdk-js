...
export function CreatePolicyResponseFromJSON(json: any): CreatePolicyResponse {
    return CreatePolicyResponseFromJSONTyped(json, false);
}

export function CreatePolicyResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): CreatePolicyResponse {
...
export function CreatePolicyResponseToJSON(value?: CreatePolicyResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
