 ...
 * 
 * @export
 * @interface DisableOutscaleLoginForUsersResponse
 */
export interface DisableOutscaleLoginForUsersResponse {
    /**
     * 
     * @type {ModelResponseContext}
     * @memberof DisableOutscaleLoginForUsersResponse
     */
    responseContext?: ModelResponseContext;
}

export function DisableOutscaleLoginForUsersResponseFromJSON(json: any): DisableOutscaleLoginForUsersResponse {
    return DisableOutscaleLoginForUsersResponseFromJSONTyped(json, false);
}

export function DisableOutscaleLoginForUsersResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): DisableOutscaleLoginForUsersResponse {
...
export function DisableOutscaleLoginForUsersResponseToJSON(value?: DisableOutscaleLoginForUsersResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
