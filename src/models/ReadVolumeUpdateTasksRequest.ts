...
import {
    ...
    FiltersReadVolumeUpdateTaskFromJSON,
    FiltersReadVolumeUpdateTaskFromJSONTyped,
    FiltersReadVolumeUpdateTaskToJSON,
} from './FiltersReadVolumeUpdateTask';

/**
 * 
 * @export
 * @interface ReadVolumeUpdateTasksRequest
 */
export interface ReadVolumeUpdateTasksRequest {
    /**
     * If true, checks whether you have the required permissions to perform the action.
     * @type {boolean}
     * @memberof ReadVolumeUpdateTasksRequest
     */
    dryRun?: boolean;
    /**
     * 
     * @type {FiltersReadVolumeUpdateTask}
     * @memberof ReadVolumeUpdateTasksRequest
     */
    filters?: FiltersReadVolumeUpdateTask;
    /**
...
export function ReadVolumeUpdateTasksRequestFromJSON(json: any): ReadVolumeUpdateTasksRequest {
    return ReadVolumeUpdateTasksRequestFromJSONTyped(json, false);
}

export function ReadVolumeUpdateTasksRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): ReadVolumeUpdateTasksRequest {
    ...
    return {
        ...
        'filters': !exists(json, 'Filters') ? undefined : FiltersReadVolumeUpdateTaskFromJSON(json['Filters']),
...
export function ReadVolumeUpdateTasksRequestToJSON(value?: ReadVolumeUpdateTasksRequest | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'DryRun': value.dryRun,
        'Filters': FiltersReadVolumeUpdateTaskToJSON(value.filters),
