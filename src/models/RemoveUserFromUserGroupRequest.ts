 ...
 * 
 * @export
 * @interface RemoveUserFromUserGroupRequest
 */
export interface RemoveUserFromUserGroupRequest {
    /**
     * If true, checks whether you have the required permissions to perform the action.
     * @type {boolean}
     * @memberof RemoveUserFromUserGroupRequest
     */
    dryRun?: boolean;
    /**
...
export function RemoveUserFromUserGroupRequestFromJSON(json: any): RemoveUserFromUserGroupRequest {
    return RemoveUserFromUserGroupRequestFromJSONTyped(json, false);
}

export function RemoveUserFromUserGroupRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): RemoveUserFromUserGroupRequest {
...
export function RemoveUserFromUserGroupRequestToJSON(value?: RemoveUserFromUserGroupRequest | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
