 ...
 * 
 * @export
 * @interface EnableOutscaleLoginPerUsersResponse
 */
export interface EnableOutscaleLoginPerUsersResponse {
    /**
     * 
     * @type {ModelResponseContext}
     * @memberof EnableOutscaleLoginPerUsersResponse
     */
    responseContext?: ModelResponseContext;
}

export function EnableOutscaleLoginPerUsersResponseFromJSON(json: any): EnableOutscaleLoginPerUsersResponse {
    return EnableOutscaleLoginPerUsersResponseFromJSONTyped(json, false);
}

export function EnableOutscaleLoginPerUsersResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): EnableOutscaleLoginPerUsersResponse {
...
export function EnableOutscaleLoginPerUsersResponseToJSON(value?: EnableOutscaleLoginPerUsersResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
