...
export function DeletePolicyVersionRequestFromJSON(json: any): DeletePolicyVersionRequest {
    return DeletePolicyVersionRequestFromJSONTyped(json, false);
}

export function DeletePolicyVersionRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): DeletePolicyVersionRequest {
...
export function DeletePolicyVersionRequestToJSON(value?: DeletePolicyVersionRequest | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
