...
import {
    ...
    FiltersSnapshotExportTaskFromJSON,
    FiltersSnapshotExportTaskFromJSONTyped,
    FiltersSnapshotExportTaskToJSON,
} from './FiltersSnapshotExportTask';

/**
 * 
 * @export
 * @interface ReadSnapshotExportTasksRequest
 */
export interface ReadSnapshotExportTasksRequest {
    /**
     * If true, checks whether you have the required permissions to perform the action.
     * @type {boolean}
     * @memberof ReadSnapshotExportTasksRequest
     */
    dryRun?: boolean;
    /**
     * 
     * @type {FiltersSnapshotExportTask}
     * @memberof ReadSnapshotExportTasksRequest
     */
    filters?: FiltersSnapshotExportTask;
    /**
...
export function ReadSnapshotExportTasksRequestFromJSON(json: any): ReadSnapshotExportTasksRequest {
    return ReadSnapshotExportTasksRequestFromJSONTyped(json, false);
}

export function ReadSnapshotExportTasksRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): ReadSnapshotExportTasksRequest {
    ...
    return {
        ...
        'filters': !exists(json, 'Filters') ? undefined : FiltersSnapshotExportTaskFromJSON(json['Filters']),
...
export function ReadSnapshotExportTasksRequestToJSON(value?: ReadSnapshotExportTasksRequest | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'DryRun': value.dryRun,
        'Filters': FiltersSnapshotExportTaskToJSON(value.filters),
