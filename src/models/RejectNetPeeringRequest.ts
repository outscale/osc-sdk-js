...
export function RejectNetPeeringRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): RejectNetPeeringRequest {
...
export function RejectNetPeeringRequestToJSON(value?: RejectNetPeeringRequest | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
