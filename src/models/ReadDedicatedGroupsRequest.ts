...
import {
    ...
    FiltersDedicatedGroupFromJSON,
    FiltersDedicatedGroupFromJSONTyped,
    FiltersDedicatedGroupToJSON,
} from './FiltersDedicatedGroup';
...
export function ReadDedicatedGroupsRequestFromJSON(json: any): ReadDedicatedGroupsRequest {
    return ReadDedicatedGroupsRequestFromJSONTyped(json, false);
}

export function ReadDedicatedGroupsRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): ReadDedicatedGroupsRequest {
    ...
    return {
        ...
        'filters': !exists(json, 'Filters') ? undefined : FiltersDedicatedGroupFromJSON(json['Filters']),
...
export function ReadDedicatedGroupsRequestToJSON(value?: ReadDedicatedGroupsRequest | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'DryRun': value.dryRun,
        'Filters': FiltersDedicatedGroupToJSON(value.filters),
