...
export function EnableOutscaleLoginForUsersResponseFromJSON(json: any): EnableOutscaleLoginForUsersResponse {
    return EnableOutscaleLoginForUsersResponseFromJSONTyped(json, false);
}

export function EnableOutscaleLoginForUsersResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): EnableOutscaleLoginForUsersResponse {
...
export function EnableOutscaleLoginForUsersResponseToJSON(value?: EnableOutscaleLoginForUsersResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
