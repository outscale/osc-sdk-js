 ...
 * 
 * @export
 * @interface UpdateVmTemplateResponse
 */
export interface UpdateVmTemplateResponse {
    /**
     * 
     * @type {ModelResponseContext}
     * @memberof UpdateVmTemplateResponse
     */
...
export function UpdateVmTemplateResponseFromJSON(json: any): UpdateVmTemplateResponse {
    return UpdateVmTemplateResponseFromJSONTyped(json, false);
}

export function UpdateVmTemplateResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): UpdateVmTemplateResponse {
...
export function UpdateVmTemplateResponseToJSON(value?: UpdateVmTemplateResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
