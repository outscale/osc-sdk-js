...
export function RemoveUserFromUserGroupResponseFromJSON(json: any): RemoveUserFromUserGroupResponse {
    return RemoveUserFromUserGroupResponseFromJSONTyped(json, false);
}

export function RemoveUserFromUserGroupResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): RemoveUserFromUserGroupResponse {
...
export function RemoveUserFromUserGroupResponseToJSON(value?: RemoveUserFromUserGroupResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
