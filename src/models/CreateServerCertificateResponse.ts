...
export function CreateServerCertificateResponseFromJSON(json: any): CreateServerCertificateResponse {
    return CreateServerCertificateResponseFromJSONTyped(json, false);
}

export function CreateServerCertificateResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): CreateServerCertificateResponse {
...
export function CreateServerCertificateResponseToJSON(value?: CreateServerCertificateResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
