 ...
 * 
 * @export
 * @interface PutUserGroupPolicyResponse
 */
export interface PutUserGroupPolicyResponse {
    /**
     * 
     * @type {ModelResponseContext}
     * @memberof PutUserGroupPolicyResponse
     */
    responseContext?: ModelResponseContext;
}

export function PutUserGroupPolicyResponseFromJSON(json: any): PutUserGroupPolicyResponse {
    return PutUserGroupPolicyResponseFromJSONTyped(json, false);
}

export function PutUserGroupPolicyResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): PutUserGroupPolicyResponse {
...
export function PutUserGroupPolicyResponseToJSON(value?: PutUserGroupPolicyResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
