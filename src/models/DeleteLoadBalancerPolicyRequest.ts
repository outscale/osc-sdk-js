...
export function DeleteLoadBalancerPolicyRequestFromJSON(json: any): DeleteLoadBalancerPolicyRequest {
    return DeleteLoadBalancerPolicyRequestFromJSONTyped(json, false);
}

export function DeleteLoadBalancerPolicyRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): DeleteLoadBalancerPolicyRequest {
...
export function DeleteLoadBalancerPolicyRequestToJSON(value?: DeleteLoadBalancerPolicyRequest | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
