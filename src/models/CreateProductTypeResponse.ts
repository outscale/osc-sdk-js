...
export function CreateProductTypeResponseFromJSON(json: any): CreateProductTypeResponse {
    return CreateProductTypeResponseFromJSONTyped(json, false);
}

export function CreateProductTypeResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): CreateProductTypeResponse {
...
export function CreateProductTypeResponseToJSON(value?: CreateProductTypeResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
