...
export function UpdateImageResponseFromJSON(json: any): UpdateImageResponse {
    return UpdateImageResponseFromJSONTyped(json, false);
}

export function UpdateImageResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): UpdateImageResponse {
...
export function UpdateImageResponseToJSON(value?: UpdateImageResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
