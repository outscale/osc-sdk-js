 ...
 * @export
 * @interface CO2CategoryDistribution
 */
export interface CO2CategoryDistribution {
    /**
     * The category of the resource (for example, `storage`).
     * @type {string}
     * @memberof CO2CategoryDistribution
     */
    category?: string;
    /**
...
export function CO2CategoryDistributionFromJSON(json: any): CO2CategoryDistribution {
    return CO2CategoryDistributionFromJSONTyped(json, false);
}

export function CO2CategoryDistributionFromJSONTyped(json: any, ignoreDiscriminator: boolean): CO2CategoryDistribution {
...
export function CO2CategoryDistributionToJSON(value?: CO2CategoryDistribution | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
