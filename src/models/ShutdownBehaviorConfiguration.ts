 ...
 * @export
 * @interface ShutdownBehaviorConfiguration
 */
export interface ShutdownBehaviorConfiguration {
    /**
     * The action performed by the orchestrator when the VM is shut down from the guest operating system. By default, `stop`.
     * @type {string}
     * @memberof ShutdownBehaviorConfiguration
     */
    guestAction?: ShutdownBehaviorConfigurationGuestActionEnum;
    /**
     ...
     * @memberof ShutdownBehaviorConfiguration
     */
    hostAction?: ShutdownBehaviorConfigurationHostActionEnum;
}
 ...
 * @export
 */
export const ShutdownBehaviorConfigurationGuestActionEnum = {
    Stop: 'stop',
    Terminate: 'terminate'
} as const;
export type ShutdownBehaviorConfigurationGuestActionEnum = typeof ShutdownBehaviorConfigurationGuestActionEnum[keyof typeof ShutdownBehaviorConfigurationGuestActionEnum];

/**
 * @export
 */
export const ShutdownBehaviorConfigurationHostActionEnum = {
    Restart: 'restart',
    Stop: 'stop'
} as const;
export type ShutdownBehaviorConfigurationHostActionEnum = typeof ShutdownBehaviorConfigurationHostActionEnum[keyof typeof ShutdownBehaviorConfigurationHostActionEnum];


export function ShutdownBehaviorConfigurationFromJSON(json: any): ShutdownBehaviorConfiguration {
    return ShutdownBehaviorConfigurationFromJSONTyped(json, false);
}

export function ShutdownBehaviorConfigurationFromJSONTyped(json: any, ignoreDiscriminator: boolean): ShutdownBehaviorConfiguration {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'guestAction': !exists(json, 'GuestAction') ? undefined : json['GuestAction'],
        'hostAction': !exists(json, 'HostAction') ? undefined : json['HostAction'],
    };
}

export function ShutdownBehaviorConfigurationToJSON(value?: ShutdownBehaviorConfiguration | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
