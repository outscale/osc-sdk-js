 ...
 * 
 * @export
 * @interface AddUserToUserGroupResponse
 */
export interface AddUserToUserGroupResponse {
    /**
     * 
     * @type {ModelResponseContext}
     * @memberof AddUserToUserGroupResponse
     */
    responseContext?: ModelResponseContext;
}

export function AddUserToUserGroupResponseFromJSON(json: any): AddUserToUserGroupResponse {
    return AddUserToUserGroupResponseFromJSONTyped(json, false);
}

export function AddUserToUserGroupResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): AddUserToUserGroupResponse {
...
export function AddUserToUserGroupResponseToJSON(value?: AddUserToUserGroupResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
