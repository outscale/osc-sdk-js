...
export function DeletePolicyRequestFromJSON(json: any): DeletePolicyRequest {
    return DeletePolicyRequestFromJSONTyped(json, false);
}

export function DeletePolicyRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): DeletePolicyRequest {
...
export function DeletePolicyRequestToJSON(value?: DeletePolicyRequest | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
