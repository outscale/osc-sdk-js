...
export function ReadPolicyResponseFromJSON(json: any): ReadPolicyResponse {
    return ReadPolicyResponseFromJSONTyped(json, false);
}

export function ReadPolicyResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ReadPolicyResponse {
...
export function ReadPolicyResponseToJSON(value?: ReadPolicyResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
