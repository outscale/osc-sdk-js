...
export function FiltersUserGroupFromJSON(json: any): FiltersUserGroup {
    return FiltersUserGroupFromJSONTyped(json, false);
}

export function FiltersUserGroupFromJSONTyped(json: any, ignoreDiscriminator: boolean): FiltersUserGroup {
...
export function FiltersUserGroupToJSON(value?: FiltersUserGroup | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
