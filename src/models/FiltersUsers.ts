...
export function FiltersUsersFromJSON(json: any): FiltersUsers {
    return FiltersUsersFromJSONTyped(json, false);
}

export function FiltersUsersFromJSONTyped(json: any, ignoreDiscriminator: boolean): FiltersUsers {
...
export function FiltersUsersToJSON(value?: FiltersUsers | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
