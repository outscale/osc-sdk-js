 ...
 * One or more filters.
 * @export
 * @interface FiltersUpdateVolumeTask
 */
export interface FiltersUpdateVolumeTask {
    /**
     * The IDs of the volume update tasks.
     * @type {Array<string>}
     * @memberof FiltersUpdateVolumeTask
     */
    taskIds?: Array<string>;
}

export function FiltersUpdateVolumeTaskFromJSON(json: any): FiltersUpdateVolumeTask {
    return FiltersUpdateVolumeTaskFromJSONTyped(json, false);
}

export function FiltersUpdateVolumeTaskFromJSONTyped(json: any, ignoreDiscriminator: boolean): FiltersUpdateVolumeTask {
...
export function FiltersUpdateVolumeTaskToJSON(value?: FiltersUpdateVolumeTask | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
