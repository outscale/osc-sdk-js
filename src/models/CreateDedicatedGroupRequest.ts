...
export function CreateDedicatedGroupRequestFromJSON(json: any): CreateDedicatedGroupRequest {
    return CreateDedicatedGroupRequestFromJSONTyped(json, false);
}

export function CreateDedicatedGroupRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): CreateDedicatedGroupRequest {
...
export function CreateDedicatedGroupRequestToJSON(value?: CreateDedicatedGroupRequest | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
