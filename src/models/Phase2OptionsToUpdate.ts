...
export function Phase2OptionsToUpdateFromJSON(json: any): Phase2OptionsToUpdate {
    return Phase2OptionsToUpdateFromJSONTyped(json, false);
}

export function Phase2OptionsToUpdateFromJSONTyped(json: any, ignoreDiscriminator: boolean): Phase2OptionsToUpdate {
...
export function Phase2OptionsToUpdateToJSON(value?: Phase2OptionsToUpdate | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
