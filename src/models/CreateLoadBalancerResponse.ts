...
export function CreateLoadBalancerResponseFromJSON(json: any): CreateLoadBalancerResponse {
    return CreateLoadBalancerResponseFromJSONTyped(json, false);
}

export function CreateLoadBalancerResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): CreateLoadBalancerResponse {
...
export function CreateLoadBalancerResponseToJSON(value?: CreateLoadBalancerResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
