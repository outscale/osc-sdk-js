 ...
 * 
 * @export
 * @interface UpdateVmGroupResponse
 */
export interface UpdateVmGroupResponse {
    /**
     * 
     * @type {ModelResponseContext}
     * @memberof UpdateVmGroupResponse
     */
...
export function UpdateVmGroupResponseFromJSON(json: any): UpdateVmGroupResponse {
    return UpdateVmGroupResponseFromJSONTyped(json, false);
}

export function UpdateVmGroupResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): UpdateVmGroupResponse {
    ...
    return {
        ...
        'vmGroup': !exists(json, 'VmGroup') ? undefined : VmGroupFromJSON(json['VmGroup']),
    };
}

export function UpdateVmGroupResponseToJSON(value?: UpdateVmGroupResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'VmGroup': VmGroupToJSON(value.vmGroup),
    };
}
