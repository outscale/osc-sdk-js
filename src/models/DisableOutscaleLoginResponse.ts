 ...
 * 
 * @export
 * @interface DisableOutscaleLoginResponse
 */
export interface DisableOutscaleLoginResponse {
    /**
     * 
     * @type {ModelResponseContext}
     * @memberof DisableOutscaleLoginResponse
     */
    responseContext?: ModelResponseContext;
}

export function DisableOutscaleLoginResponseFromJSON(json: any): DisableOutscaleLoginResponse {
    return DisableOutscaleLoginResponseFromJSONTyped(json, false);
}

export function DisableOutscaleLoginResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): DisableOutscaleLoginResponse {
...
export function DisableOutscaleLoginResponseToJSON(value?: DisableOutscaleLoginResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
