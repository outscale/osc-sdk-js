...
export function CreateSecurityGroupResponseFromJSON(json: any): CreateSecurityGroupResponse {
    return CreateSecurityGroupResponseFromJSONTyped(json, false);
}

export function CreateSecurityGroupResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): CreateSecurityGroupResponse {
...
export function CreateSecurityGroupResponseToJSON(value?: CreateSecurityGroupResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
