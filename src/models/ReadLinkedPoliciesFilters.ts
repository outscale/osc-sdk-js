...
export function ReadLinkedPoliciesFiltersFromJSON(json: any): ReadLinkedPoliciesFilters {
    return ReadLinkedPoliciesFiltersFromJSONTyped(json, false);
}

export function ReadLinkedPoliciesFiltersFromJSONTyped(json: any, ignoreDiscriminator: boolean): ReadLinkedPoliciesFilters {
...
export function ReadLinkedPoliciesFiltersToJSON(value?: ReadLinkedPoliciesFilters | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
