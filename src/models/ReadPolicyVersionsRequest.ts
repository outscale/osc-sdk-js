 ...
 * 
 * @export
 * @interface ReadPolicyVersionsRequest
 */
export interface ReadPolicyVersionsRequest {
    /**
     * The item starting the list of policies requested.
     * @type {number}
     * @memberof ReadPolicyVersionsRequest
     */
    firstItem?: number;
    /**
...
export function ReadPolicyVersionsRequestFromJSON(json: any): ReadPolicyVersionsRequest {
    return ReadPolicyVersionsRequestFromJSONTyped(json, false);
}

export function ReadPolicyVersionsRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): ReadPolicyVersionsRequest {
...
export function ReadPolicyVersionsRequestToJSON(value?: ReadPolicyVersionsRequest | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
