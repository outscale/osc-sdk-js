...
export function BootModeFromJSON(json: any): BootMode {
    return BootModeFromJSONTyped(json, false);
}

export function BootModeFromJSONTyped(json: any, ignoreDiscriminator: boolean): BootMode {
    return json as BootMode;
}

export function BootModeToJSON(value?: BootMode | null): any {
    return value as any;
}
