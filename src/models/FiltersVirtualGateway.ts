...
export function FiltersVirtualGatewayFromJSON(json: any): FiltersVirtualGateway {
    return FiltersVirtualGatewayFromJSONTyped(json, false);
}

export function FiltersVirtualGatewayFromJSONTyped(json: any, ignoreDiscriminator: boolean): FiltersVirtualGateway {
...
export function FiltersVirtualGatewayToJSON(value?: FiltersVirtualGateway | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
