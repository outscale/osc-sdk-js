 ...
 * 
 * @export
 * @interface DisableOutscaleLoginRequest
 */
export interface DisableOutscaleLoginRequest {
    /**
     * If true, checks whether you have the required permissions to perform the action.
     * @type {boolean}
     * @memberof DisableOutscaleLoginRequest
     */
    dryRun?: boolean;
}

export function DisableOutscaleLoginRequestFromJSON(json: any): DisableOutscaleLoginRequest {
    return DisableOutscaleLoginRequestFromJSONTyped(json, false);
}

export function DisableOutscaleLoginRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): DisableOutscaleLoginRequest {
...
export function DisableOutscaleLoginRequestToJSON(value?: DisableOutscaleLoginRequest | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
