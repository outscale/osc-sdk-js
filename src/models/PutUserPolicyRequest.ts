...
export function PutUserPolicyRequestFromJSON(json: any): PutUserPolicyRequest {
    return PutUserPolicyRequestFromJSONTyped(json, false);
}

export function PutUserPolicyRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): PutUserPolicyRequest {
...
export function PutUserPolicyRequestToJSON(value?: PutUserPolicyRequest | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
