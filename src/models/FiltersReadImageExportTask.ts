 ...
 * One or more filters.
 * @export
 * @interface FiltersReadImageExportTask
 */
export interface FiltersReadImageExportTask {
    /**
     * The IDs of the OMIs used for the snapshot export tasks.
     * @type {Array<string>}
     * @memberof FiltersReadImageExportTask
     */
...
export function FiltersReadImageExportTaskFromJSON(json: any): FiltersReadImageExportTask {
    return FiltersReadImageExportTaskFromJSONTyped(json, false);
}

export function FiltersReadImageExportTaskFromJSONTyped(json: any, ignoreDiscriminator: boolean): FiltersReadImageExportTask {
...
export function FiltersReadImageExportTaskToJSON(value?: FiltersReadImageExportTask | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
