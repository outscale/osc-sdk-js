 ...
 * 
 * @export
 * @interface ScaleUpVmGroupResponse
 */
export interface ScaleUpVmGroupResponse {
    /**
     * 
     * @type {ModelResponseContext}
     * @memberof ScaleUpVmGroupResponse
     */
    responseContext?: ModelResponseContext;
}

export function ScaleUpVmGroupResponseFromJSON(json: any): ScaleUpVmGroupResponse {
    return ScaleUpVmGroupResponseFromJSONTyped(json, false);
}

export function ScaleUpVmGroupResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ScaleUpVmGroupResponse {
...
export function ScaleUpVmGroupResponseToJSON(value?: ScaleUpVmGroupResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
