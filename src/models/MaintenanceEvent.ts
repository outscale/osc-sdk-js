...
export function MaintenanceEventFromJSON(json: any): MaintenanceEvent {
    return MaintenanceEventFromJSONTyped(json, false);
}

export function MaintenanceEventFromJSONTyped(json: any, ignoreDiscriminator: boolean): MaintenanceEvent {
...
export function MaintenanceEventToJSON(value?: MaintenanceEvent | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
