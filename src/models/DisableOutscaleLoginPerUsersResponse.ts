 ...
 * 
 * @export
 * @interface DisableOutscaleLoginPerUsersResponse
 */
export interface DisableOutscaleLoginPerUsersResponse {
    /**
     * 
     * @type {ModelResponseContext}
     * @memberof DisableOutscaleLoginPerUsersResponse
     */
    responseContext?: ModelResponseContext;
}

export function DisableOutscaleLoginPerUsersResponseFromJSON(json: any): DisableOutscaleLoginPerUsersResponse {
    return DisableOutscaleLoginPerUsersResponseFromJSONTyped(json, false);
}

export function DisableOutscaleLoginPerUsersResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): DisableOutscaleLoginPerUsersResponse {
...
export function DisableOutscaleLoginPerUsersResponseToJSON(value?: DisableOutscaleLoginPerUsersResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
