...
export function LinkPolicyRequestFromJSON(json: any): LinkPolicyRequest {
    return LinkPolicyRequestFromJSONTyped(json, false);
}

export function LinkPolicyRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): LinkPolicyRequest {
...
export function LinkPolicyRequestToJSON(value?: LinkPolicyRequest | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
