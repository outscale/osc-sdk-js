...
export function CreateSecurityGroupRequestFromJSON(json: any): CreateSecurityGroupRequest {
    return CreateSecurityGroupRequestFromJSONTyped(json, false);
}

export function CreateSecurityGroupRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): CreateSecurityGroupRequest {
...
export function CreateSecurityGroupRequestToJSON(value?: CreateSecurityGroupRequest | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
