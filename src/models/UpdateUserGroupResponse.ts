...
export interface UpdateUserGroupResponse {
     ...
     * @memberof UpdateUserGroupResponse
     */
...
export function UpdateUserGroupResponseFromJSON(json: any): UpdateUserGroupResponse {
    return UpdateUserGroupResponseFromJSONTyped(json, false);
}

export function UpdateUserGroupResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): UpdateUserGroupResponse {
...
export function UpdateUserGroupResponseToJSON(value?: UpdateUserGroupResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
