...
export function LinkedPolicyFromJSON(json: any): LinkedPolicy {
    return LinkedPolicyFromJSONTyped(json, false);
}

export function LinkedPolicyFromJSONTyped(json: any, ignoreDiscriminator: boolean): LinkedPolicy {
...
export function LinkedPolicyToJSON(value?: LinkedPolicy | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
