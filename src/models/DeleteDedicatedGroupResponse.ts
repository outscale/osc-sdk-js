...
export function DeleteDedicatedGroupResponseFromJSON(json: any): DeleteDedicatedGroupResponse {
    return DeleteDedicatedGroupResponseFromJSONTyped(json, false);
}

export function DeleteDedicatedGroupResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): DeleteDedicatedGroupResponse {
...
export function DeleteDedicatedGroupResponseToJSON(value?: DeleteDedicatedGroupResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
