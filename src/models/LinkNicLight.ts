...
export function LinkNicLightFromJSON(json: any): LinkNicLight {
    return LinkNicLightFromJSONTyped(json, false);
}

export function LinkNicLightFromJSONTyped(json: any, ignoreDiscriminator: boolean): LinkNicLight {
...
export function LinkNicLightToJSON(value?: LinkNicLight | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
