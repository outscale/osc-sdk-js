...
export function MinimalPolicyFromJSON(json: any): MinimalPolicy {
    return MinimalPolicyFromJSONTyped(json, false);
}

export function MinimalPolicyFromJSONTyped(json: any, ignoreDiscriminator: boolean): MinimalPolicy {
...
export function MinimalPolicyToJSON(value?: MinimalPolicy | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
