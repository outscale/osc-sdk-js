...
export function VolumeUpdateParametersFromJSON(json: any): VolumeUpdateParameters {
    return VolumeUpdateParametersFromJSONTyped(json, false);
}

export function VolumeUpdateParametersFromJSONTyped(json: any, ignoreDiscriminator: boolean): VolumeUpdateParameters {
    ...
    return {
        ...
        'iops': json['Iops'],
        'size': json['Size'],
        'volumeType': json['VolumeType'],
    };
}

export function VolumeUpdateParametersToJSON(value?: VolumeUpdateParameters | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
