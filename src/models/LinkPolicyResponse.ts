...
export function LinkPolicyResponseFromJSON(json: any): LinkPolicyResponse {
    return LinkPolicyResponseFromJSONTyped(json, false);
}

export function LinkPolicyResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): LinkPolicyResponse {
...
export function LinkPolicyResponseToJSON(value?: LinkPolicyResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
