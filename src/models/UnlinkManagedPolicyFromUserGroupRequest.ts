...
export function UnlinkManagedPolicyFromUserGroupRequestFromJSON(json: any): UnlinkManagedPolicyFromUserGroupRequest {
    return UnlinkManagedPolicyFromUserGroupRequestFromJSONTyped(json, false);
}

export function UnlinkManagedPolicyFromUserGroupRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): UnlinkManagedPolicyFromUserGroupRequest {
...
export function UnlinkManagedPolicyFromUserGroupRequestToJSON(value?: UnlinkManagedPolicyFromUserGroupRequest | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
