 ...
 * 
 * @export
 * @interface EnableOutscaleLoginForUsersRequest
 */
export interface EnableOutscaleLoginForUsersRequest {
    /**
     * If true, checks whether you have the required permissions to perform the action.
     * @type {boolean}
     * @memberof EnableOutscaleLoginForUsersRequest
     */
    dryRun?: boolean;
}

export function EnableOutscaleLoginForUsersRequestFromJSON(json: any): EnableOutscaleLoginForUsersRequest {
    return EnableOutscaleLoginForUsersRequestFromJSONTyped(json, false);
}

export function EnableOutscaleLoginForUsersRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): EnableOutscaleLoginForUsersRequest {
...
export function EnableOutscaleLoginForUsersRequestToJSON(value?: EnableOutscaleLoginForUsersRequest | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
