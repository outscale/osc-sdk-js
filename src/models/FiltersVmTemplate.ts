...
export function FiltersVmTemplateFromJSON(json: any): FiltersVmTemplate {
    return FiltersVmTemplateFromJSONTyped(json, false);
}

export function FiltersVmTemplateFromJSONTyped(json: any, ignoreDiscriminator: boolean): FiltersVmTemplate {
...
export function FiltersVmTemplateToJSON(value?: FiltersVmTemplate | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
