...
export function ReadUserGroupsPerUserRequestFromJSON(json: any): ReadUserGroupsPerUserRequest {
    return ReadUserGroupsPerUserRequestFromJSONTyped(json, false);
}

export function ReadUserGroupsPerUserRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): ReadUserGroupsPerUserRequest {
...
export function ReadUserGroupsPerUserRequestToJSON(value?: ReadUserGroupsPerUserRequest | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
