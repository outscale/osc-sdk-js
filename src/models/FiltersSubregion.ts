...
export function FiltersSubregionFromJSON(json: any): FiltersSubregion {
    return FiltersSubregionFromJSONTyped(json, false);
}

export function FiltersSubregionFromJSONTyped(json: any, ignoreDiscriminator: boolean): FiltersSubregion {
...
export function FiltersSubregionToJSON(value?: FiltersSubregion | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
