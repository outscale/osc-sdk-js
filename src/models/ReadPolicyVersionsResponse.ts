 ...
 * 
 * @export
 * @interface ReadPolicyVersionsResponse
 */
export interface ReadPolicyVersionsResponse {
    /**
     * If true, there are more items to return using the `FirstItem` parameter in a new request.
     * @type {boolean}
     * @memberof ReadPolicyVersionsResponse
     */
...
export function ReadPolicyVersionsResponseFromJSON(json: any): ReadPolicyVersionsResponse {
    return ReadPolicyVersionsResponseFromJSONTyped(json, false);
}

export function ReadPolicyVersionsResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ReadPolicyVersionsResponse {
    ...
    return {
        ...
        'policyVersions': !exists(json, 'PolicyVersions') ? undefined : ((json['PolicyVersions'] as Array<any>).map(PolicyVersionFromJSON)),
        'responseContext': !exists(json, 'ResponseContext') ? undefined : ModelResponseContextFromJSON(json['ResponseContext']),
    };
}

export function ReadPolicyVersionsResponseToJSON(value?: ReadPolicyVersionsResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'PolicyVersions': value.policyVersions === undefined ? undefined : ((value.policyVersions as Array<any>).map(PolicyVersionToJSON)),
