 ...
 * @export
 * @interface CO2FactorDistribution
 */
export interface CO2FactorDistribution {
    /**
     * The emission source (for example, `hardware`).
     * @type {string}
     * @memberof CO2FactorDistribution
     */
    factor?: string;
    /**
...
export function CO2FactorDistributionFromJSON(json: any): CO2FactorDistribution {
    return CO2FactorDistributionFromJSONTyped(json, false);
}

export function CO2FactorDistributionFromJSONTyped(json: any, ignoreDiscriminator: boolean): CO2FactorDistribution {
...
export function CO2FactorDistributionToJSON(value?: CO2FactorDistribution | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
