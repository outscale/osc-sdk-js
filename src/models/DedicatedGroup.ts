...
export function DedicatedGroupFromJSON(json: any): DedicatedGroup {
    return DedicatedGroupFromJSONTyped(json, false);
}

export function DedicatedGroupFromJSONTyped(json: any, ignoreDiscriminator: boolean): DedicatedGroup {
    ...
    return {
        ...
        'cpuGeneration': !exists(json, 'CpuGeneration') ? undefined : json['CpuGeneration'],
        'dedicatedGroupId': !exists(json, 'DedicatedGroupId') ? undefined : json['DedicatedGroupId'],
...
export function DedicatedGroupToJSON(value?: DedicatedGroup | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
