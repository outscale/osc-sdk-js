...
export function CreateRouteTableResponseFromJSON(json: any): CreateRouteTableResponse {
    return CreateRouteTableResponseFromJSONTyped(json, false);
}

export function CreateRouteTableResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): CreateRouteTableResponse {
...
export function CreateRouteTableResponseToJSON(value?: CreateRouteTableResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
