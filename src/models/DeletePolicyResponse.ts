...
export function DeletePolicyResponseFromJSON(json: any): DeletePolicyResponse {
    return DeletePolicyResponseFromJSONTyped(json, false);
}

export function DeletePolicyResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): DeletePolicyResponse {
...
export function DeletePolicyResponseToJSON(value?: DeletePolicyResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
