...
export function EnableOutscaleLoginRequestFromJSON(json: any): EnableOutscaleLoginRequest {
    return EnableOutscaleLoginRequestFromJSONTyped(json, false);
}

export function EnableOutscaleLoginRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): EnableOutscaleLoginRequest {
...
export function EnableOutscaleLoginRequestToJSON(value?: EnableOutscaleLoginRequest | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
