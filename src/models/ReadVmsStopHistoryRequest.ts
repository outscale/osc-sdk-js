...
import {
    ...
    FiltersVmsStopHistoryFromJSON,
    FiltersVmsStopHistoryFromJSONTyped,
    FiltersVmsStopHistoryToJSON,
} from './FiltersVmsStopHistory';

/**
 * 
 * @export
 * @interface ReadVmsStopHistoryRequest
 */
export interface ReadVmsStopHistoryRequest {
    /**
     * 
     * @type {FiltersVmsStopHistory}
     * @memberof ReadVmsStopHistoryRequest
     */
    filters?: FiltersVmsStopHistory;
    /**
...
export function ReadVmsStopHistoryRequestFromJSON(json: any): ReadVmsStopHistoryRequest {
    return ReadVmsStopHistoryRequestFromJSONTyped(json, false);
}

export function ReadVmsStopHistoryRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): ReadVmsStopHistoryRequest {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'filters': !exists(json, 'Filters') ? undefined : FiltersVmsStopHistoryFromJSON(json['Filters']),
...
export function ReadVmsStopHistoryRequestToJSON(value?: ReadVmsStopHistoryRequest | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'Filters': FiltersVmsStopHistoryToJSON(value.filters),
