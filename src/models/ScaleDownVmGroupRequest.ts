...
export function ScaleDownVmGroupRequestFromJSON(json: any): ScaleDownVmGroupRequest {
    return ScaleDownVmGroupRequestFromJSONTyped(json, false);
}

export function ScaleDownVmGroupRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): ScaleDownVmGroupRequest {
...
export function ScaleDownVmGroupRequestToJSON(value?: ScaleDownVmGroupRequest | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
