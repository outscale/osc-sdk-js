...
export interface CreateNetPeeringRequest {
    ...
    /**
     * The OUTSCALE account ID of the owner of the Net you want to connect with. By default, the account ID of the owner of the Net from which the peering request is sent. <br /><br/ >
...
export function CreateNetPeeringRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): CreateNetPeeringRequest {
    ...
    return {
        ...
        'accepterOwnerId': !exists(json, 'AccepterOwnerId') ? undefined : json['AccepterOwnerId'],
...
export function CreateNetPeeringRequestToJSON(value?: CreateNetPeeringRequest | null): any {
    ...
    return {
        ...
        'AccepterOwnerId': value.accepterOwnerId,
        'DryRun': value.dryRun,
