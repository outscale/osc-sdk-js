...
export function CreateAccessKeyRequestFromJSON(json: any): CreateAccessKeyRequest {
    return CreateAccessKeyRequestFromJSONTyped(json, false);
}

export function CreateAccessKeyRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): CreateAccessKeyRequest {
...
export function CreateAccessKeyRequestToJSON(value?: CreateAccessKeyRequest | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
