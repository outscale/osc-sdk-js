 ...
 * @export
 * @interface VmsStopHistory
 */
export interface VmsStopHistory {
    /**
...
export function VmsStopHistoryFromJSON(json: any): VmsStopHistory {
    return VmsStopHistoryFromJSONTyped(json, false);
}

export function VmsStopHistoryFromJSONTyped(json: any, ignoreDiscriminator: boolean): VmsStopHistory {
    ...
    return {
        ...
        'stopDate': !exists(json, 'StopDate') ? undefined : (new Date(json['StopDate'])),
        'vmId': !exists(json, 'VmId') ? undefined : json['VmId'],
    };
}

export function VmsStopHistoryToJSON(value?: VmsStopHistory | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
