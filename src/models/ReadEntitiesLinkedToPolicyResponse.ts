...
import {
    PolicyEntities,
    PolicyEntitiesFromJSON,
    PolicyEntitiesFromJSONTyped,
    PolicyEntitiesToJSON,
} from './PolicyEntities';

/**
 * 
 * @export
 * @interface ReadEntitiesLinkedToPolicyResponse
 */
export interface ReadEntitiesLinkedToPolicyResponse {
    /**
     * 
     * @type {PolicyEntities}
     * @memberof ReadEntitiesLinkedToPolicyResponse
     */
...
export function ReadEntitiesLinkedToPolicyResponseFromJSON(json: any): ReadEntitiesLinkedToPolicyResponse {
    return ReadEntitiesLinkedToPolicyResponseFromJSONTyped(json, false);
}

export function ReadEntitiesLinkedToPolicyResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ReadEntitiesLinkedToPolicyResponse {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'policyEntities': !exists(json, 'PolicyEntities') ? undefined : PolicyEntitiesFromJSON(json['PolicyEntities']),
        'responseContext': !exists(json, 'ResponseContext') ? undefined : ModelResponseContextFromJSON(json['ResponseContext']),
    };
}

export function ReadEntitiesLinkedToPolicyResponseToJSON(value?: ReadEntitiesLinkedToPolicyResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'PolicyEntities': PolicyEntitiesToJSON(value.policyEntities),
