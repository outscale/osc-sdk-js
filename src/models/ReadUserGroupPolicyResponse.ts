 ...
 * 
 * @export
 * @interface ReadUserGroupPolicyResponse
 */
export interface ReadUserGroupPolicyResponse {
    /**
     * 
     * @type {InlinePolicy}
     * @memberof ReadUserGroupPolicyResponse
     */
    policy?: InlinePolicy;
    /**
     * 
...
export function ReadUserGroupPolicyResponseFromJSON(json: any): ReadUserGroupPolicyResponse {
    return ReadUserGroupPolicyResponseFromJSONTyped(json, false);
}

export function ReadUserGroupPolicyResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ReadUserGroupPolicyResponse {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'policy': !exists(json, 'Policy') ? undefined : InlinePolicyFromJSON(json['Policy']),
        'responseContext': !exists(json, 'ResponseContext') ? undefined : ModelResponseContextFromJSON(json['ResponseContext']),
    };
}

export function ReadUserGroupPolicyResponseToJSON(value?: ReadUserGroupPolicyResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'Policy': InlinePolicyToJSON(value.policy),
