...
export function UnitPriceEntryFromJSON(json: any): UnitPriceEntry {
    return UnitPriceEntryFromJSONTyped(json, false);
}

export function UnitPriceEntryFromJSONTyped(json: any, ignoreDiscriminator: boolean): UnitPriceEntry {
...
export function UnitPriceEntryToJSON(value?: UnitPriceEntry | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
