 ...
 * 
 * @export
 * @interface AddUserToUserGroupRequest
 */
export interface AddUserToUserGroupRequest {
    /**
     * If true, checks whether you have the required permissions to perform the action.
     * @type {boolean}
     * @memberof AddUserToUserGroupRequest
     */
    dryRun?: boolean;
    /**
...
export function AddUserToUserGroupRequestFromJSON(json: any): AddUserToUserGroupRequest {
    return AddUserToUserGroupRequestFromJSONTyped(json, false);
}

export function AddUserToUserGroupRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): AddUserToUserGroupRequest {
...
export function AddUserToUserGroupRequestToJSON(value?: AddUserToUserGroupRequest | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
